...
slug: gHyf-cutler-hammer-elc-serial
docTags: 
...
| **Replaces Gen 1 driver(s)** | [ELC Serial (Gen1.3)](<ELC Serial _Gen1_3_.mdx>) |
...
| ------------------------- | -------------------------------- |
| **Type**                  | Eaton                            |
| **Driver**                | Cutler-Hammer ELC Serial         |
| **Device File**           | /dev/ttyS1 (or your serial port) |
| **Baud Rate**             | Select appropriate baud rate     |
| **Data Bits**             | 7 or 8                           |
| **Parity**                | None, Odd, or Even               |
| **Stop Bits**             | 1 or 2                           |
| **Station ID**            | 0 (default)                      |
