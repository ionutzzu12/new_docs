...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Linear Prediction&#x20;*&#x70;rocessor, refer the :Link[Use the Linear Prediction Function]{label="Use the Linear Prediction Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="kD_pXH523xdKowzIS54UF" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
