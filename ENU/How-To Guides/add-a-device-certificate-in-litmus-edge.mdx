...
- Confirm with your IT department if you require a custom CA certificate to be uploaded to Litmus Edge before you add a device certificate. If you need to upload a custom CA certificate, see :Link[Add a Custom CA Certificate]{docId="EK7QmmQSRt5JnF1grQJKM" label="Add a Custom CA Certificate" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Add a Custom CA Certificate"} for details.&#x20;
...
Follow the steps to :Link[Backup a Device]{docId="qpUpvf6R5mHnloXhHsMux" label="Backup a Device" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Backup a Device"}.&#x20;
