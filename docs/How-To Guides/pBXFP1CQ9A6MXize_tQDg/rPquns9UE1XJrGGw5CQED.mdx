...
Follow the steps to [Add a Connector](<../../Product Features/Integration/C5bo-JHYKWiLNMFY9iVsj.mdx>) and select the **Google Cloud Pub/Sub Connector** provider.&#x20;
...
- **Custom Attributes**:  You can add custom attributes in key/value pairs for further data processing. Refer to the following to learn more:
  - [Use Custom Attributes in the Google Cloud Pub/Sub Connector](<../Integration Guides/Google Cloud Pub/Sub Integration Guide/spR0xQGk2Gi31K2vQMwMe.mdx>)
...
- [Create a Flow](<../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx>) to view the messages coming from Google Pub/Sub through the connector you created.&#x20;
- Visualize the incoming data using one of the dedicated [Applications](<../../Product Features/foSdJKsfOzpqRQZ_00gZy.mdx>) such as [Grafana](../UBH13Ur3WTAoCCkiI605F/PS77TbxOwIzo54AXrCK36.mdx).&#x20;
