...
Learn more about :Link[Certificates]{docId="9csb4OK-t4Xec0HlsPTur" label="Certificates" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
...
The MQTT SSL option allows the client to connect to the server by providing the client configuration with certificates. Learn more about :Link[Certificates]{docId="9csb4OK-t4Xec0HlsPTur" label="Certificates" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
...
<hint type="info">
  **Note**: You can't connect the DeviceHub :Link[MQTT Client]{docId="GsjQL9B16A0MNJeCVvchR" label="MQTT Client" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to the MQTT Server if they are using the same Litmus Edge instance. This includes connecting through the Flows Manager or through an Integration connector. If they are using different Litmus Edge instances, they can connect. &#x20;
</hint>
