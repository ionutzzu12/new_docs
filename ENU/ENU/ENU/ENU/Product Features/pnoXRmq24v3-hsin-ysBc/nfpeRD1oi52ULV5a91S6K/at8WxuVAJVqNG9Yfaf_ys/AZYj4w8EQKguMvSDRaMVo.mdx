...
Machine Learning Classification uses models created in TensorFlow. See [Upload a Model](<../../../../../Product Features/pnoXRmq24v3-hsin-ysBc/nfpeRD1oi52ULV5a91S6K/n6R8xKX9KOkn5KsqeMGZ3.mdx>). The TensorFlow Images Processor feeds images to an already created TensorFlow Model. The TensorFlow Processor feeds timeseries data to an already created TensorFlow Model.
