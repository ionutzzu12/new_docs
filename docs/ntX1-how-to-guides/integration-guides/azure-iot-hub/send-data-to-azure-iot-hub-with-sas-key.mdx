...
slug: ntX1-how-to-guides/integration-guides/azure-iot-hub/send-data-to-azure-iot-hub-with-sas-key
...
You must first [Set up an Azure IoT Hub](../../../how-to-guides/integration-guides/azure-iot-hub/set-up-an-azure-iot-hub.mdx).&#x20;
...
Follow the steps to [Add a Connector](../../../product-features/integration/add-a-connector.mdx) and select the **MQTT - Azure IoT Hub using SAS Key** provider.&#x20;
...
3. Add topics to the connector with the details below. See :Link[Add Topics to Connectors]{label="Add Topics to Connectors" spaceId docId="B9qPfvffO0YM-BmuNKmUp" version="v2" docAnchorId="#IQNU7" loadingMethod="dynamic" overridedLabel href="../../../product-features/integration/add-topics-to-connectors.mdx"} for more information.&#x20;
