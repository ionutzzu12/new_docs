...
When you :Link[Add a Tag]{label="Add a Tag" spaceId="0c3K9AkyXsnPI4j8vUaa5" docId="1OuYH77LULH8tblcBiPQi" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to the connected device, see the following Register Table and Tag Parameters sections.&#x20;
