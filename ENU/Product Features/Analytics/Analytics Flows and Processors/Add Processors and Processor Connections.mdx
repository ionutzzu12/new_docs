...
3. Open the **Action menu** and select **Add a processor**.&#x20;
   ...
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/9IdXeksmKIjAjeeRAamO6_addprocessoricon.png "Add a processor icon")
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/T-4IX3MWfx-tJljsPw6IN_image.png" size="80" width="1054" height="237" caption="Add a connection between two processors" position="center" showCaption="true"></Image>
