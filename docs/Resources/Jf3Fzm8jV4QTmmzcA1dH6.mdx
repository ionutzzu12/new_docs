...
<ExpandableHeading>
  ...
  Try the Litmus Edge [Installation and Deployments](<../QuickStart Guide/HuKWZTyTIc3Ce9wsrNx0l.mdx>) guide to start using Litmus Edge concepts and procedures.
...
<ExpandableHeading>
  ...
  See :Link[Firewall Port Configuration Requirements]{label="System Requirements" spaceId docId="gLtPRe4J7Pwurbmrvqca7" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel="Firewall Port Configuration Requirements" href="../QuickStart Guide/GhaNpfCdRlH0OiNIyk1du.mdx"} to learn more about other ports used by Litmus Edge services.&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Use Upgrade next to the core license on the License pane. You need a `.upd` file for the new version and a currently installed version of Litmus Edge that supports upgrades to the new version. See [Software Updates](<../docs/QuickStart Guide/HuKWZTyTIc3Ce9wsrNx0l/jeWtCYzfX-VdU2FuB7KDG.mdx>) for details on which version you must start from to begin the upgrade process from Litmus Edge.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId docId="V8SLnFzOaPMoLM9QcrXc_" version="v2" docAnchorId="#XMn0S" loadingMethod="dynamic" overridedLabel href="../Troubleshooting/1ziGTKivhzTmtis72qFfs.mdx"} for reasons and steps to resolve these issues.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  Why is my CSV file not able to upload tags?

  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId docId="V8SLnFzOaPMoLM9QcrXc_" version="v2" docAnchorId="#25ovv" loadingMethod="dynamic" overridedLabel href="../Troubleshooting/1ziGTKivhzTmtis72qFfs.mdx"} for possible reasons for this issue and how to resolve it.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  What devices and drivers are supported?

  Check out the extensive lists of [Industrial Systems Connection Guide](<../QuickStart Guide/ihnwJuFWkFifh4xbYZH3n.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  - There are 250+ device drivers included in DeviceHub. DeviceHub supports many PLC manufacturers, such as Siemens, Allen-Bradley, Mitsubishi, Omron. See also [Industrial Systems Connection Guide](<../QuickStart Guide/ihnwJuFWkFifh4xbYZH3n.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Before exporting nodes, select the nodes and connecting wires within a flow tab. See [Manage the Flow Canvas](<../docs/Product Features/tAQ2y6xPYLoNqxyFDrrb-/BIKDEdE9sU71jeGrPO9qu.mdx>).&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  See [OPC UA Client](<../QuickStart Guide/Industrial Systems Connection Guide/OPC UA/QH32VtU7m_jDGL6HRy6cZ.mdx>) for more information about supported servers.
</ExpandableHeading>
