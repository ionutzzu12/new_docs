...
For a Litmus Edge to carry a site license, you will need a connection with a license server. The Litmus Edge can connect to Litmus Edge Manager (which contains an embedded license server that the Litmus Edge will automatically connect to) or a standalone license server. See [License Server Installation](<../docs/QuickStart Guide/7EhNIXawudRIMdiTEOnJV/PW5xfv_1tQGG8y7hDjp70.mdx>) for details.
...
To retrieve a site license from a license server for Litmus Edge, see [Set a License Server](<../Product Features/System/Activation/Licenses/VO6skkuDBH0bLye3C5ZQO.mdx>).
