...
Follow the steps to [Add a Connector](<../../ENU/Product Features/LR02cKZrqRt_aoIMAeuRN/Oltgmv6mo5teuzS_GsNx1.mdx>) and select the **Google Cloud Pub/Sub Connector** provider.&#x20;
...
- **Custom Attributes**:  You can add custom attributes in key/value pairs for further data processing. Refer to the following to learn more:
  - :Link[Use Custom Attributes in the Google Cloud Pub/Sub Connector]{label="Use Custom Attributes in the Google Cloud Pub/Sub Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="2pbmMfVLkfGs2_s4y37ea" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}
...
- [Create a Flow](<../../ENU/Product Features/yOXP8Qb_U_AFnbdqxZSd4/7xvHQOytaduG1w9sa5Jh8.mdx>) to view the messages coming from Google Pub/Sub through the connector you created.&#x20;
- Visualize the incoming data using one of the dedicated [Applications](<../../Product Features/fZ5kfjS0rj8nf2ikyzKYK.mdx>) such as :Link[Grafana]{docId="UukPzrfpbkkQPXmxRT5Sk" label="Visualize Data Using Grafana" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel="Grafana"}.&#x20;
