...
- Activate the device with Litmus Edge Manager. See [Activate an Edge Device](<../../../../../Product Features/System/Activation/YEdmQhGcCCVbGd4L5f0l5.mdx>) for more information.
...
<hint type="success">
  ...
  **Request a License Key**
  ...
  See [Upgrade a Node-Locked License](../../Activation/Licenses/NSMqjG2O4blVt54EBbGUb/7dUvd9aOna0c12bP8mC8V.mdx) or [Upgrade a Node-Locked License Offline](<../../../../../Product Features/System/Activation/Licenses/Offline Node-Locked License Activations/08FB0t_st2tDgfMTpCQDP.mdx>) for steps on upgrading licenses.
</hint>
