...
If you only need to restore a device configuration to a device that isn't damaged, see [Restore a Device](<Restore a Device.mdx>).&#x20;
...
See [Activate a Node-Locked License Online](<./././Activation/Licenses/Online Node-Locked License Activations/Activate a Node-Locked License Online.md>) to learn how to activate the license for the device.
...
3. From the *Backup/Restore Configuration* section, click **Restore**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/63KyojHKFAEL7_bj3kFIk_restore-button.png)
