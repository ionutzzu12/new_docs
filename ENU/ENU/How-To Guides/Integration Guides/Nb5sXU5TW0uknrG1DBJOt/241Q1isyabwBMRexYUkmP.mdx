...
3. Add topics to the connector with the details below. See :Link[Add Topics to Connectors]{label="Add Topics to Connectors" spaceId docId="NZmVtZ9KnORx_hDB6nLwq" version="v2" docAnchorId="#IQNU7" loadingMethod="dynamic" overridedLabel href="../../../../Product Features/Integration/K5ejC0Gja8gzIzlfpvLxz.mdx"} for more information.&#x20;
