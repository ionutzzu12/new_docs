...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Manufacture Counter and Capacity Utilization&#x20;*&#x4B;PI, refer the :Link[Use the Manufacture Counter KPI]{label="Use the Manufacture Counter KPI" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="YuBuHvdzejmwSm4KiORQh" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}  guide for more details.
</hint>
