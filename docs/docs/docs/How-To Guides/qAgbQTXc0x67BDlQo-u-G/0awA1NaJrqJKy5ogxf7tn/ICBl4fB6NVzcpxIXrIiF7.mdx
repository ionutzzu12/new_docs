...
You must first [Set up an Azure IoT Hub](<../../../../../How-To Guides/Integration Guides/Azure IoT Hub Guides/O7bEwhB6DATved5WmyCFt.mdx>). When you add the IoT device to the hub, select **X.509 Self-Signed** as the **Authentication type&#xA0;**&#x77;hen you add the IoT device in Azure.&#x20;
...
Follow the steps to [Add a Connector](<../../../../../Product Features/Integration/GcX9UZAhKiYSz8LSe4xaJ.mdx>) and select the **MQTT - Azure IoT Hub using Device Certificates** provider. Define the following parameters.&#x20;
...
Before creating the topics copy the *Raw Topic* parameter for all tags you want to use for topics. See [Manage Tags](<../../../Product Features/UeMlHt5tdnpQAOmR99fVv/Rwfa_L_7a-1E6DUb6n9Zf/EG-ZEQNrAwPTVHFkZNKS4.mdx>) for more information.
...
5. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="U2ZE0GLAydau4Z5agvqMV" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../../Product Features/tAQ2y6xPYLoNqxyFDrrb-/EfWU7FhzSuuhmZvRB11Ad.mdx"} to learn more.&#x20;
6. Click **Done**, and then click **Deploy**.
7. Check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../../Product Features/tAQ2y6xPYLoNqxyFDrrb-/BIKDEdE9sU71jeGrPO9qu.mdx>) for more details.&#x20;
