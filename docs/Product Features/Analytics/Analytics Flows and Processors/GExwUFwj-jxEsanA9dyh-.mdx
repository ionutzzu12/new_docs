...
To create an entire flow with processors and connections, see :Link[Create an Analytics Flow]{docId="NoLdPWVyw9fcvrD412K2Q" label="Create an Analytics Flow" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Create an Analytics Flow"}.&#x20;
