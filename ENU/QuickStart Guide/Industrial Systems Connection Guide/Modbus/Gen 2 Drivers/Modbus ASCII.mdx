...
<hint type="info">
  **Note**: The address format in this Gen 2 driver is different from the Gen 1 driver ([Modbus ASCII (Gen1)](<././Gen 1 Drivers/Modbus ASCII _Gen1_.md>)) for the same device. Learn more about [Gen1 and Gen2 Driver Differences](<./././././Product Features/DeviceHub/Devices/Gen1 and Gen2 Driver Differences.md>).&#x20;
</hint>
