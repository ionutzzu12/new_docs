...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/uC5OqFKqdShe_tdPkXAPb_2023-09-0812-29-01.png" size="80" width="752" height="1056" position="center" caption="Edit switch node dialog box" indent="2" showCaption="true"></Image>
...
4. Enter code for the function. For this status message use case, the following code was used.
   \:::BlockQuote
   switch (msg.payload) \{
   case "Ready" :
   msg.color = "lime";
   ...
   return msg;
   \::: |
   \| Text     | This ui\_text node can be found in the **Dashboard&#xA0;**&#x6C;ist. Note that there are two text nodes in the Dashboard list. This is not the text input field. V Value Format, enter:
   1\) Drag the **ui\_text&#x20;**&#x6E;ode onto the canvas and wire it to the **Function&#x20;**&#x6E;ode.
5. In the *Value Format* field, enter:
   \:::BlockQuote
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/mKEuxHpD9qXhCbozWL6Pf_2023-09-0810-38-00.png" size="70" width="750" height="684" position="center" caption="Deleting a node" indent="2" showCaption="true"></Image>
