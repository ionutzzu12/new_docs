...
| Mapping            | Data from a predefined table could be mapped into a custom one. Example: \{"from": "to"} where "from" is a column from predefined table, and "to" is a column from destination table. See [Work with Tables in SQL Connectors (Create Table and Show Mapping)](<./././././How-To Guides/Integration Guides/Work with Tables in SQL Connectors _Create Table and Show Mapping_.md>) to learn more.  | No           |
| Create Table       | If selected and table doesn't exist, the table is created with the necessary format. See [Work with Tables in SQL Connectors (Create Table and Show Mapping)](<./././././How-To Guides/Integration Guides/Work with Tables in SQL Connectors _Create Table and Show Mapping_.md>) to learn more.                                                                                                   | No           |
