...
You can also configure static routes in the Terminal User Interface (TUI) or through REST API. See [Access the Terminal User Interface](<../../../QuickStart Guide/-rsTGCtmcfYrNS1hhjVLX/GxZdQf6dCdiiwoE2ZpHR1.mdx>) to learn more.&#x20;
...
- Only Admin users are able to add static routes. See :Link[Access Control]{label="Access Control" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="B675AOmC0ujVtc4Wuzdww" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
