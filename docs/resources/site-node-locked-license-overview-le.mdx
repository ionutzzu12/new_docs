...
For a Litmus Edge to carry a site license, you will need a connection with a license server. The Litmus Edge can connect to Litmus Edge Manager (which contains an embedded license server that the Litmus Edge will automatically connect to) or a standalone license server. See :Link[License Server Installation]{docId="Ko7wFLqRmWv3wg_QZJzTY" label="License Server Installation" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} for details.
...
To retrieve a site license from a license server for Litmus Edge, see [Set a License Server](../product-features/system/licenses/set-license-server.mdx).
...
- [Activate a Node-Locked License Offline](../product-features/system/licenses/offline-node-locked/activate-license.mdx)
