...
4. In the **Topic** field, click the search icon, select the device you previously created, and then select the alias topic for the Timestamp tag.&#x20;
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/cPrHzIeJ18g7uszL1jCux_createprocessor01.png)
5. Click **Save**.&#x20;
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/XBb8yNuNyguyGyb6lMx2X_conversion-timestamp-flow.png" size="80" width="831" height="408" caption="Processor flow for Timestamp tag" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/fHvSLRvnctAa18I9M8pZ6_image.png" size="80" width="930" height="510" position="center" caption="Completed analytics flows canvas" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/PpKCH2b8ov5WDKRiMAImO_image.png" size="80" width="930" height="510" caption="View icons for Conversion processors" position="center" showCaption="true"></Image>

## Conversion Data for Timestamp Tag11.

A value for the time the data was generated in UTC is included in the payload.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/X2SXhnSGvK2oqodbz_vZc_image.png" size="80" width="950" height="788" caption="Time in UTC included in payload" position="center" showCaption="true"></Image>

## Conversion Data for Temperature Tag

The temperature value of 75 Celsius is converted to 167 Fahrenheit.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/vnXJA-VENBBHVQF65QG_U_image.png" size="80" width="926" height="722" caption="Converted value from Celsius to Fahrenheit" position="center" showCaption="true"></Image>

## Conversion Data for Angle Tag

The value of 65 degrees is converted to 1.1344640137963142 radian.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/3gzjEqvYUheYVzoqma8Lo_image.png" size="80" width="925" height="722" caption="Converted value from degrees to radian" position="center" showCaption="true"></Image>
