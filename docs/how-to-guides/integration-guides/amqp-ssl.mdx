...
slug: how-to-guides/integration-guides/amqp-ssl
...
Follow the steps to :Link[Add a Connector]{docId="ytsWGWeU6H6oEUnHj5hW3" label="Add a Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Add a Connector"} and select the **AMQP SSL** provider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see :Link[AMQP SSL]{label="AMQP SSL" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="iXye3Z_vGVaIep7C_eZf0" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
