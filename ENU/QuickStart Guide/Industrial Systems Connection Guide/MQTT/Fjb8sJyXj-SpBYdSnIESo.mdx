...
Learn more about :Link[Certificates]{docId="cT-s9ldLXVj9bDEeScbMu" label="Certificates" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
...
The MQTT SSL option allows the client to connect to the server by providing the client configuration with certificates. Learn more about :Link[Certificates]{docId="cT-s9ldLXVj9bDEeScbMu" label="Certificates" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
...
<hint type="info">
  **Note**: You can't connect the DeviceHub [MQTT Client](3BrPITrkIxodJwzB2jmV0.mdx) to the MQTT Server if they are using the same Litmus Edge instance. This includes connecting through the Flows Manager or through an Integration connector. If they are using different Litmus Edge instances, they can connect. &#x20;
</hint>
