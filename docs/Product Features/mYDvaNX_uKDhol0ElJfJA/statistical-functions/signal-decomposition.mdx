...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Signal Decomposition&#x20;*&#x70;rocessor, refer the :Link[Use the Signal Decomposition Function]{label="Use the Signal Decomposition Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="gc_9gMhH-j86nw3uskHRk" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}  guide for more details.
</hint>
