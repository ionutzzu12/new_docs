...
You will need to sign up for a Twilio account on their [website](https://www.twilio.com/). Note that Twilio charges for message activity.
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/YPcRj2mZCN0xxp3pkh2jP_image.png" size="70" width="763" height="544" position="center" caption="Twilio account dashboard" indent="4" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Le1_OuhCF_g_WrXX_u7S3_image.png" size="50" width="688" height="457" position="center" caption="Edit twilio out node dialog box" indent="3" showCaption="true"></Image>
...
2. Double-click the **Function&#x20;**&#x6E;ode.&#x20;
   ...
   - Click **Done**.&#x20;
3. Click **Deploy**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/xKCJPnOrxgpGVjXVfvDGP_image.png "Completed flows canvas")
4. Click the **Inject&#x20;**&#x6E;ode button to trigger the alert and check the respective phone for the text message.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/uzbN855y9vVHhx5UTUcUT_image.png" size="50" width="736" height="552" position="center" caption="Alert message from twilio" showCaption="true"></Image>
