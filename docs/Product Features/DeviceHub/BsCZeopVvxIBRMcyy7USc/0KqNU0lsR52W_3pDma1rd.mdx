...
<hint type="info">
  **Note**: The **Enable Logging** option when connecting an edge device is only available for Gen 2 drivers. See :Link[Connect a Device]{label="Connect a Device" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="IxDarLhX06j-kM1HeO34R" version="v2" docAnchorId="#e31JR" loadingMethod="dynamic" overridedLabel} for more details.
</hint>
