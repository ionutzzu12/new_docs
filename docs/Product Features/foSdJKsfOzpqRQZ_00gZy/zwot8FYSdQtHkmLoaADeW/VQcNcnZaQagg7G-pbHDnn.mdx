...
See :Link[System Requirements]{label="System Requirements" spaceId docId="zR6z1Pq-0YdPCLeACa58b" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel href="../../../QuickStart Guide/WVlytzrPAyAnw3JKLOu7p.mdx"} to review the list of required and optional ports.&#x20;
