...
<hint type="info">
  **Note**: For additional functions on tag values such as rounding and data conversions, you can use [Analytics](<../../../../Product Features/ETlaRb27Q09oTONoE4bcY.mdx>) or the [Flows Manager](<../../../../Product Features/pEXVb0gXlLgDPGGkqJ2mk.mdx>). See [Analytics Guides](<../../../../How-To Guides/a6rxrowapnADEOPp9BKYB.mdx>) to learn more.&#x20;
</hint>
