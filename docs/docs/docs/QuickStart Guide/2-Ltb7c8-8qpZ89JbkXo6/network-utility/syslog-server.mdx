...
See :Link[Syslog Server Reference]{label="Syslog Server Reference" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="8W6qLEE6nrKNHQMxy_YDf" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} for more information.&#x20;
