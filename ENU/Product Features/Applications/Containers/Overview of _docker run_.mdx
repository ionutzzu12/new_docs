...
<hint type="info">
  **Notes:**&#x20;
  ...
  - The Docker run command is a very versatile tool with numerous configuration options. This section is only intended as an introduction to some of the possible uses of `docker run`. It does not serve as a comprehensive reference.
    See the [Docker documentation](https://docs.docker.com/engine/reference/commandline/run/) for the official, maintained and complete description of `docker run` and its capabilities.
...
4. Click **Run&#x20;**&#x61;t the upper-right corner of the pane.
   ...
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Y6V8W4zSapR1wR4fY4bdq_2023-09-1411-30-41.png "Run button")
...
See [System Requirements](<././././QuickStart Guide/System Requirements.md>) to review the list of required and optional ports.&#x20;
