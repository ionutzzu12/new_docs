---
title: Modbus RTU (Gen1)
slug: quickstart-guide/industrial-systems-connection-guide/modbus/modbus-rtu-gen1
description: Review the following information for setting up and configuring the Modbus RTU (Gen1) driver.
docTags: 
