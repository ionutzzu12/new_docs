...
Make sure you :Link[Install the Mosquitto MQTT Broker on Ubuntu]{docId="qxd9pJ3Ws_ARBw8O29HBe" label="Install the Mosquitto MQTT Broker on Ubuntu" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}.&#x20;
...
Follow the steps to [Add a Connector](<../../ENU/Product Features/LR02cKZrqRt_aoIMAeuRN/Oltgmv6mo5teuzS_GsNx1.mdx>) and select the **MQTT - Generic over SSL&#x20;**&#x70;rovider.&#x20;
