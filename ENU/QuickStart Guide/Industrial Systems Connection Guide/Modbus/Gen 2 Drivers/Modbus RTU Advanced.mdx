---
title: Modbus RTU Advanced
slug: quickstart-guide/industrial-systems-connection-guide/modbus/modbus-rtu-advanced
description: Review the following information for setting up and configuring the Modbus RTU Advanced driver.
docTags: 
createdAt: Thu May 28 2026 23:47:07 GMT+0300 (Eastern European Summer Time)
---

Use this driver instead of the [Modbus RTU](<Modbus RTU.mdx>) driver when multiple stations are connected to the RS-485 bus. The **Station ID** setting can be customized at the tag level with this driver. The device connection status is defined by the last received response.

Review the following information for setting up and configuring the Modbus RTU Advanced driver.&#x20;
