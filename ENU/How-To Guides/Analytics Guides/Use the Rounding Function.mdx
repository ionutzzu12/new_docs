...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/REU_V4_1fss0zw5KnSw8-_image.png" size="70" width="565" height="481" position="center" caption="Rounding Pocessor dialog box" indent="2" showCaption="true"></Image>

8. Connect the two processors, select **Events**, and enter a definition of **roundnearest&#xA0;**&#x66;or the connection.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/VB-r6QBH3UaMmbMOMDwkY_image.png "Processor flow for roundnearest tag")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/3tnb2XOJos_nUZUHoYMcQ_image.png "Completed Rounding Function in Analytics flows canvas")

# Step 4: View Rounded Data

You can view data on the analytics canvas by clicking the **View&#xA0;**&#x69;con in each *Rounding&#xA0;*&#x70;rocessor. 

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/TutbPg6uvAhfg2OFFry83_image.png "View icons for Rounding processors")

## Round Data for RoundNearest Tag

The *roundNearest* method returns **1.52** as the answer when **1.523&#x20;**&#x69;s used as an input value.

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/YqBVPeUJotXwJfHSGWmRN_image.png "Rounding to nearest decimal")

## Round Data for RoundUp Tag

The *roundUp&#x20;*&#x6D;ethod returns **1.53** as the answer when **1.523&#x20;**&#x69;s used as an input value.

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/4oD4Qw82NVdEms6TtAcjM_image.png "Rounding up to nearest decimal")

## Round Data for RoundDown Tag

The *roundDown&#x20;*&#x6D;ethod returns **1.52&#x20;**&#x61;s the answer when **1.523&#x20;**&#x69;s used as an input value.&#x20;

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/ssd57nRfs3ukrdeMB42f0_image.png "Rounding down to nearest decimal")

## Round Data for RoundEven Tag

The *roundEven&#x20;*&#x6D;ethod returns **2** as the answer when **1.523&#x20;**&#x69;s used as an input value.

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/xcv9AA8SXU0w9Yw8PTH30_image.png "Rounding even to nearest decimal")
