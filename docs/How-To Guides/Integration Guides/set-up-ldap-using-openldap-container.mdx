...
slug: set-up-ldap-using-openldap-container
docTags: 
createdAt: Fri Apr 05 2024 23:05:18 GMT+0300 (Eastern European Summer Time)
---
...
1. From your Edge Device, navigate to **Applications&#x20;**> **Containers**.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/xlLsh-YiIcg7DfBJRZtbQ_image.png "Applications > Containers page")
2. Copy and paste the below commands and click the **Run** button.
   ...
   - Command to run the **web UI** to configure users and groups:
     ...
     ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/MiT2g0uVtfuPvcEwjs6LZ_image.png "LDAP docker container images")
3. Once both containers are running, you can access *PHP LDAP Admin UI* by going to `<IP Address of LE>:9080` in your web browser.
   ...
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/MsQ7FWWNtxJmlIeUTwxIx_image.png "PHP LDAP Admin UI Landing Page")
...
1. Click the **login&#x20;**&#x62;utton.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Th_tLRLOD_Sngv-syRJ2b_image.png "PHP LDAP Admin UI Landing Page - Login")
2. Enter the default **Login DN** and **Password**.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/N7GnerPFnbgHXUUlnYOmz_image.png "PHP LDAP Admin UI - Login Dialog Box")
3. Upon successful login, you will see the landing page and an empty tree structure on the left side.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/tPLifSCvsVa4az6MbM0oZ_image.png "PHP LDAP Admin UI Landing Page ")
...
1. Click the *globe* icon and then select **Create a child entry**. The *Create Object* page appears.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/lxnze7qWupISmDdsVr5ff_image.png "PHP LDAP Admin UI Create User Page")
2. Choose **Default** from Templates.
3. Select **inetOrgPerson&#x20;**&#x66;rom *ObjectClasses&#x20;*&#x6C;ist for the LDAP server container.
4. Click **Proceed >>**
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/JmwTeMya3JxD5EhKfzJ16_image.png "PHP LDAP Admin UI Create User Dialog Box")
...
6. Click **Create Object** and then **Commit**.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/GPdt1M2U818xctwuXTD5F_image.png "PHP LDAP Admin UI Create LDAP Entry Page")
...
8. Click **Create Object** and then **Commit**.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/la3VVO6Lj-EdJLuxdmH_m_image.png "PHP LDAP Admin UI Create LDAP Entry Page")

You should see both *Alice* and *Bob* added to the LDAP server:&#x20;

<Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/g66K265aDwy6PgemOq9Pa_image.png" size="60" width="304" height="262" position="center" caption="PHP LDAP Admin UI Side Option" showCaption="true"></Image>
...
6. Click **Create Object**.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/6aGEnfp7425bBSXxyR3Ph_image.png" size="80" width="753" height="719" position="center" caption="PHP LDAP Admin UI - Create Groups" showCaption="true"></Image>
7. Click **Commit.**
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/eDBXaq_KMuX4WagSnBrio_image.png" size="70" width="513" height="275" position="center" caption="PHP LDAP Admin UI Create LDAP Entry Page" showCaption="true"></Image>
...
9. Click **Create Object.**
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/3laUsgiT9mPUmAtqi1aEC_image.png" size="70" width="581" height="712" position="center" caption="PHP LDAP Admin UI - Create Groups" showCaption="true"></Image>
10. Click **Commit.**
    <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Fj8xMIhxpHn-K_nn9Wh4b_image.png" size="70" width="475" height="277" position="center" caption="PHP LDAP Admin UI Create LDAP Entry Page" showCaption="true"></Image>

We should now have four entries under the root folder of the LDAP server. Next, we will configure Litmus Edge.

<Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/PLL_EIG6js49b0EQpT8Vu_image.png" size="60" width="346" height="370" position="center" caption="PHP LDAP Admin UI Side Option" showCaption="true"></Image>
...
1. Navigate to *System&#x20;*>*&#x20;LDAP/AD Auth* and then click the **+** button to define a new LDAP Provider.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/dOZdmIjyTG4dTUlax9aEr_image.png "System > LDAP/AD Auth Page")
2. The *Add Provider* dialog box appears. Here, we have the option to start from a template or to define everything manually.
   ...
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/ELAuTeeF9WEah3VGkcaQ1_image.png "Add Provider dialog box ")
3. On the *Generic&#x20;*&#x74;ab, give the provider a **name&#x20;**&#x61;nd click **Next**.
   The default selection for *Type&#x20;*&#x69;s **generic**.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/tpFmkUQw2ZOsbksR9Vwdz_image.png "Add Provider dialog box - Generic tab")
4. On the *Connection* tab, enter the following:&#x20;
   ...
   - Click **Next**.
     ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/m1N2ORWJjJ_fiFuSxw-4p_image.png "Add Provider dialog box - Connection tab")
...
3. **User Search Filter:** We require a filter to provide Litmus Edge with a list of users who should have access to it.&#x20;
   ...
   If you need more information on how to write LDAP filters, you can refer this :Link[resource]{href="https://confluence.atlassian.com/kb/how-to-write-ldap-search-filters-792496933.html" newTab="true" hasDisabledNofollow="false"}.
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/izu7xVn1qn0QnVggbTWpl_image.png "Add Provider dialog box - User tab")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Rly3GFhXMnP5BYLi73F9j_image.png "Add Provider dialog box - Groups tab")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/iMC3sBpc1smrCnv0-BEe-_image.png "Update Provider dialog box ")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Hf0XB5sGcp6IygnREtTsF_image.png "Map Groups dialog box")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/tALNSIXeYAbZL-bcjtXgY_image.png "Map Groups dialog box - With Permissions")
...
<Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/CmMddPBc-cQgmylXp2dQQ_image.png" size="70" width="504" height="440" position="center" caption="Litmus Edge Login Page" showCaption="true"></Image>
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/MioB7wEIZ-oGxWUe608PG_image.png "List of Members dialog box")
