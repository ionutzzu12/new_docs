...
You can also configure static routes in the Terminal User Interface (TUI) or through REST API. See [Access the Terminal User Interface](<../../../QuickStart Guide/LH9wLRWVmLRpp4M4yCy-f/h0KyQCpKLpGAqZ06S-LRP.mdx>) to learn more.&#x20;
...
- Only Admin users are able to add static routes. See [Access Control](../../Lv4VprvL49Sh2xq8oEdH-/Z27GWlDGawhpAlMXldr-l.mdx) to learn more.&#x20;
