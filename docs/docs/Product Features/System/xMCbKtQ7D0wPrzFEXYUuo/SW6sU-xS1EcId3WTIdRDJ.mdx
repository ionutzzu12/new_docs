...
You can also configure static routes in the Terminal User Interface (TUI) or through REST API. See [Access the Terminal User Interface](<../../../QuickStart Guide/i861oBtdL-QNxXTt1b3ga/5PyFNXl3KcBVdtEAu9mNi.mdx>) to learn more.&#x20;
...
- Only Admin users are able to add static routes. See [Access Control](<../../../../Product Features/System/p7VvH_IUspONeYl_U0xR5.mdx>) to learn more.&#x20;
