...
You will need to configure SSL authentication in InfluxDB and use the authentication parameters to configure the connection in Litmus Edge. See :Link[Enable TLS encryption]{href="https://docs.influxdata.com/influxdb/v2/admin/security/enable-tls/" newTab="true" hasDisabledNofollow="false"} to learn more.&#x20;
...
Follow the steps to [Add a Connector](../../product-features/integration/add-a-connector.mdx) and select the **DB - InfluxDB v2.x SSL&#x20;**&#x70;rovider.&#x20;
...
<Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/svCiXvEys-LNUn3oAx1lz_influxdb17ssl.png" size="60" width="388" height="358" position="flex-start" showCaption="false"></Image>
