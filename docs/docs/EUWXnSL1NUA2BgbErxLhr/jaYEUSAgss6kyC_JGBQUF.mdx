...
Flows and Analytics offer robust data manipulation and analysis tools in industrial settings. You can enhance your data-driven decision-making and operational efficiency with these tools. See [Flows Manager](<../../Product Features/tAQ2y6xPYLoNqxyFDrrb-.mdx>) and [Analytics](<../../Product Features/Cquvomk4GSCEJym0wUtlK.mdx>) to learn more about each feature. This topic compares the features and helps you determine when you should use them.
...
- For additional detailed guides and user scenarios for leveraging Flows, see [Flows Guides](<../../How-To Guides/xFe777GWxhyKl-UrUOnnF.mdx>).
...
- For additional detailed guides and user scenarios for leveraging Analytics, see [Analytics Guides](<../../How-To Guides/NWeROWbMwdP6Asn21Sg6D.mdx>).
