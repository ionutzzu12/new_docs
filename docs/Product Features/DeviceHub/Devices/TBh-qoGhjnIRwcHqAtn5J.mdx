...
<hint type="info">
  **Note**: The **Enable Logging** option when connecting an edge device is only available for Gen 2 drivers. See :Link[Connect a Device]{label="Connect a Device" spaceId docId="_2EDTlzj-mOkIWGexTiF0" version="v2" docAnchorId="#e31JR" loadingMethod="dynamic" overridedLabel href="../../../docs/Product Features/DeviceHub/gp4Hx5suHimGbwANR-nBs/FbhaHiALYdPY4aeQGjHB0.mdx"} for more details.
</hint>
