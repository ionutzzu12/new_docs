...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Change&#x20;*&#x70;rocessor, refer the :Link[Use the Change Processor Function]{label="Use the Change Processor Function" spaceId="SuELLqhxHnnKWA4eA6SOc" docId="m1LAgr-a4fMQvEdMhA8WL" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
