...
If you see a *Failed* status, review the [Manage Connectors](<../../../ENU/Product Features/Xgrv-_ps5irJcZlfL22DG/bzjTf5H1klbPPmGVLysLD.mdx>) page and the relevant error messages.
