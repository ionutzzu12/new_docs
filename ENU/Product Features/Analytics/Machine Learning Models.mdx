...
1. Upload the model. See [Upload a Model](<Machine Learning Models/Upload a Model.mdx>) for details.&#x20;
2. Create an analytics flow based on your model.&#x20;
   ...
   - TensorFlow Images processor for images. See [TensorFlow Images Processor](<Statistical Functions/TensorFlow Images Processor.mdx>)for details.&#x20;
3. (Optional) Add the Tengo Script processor to modify the model output. See [Tengo Script](<Statistical Functions/Tengo Script.mdx>) for details.&#x20;
4. Visualize the ML-based output in the [Flows Manager](<././Flows Manager.md>) or through [Applications](././Applications.md).&#x20;
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Emguio_RaNeFVY_6WTcOf_image.png" size="80" width="884" height="460" caption="The Analytics Models pane" position="center" showCaption="true"></Image>

# Next Steps

- [Upload a Model](<Machine Learning Models/Upload a Model.mdx>)&#x20;
- [Obtain Field Values from a Model](<Machine Learning Models/Obtain Field Values from a Model.mdx>)&#x20;
- [Model Types](<Machine Learning Models/Model Types.mdx>)&#x20;
