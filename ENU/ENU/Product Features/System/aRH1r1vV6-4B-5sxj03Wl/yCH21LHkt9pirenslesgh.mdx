...
<hint type="info">
  **Notes**:&#x20;
  ...
  - Only Admin users are able to add and edit firewall rules. See :Link[Access Control]{label="Access Control" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="79TRd7lbrr88qX25_zFo8" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
</hint>
