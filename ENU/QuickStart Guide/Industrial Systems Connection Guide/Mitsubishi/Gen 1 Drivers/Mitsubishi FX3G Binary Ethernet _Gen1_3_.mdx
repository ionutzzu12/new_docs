...
slug: quickstart-guide/industrial-systems-connection-guide/mitsubishi/mitsubishi-fx3g-binary-ethernet-gen1
...
| ------------------- | ---------------------------------------- |
| **Type**            | Mitsubishi                               |
| **Driver**          | Mitsubishi FX3G Binary Ethernet (Gen1)   |
...
| -------- | --------------- | ------------------ | --------------- | --------------- | --------------------- |
| X        | bit             | DDD                | 0               | 255             | Input Relay           |
| Y        | bit             | DDD                | 0               | 255             | Output Relay          |
| M        | bit             | DDDD               | 0               | 7999            | Internal Relay        |
| T        | bit             | DDD                | 0               | 511             | Timer Contacts        |
| C        | bit             | DDD                | 0               | 255             | Counter Contacts      |
| SM       | bit             | DDDD               | 8000            | 8511            | Source Int. Relays    |
| S        | bit             | DDDD               | 0               | 4095            | Step Relays           |
| R        | word            | DDDDD              | 0               | 32767           | File Register         |
| SD       | word            | DDDD               | 8000            | 8511            | Service Data Register |
| CV2      | word            | DDD                | 200             | 255             | Counter Value         |
| D        | word            | DDDD               | 0               | 7999            | Data Registers        |
| CV       | word            | DDD                | 0               | 199             | Counter Value         |
| TV       | word            | DDD                | 0               | 511             | Timer Value           |
