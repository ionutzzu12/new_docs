...
- [Create API Credentials](<Create API Credentials.mdx>).
- Validate the API token from the **Action menu&#x20;**&#x6F;f the API Token. See [Manage API Credentials](<Manage API Credentials.mdx>) to learn more.&#x20;
- Copy the API token (click the **Copy&#x20;**&#x69;con next to the *API token value)*. See [Manage API Credentials](<Manage API Credentials.mdx>) to learn more.&#x20;
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/V-pWr_FjbH522MwZovChH_get-command.png" size="80" width="1920" height="1020" caption="The GET command" position="center" indent="2" showCaption="true"></Image>

3. Enter the API endpoint to verify the component version: \[Litmus Edge IP address]/\[component name]/version. For example, [https://192.168.0.148/devicehub/version](https://192.168.0.148/devicehub/version).&#x20;
4. Click the **Authorization&#x20;**&#x74;ab.

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/yLq6AoYXP9RSS3rlehSGR_authorization-tab.png" size="80" width="1920" height="1020" caption="Authorization tab" position="center" indent="2" showCaption="true"></Image>

5. From the **Type&#x20;**&#x64;rop-down list, select **Basic Auth**.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/LPwiApBU2tnERB3YCIqjA_basic-auth.png" size="80" width="1920" height="1020" caption="Basic Auth option" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Ic9RSu26ifR9uyHLM7b9A_response.png" size="80" width="1920" height="1020" caption="API response" position="center" indent="2" showCaption="true"></Image>
...
2. In Litmus Edge, navigate to **System&#x20;**> **Support&#x20;**&#x61;nd refer to the *Status&#x20;*&#x73;ection.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/DqyAEdStTMYKsl5CJMtl7_components.png)
3. Cross-reference the version number from the API response and the version number for *DeviceHub API*.
   ...
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Zv-0bZ9LTJ-1Ua_s9wspK_components-version.png)
