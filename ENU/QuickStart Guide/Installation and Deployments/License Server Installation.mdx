...
After receiving a site license key from [Central Portal](https://portal.litmus.io/) a site license can then be activated and added to the license server.&#x20;
...
If your organization has an instance of Litmus Edge Manager along with instances of Litmus Edge, then you can install and manage the license server in Litmus Edge Manager. See [License Server Management](#) and [Activate an Edge Device](<./././Product Features/System/Activation/Activate an Edge Device.md>) for more information.
...
- Obtain access to a License Server Docker image, which is available from [Central Portal](https://portal.litmus.io/).
...
1\.  Download the service account `.json` file from the [Central Portal](https://portal.litmus.io/).
...
<hint type="info">
  **Note**: If you have already set up a license server through Litmus Edge Manager, see [License Server Management](#) and [Activate an Edge Device](<./././Product Features/System/Activation/Activate an Edge Device.md>) to learn how to manage licenses through Litmus Edge Manager.&#x20;
</hint>

## Before You Begin

Request the activation key you will need from the [Central Portal](https://portal.litmus.io/).
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/1KPvxbPOvLRbV9c8EKwS1_add-license.png" size="80" width="977" height="307" position="flex-start" caption="Add License dialog box" indent="2" showCaption="true"></Image>
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/67WZpA72901_ErJb8eu8t_activation-request.png" size="80" width="973" height="363" position="flex-start" caption="Copy icon and URL link" indent="2" showCaption="true"></Image>
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/yZ-kkn0n1mtRn_PlWcJqN_licensing-portal.png" size="80" width="952" height="408" position="flex-start" caption="Licensing Portal page" indent="2" showCaption="true"></Image>
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/HGaCreP6I3e1-o_XDSFKx_activation-data.png" size="80" width="981" height="311" position="flex-start" caption="Activation Data field" indent="2" showCaption="true"></Image>
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/431ihAIG4c4XX0B9u_gbC_authorize-device.png" size="80" width="980" height="325" position="flex-start" caption="Authorize Device dialog box" indent="2" showCaption="true"></Image>
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/invuCEWMNR3qhmCd10gpI_set-server.png" size="80" width="1048" height="652" position="flex-start" caption="Set Server button" indent="2" showCaption="true"></Image>
