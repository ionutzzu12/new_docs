...
<hint type="info">
  **Note**: If multiple stations are connected to the RS-485 bus, then use the [Modbus RTU Advanced](<Modbus RTU Advanced.mdx>) driver instead of this one.&#x20;
</hint>
...
| **Replaces Gen 1 driver(s)** | [Modbus RTU (Gen1)](<././Gen 1 Drivers/Modbus RTU _Gen1_.md>) &#xA;[Modbus RTU-Offset (Gen1)](<././Gen 1 Drivers/Modbus RTU-Offset _Gen1_.md>)&#xA;Learn more about [Gen1 and Gen2 Driver Differences](<./././././Product Features/DeviceHub/Devices/Gen1 and Gen2 Driver Differences.md>) |
...
<hint type="info">
  **Note**: The address format in this Gen 2 driver is different from the Gen 1 driver ([Modbus RTU (Gen1)](<././Gen 1 Drivers/Modbus RTU _Gen1_.md>)) for the same device. Learn more about [Gen1 and Gen2 Driver Differences](<./././././Product Features/DeviceHub/Devices/Gen1 and Gen2 Driver Differences.md>).&#x20;
</hint>
