...
<hint type="info">
  **Note**: The **Enable Logging** option when connecting an edge device is only available for Gen 2 drivers. See :Link[Connect a Device]{label="Connect a Device" spaceId docId="WL56idZTpJY5A20Turkbd" version="v2" docAnchorId="#e31JR" loadingMethod="dynamic" overridedLabel href="../../../../../Product Features/DeviceHub/Devices/2QO5xh8wBeO2UG92F3hbM.mdx"} for more details.
</hint>
