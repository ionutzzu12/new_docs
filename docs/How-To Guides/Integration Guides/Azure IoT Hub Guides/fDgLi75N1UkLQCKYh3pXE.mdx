...
You must first :Link[Set up an Azure IoT Hub]{docId="8lAzmEVqUk6edZ1dOhtCb" label="Set up an Azure IoT Hub" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}.&#x20;

# Step 1: Add the Azure IoT Hub using SAS Key Connector

Follow the steps to [Add a Connector](<../../../Product Features/Integration/C5bo-JHYKWiLNMFY9iVsj.mdx>) and select the **MQTT - Azure IoT Hub using SAS Key** provider.&#x20;
...
3. Double-click the **DataHub Subscribe&#xA0;**&#x6E;ode.
   ...
   - If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="Nay58AX-cu8eMvJ5jUcQm" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx"} to learn more.&#x20;
...
7. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../Product Features/34sTTMTBZO9bOWxfOE7kC/CKl1LMeZrekjdNexLVk4k.mdx>) for more details.&#x20;
