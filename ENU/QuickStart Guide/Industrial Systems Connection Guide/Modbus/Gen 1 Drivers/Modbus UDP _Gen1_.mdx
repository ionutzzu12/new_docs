---
title: Modbus UDP (Gen1)
slug: quickstart-guide/industrial-systems-connection-guide/modbus/modbus-udp-gen1
description: Review the following information for setting up and configuring the Modbus UDP (Gen1) driver.
docTags: 
createdAt: Thu May 28 2026 23:47:06 GMT+0300 (Eastern European Summer Time)
---

<hint type="info">
  **Note**: This driver will be deprecated in a future release. We recommend using the Gen 2 [Modbus UDP](<././Gen 2 Drivers/Modbus UDP.md>).
</hint>
...
| **Replaced with Gen 2 driver** | [Modbus UDP](<././Gen 2 Drivers/Modbus UDP.md>) |
