...
- [DB - Microsoft SQL Server](<../../Product Features/Integration/Integration Connectors/Databases/RvoF4ZEd2v7JFg14nm6ZL.mdx>)
- [DB - Microsoft SQL Server SSL](<../../Product Features/Integration/Integration Connectors/Databases/lq02ZBIWI2SHw2qKA3pT9.mdx>)
- [DB - MySQL](<../../Product Features/Integration/Integration Connectors/Databases/7S9qoxlip4tpnC4Y4qW3w.mdx>)
- [DB - MySQL SSL](<../../Product Features/Integration/Integration Connectors/Databases/4m56UoQlM4EP864oByetW.mdx>)
- [DB - PostgreSQL](<../../Product Features/Integration/Integration Connectors/Databases/WXMCm5at9q_GXlsdBuika.mdx>)
- [DB - PostgreSQL SSL](<../../Product Features/Integration/Integration Connectors/Databases/yk-ZZyRdRwAePfi5ZTEDF.mdx>)
- [DB - MongoDB](<../../Product Features/Integration/Integration Connectors/Databases/WAbDrtDFKZ1Ao4bVSkDsJ.mdx>)
- [DB - Mongo v4+](<../../Product Features/Integration/Integration Connectors/Databases/GNERiVbMpJBtZ5DrqfRXa.mdx>)
...
If you set up a connection with [DB - Microsoft SQL Server](<../../Product Features/Integration/Integration Connectors/Databases/RvoF4ZEd2v7JFg14nm6ZL.mdx>) or [DB - Microsoft SQL Server SSL](<../../Product Features/Integration/Integration Connectors/Databases/lq02ZBIWI2SHw2qKA3pT9.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.&#x20;
...
If you set up a connection with [DB - MySQL](<../../Product Features/Integration/Integration Connectors/Databases/7S9qoxlip4tpnC4Y4qW3w.mdx>) or [DB - MySQL SSL](<../../Product Features/Integration/Integration Connectors/Databases/4m56UoQlM4EP864oByetW.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
If you set up a connection with [DB - PostgreSQL](<../../Product Features/Integration/Integration Connectors/Databases/WXMCm5at9q_GXlsdBuika.mdx>) or [DB - PostgreSQL SSL](<../../Product Features/Integration/Integration Connectors/Databases/yk-ZZyRdRwAePfi5ZTEDF.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
- :Link[Microsoft SQL Server Integration Guide]{docId="lE9ADJbeB-yH620fJImG3" label="Microsoft SQL Server Integration Guide" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}&#x20;
...
These guides use DeviceHub data from devices and tags to create the data that will be sent to the database. Alternatively, you can also use [Analytics](<../../Product Features/mYDvaNX_uKDhol0ElJfJA.mdx>) or the [Flows Manager](<../../Product Features/34sTTMTBZO9bOWxfOE7kC.mdx>) to create this data.&#x20;
