...
slug: product-features/applications/containers/overview-of-docker-run
...
See :Link[System Requirements]{label="System Requirements" spaceId docId="NjMoknGqRerxH-iznRnGj" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel href="../../../quickstart-guide/system-requirements.mdx"} to review the list of required and optional ports.&#x20;
