---
title: GE Fanuc RX3i Serial (Gen1.3)
slug: quickstart-guide/industrial-systems-connection-guide/ge-fanuc/ge-fanuc-rx3i-serial-gen1
description: Review the following information for setting up and configuring the GE Fanuc RX3i Serial (Gen1) driver.
docTags: 
createdAt: Thu May 28 2026 23:47:05 GMT+0300 (Eastern European Summer Time)
---

Review the following information for setting up and configuring the GE Fanuc RX3i Serial (Gen1.3) driver.&#x20;
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/5exWOJp75HB843lQzWlZz_ge-fanuc-rx3i-serial.png" size="80" width="355" height="351" position="flex-start" caption="GE Fanuc RX3i Serial reference" indent="2" showCaption="true"></Image>

2. Launch Proficy Machine Edition v8.0 software to configure the device for Ethernet access.&#x20;
...
| ---------------------- | --------------------------------- |
| **Type**               | GE Fanuc                          |
| **Driver**             | GE Fanuc RX3i Serial (Gen1.3)     |
