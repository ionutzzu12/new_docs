...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Switch&#x20;*&#x70;rocessor, refer the :Link[Use the Switch Processor Function]{label="Use the Switch Processor Function" spaceId="SuELLqhxHnnKWA4eA6SOc" docId="leRIPHxSf5kFYtC64qgKV" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
