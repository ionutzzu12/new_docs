---
title: OPC UA Client (Gen1)
slug: quickstart-guide/industrial-systems-connection-guide/opc-ua/opc-ua-client-gen1
description: Review the following information for setting up and configuring the OPC UA Client (Gen1) driver.
docTags: 
