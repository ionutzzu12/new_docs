...
Make sure you :Link[Install the Mosquitto MQTT Broker on Ubuntu]{docId="XczFFbuebf9_TVK8k1d2l" label="Install the Mosquitto MQTT Broker on Ubuntu" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}.&#x20;
...
Follow the steps to [Add a Connector](<../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **MQTT - Generic over SSL&#x20;**&#x70;rovider.&#x20;
