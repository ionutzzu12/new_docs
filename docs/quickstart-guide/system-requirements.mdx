...
<hint type="info">
  **Note:** You can also managing port in Litmus Edge. See [Manage Firewall Rules](../product-features/system/network/manage-firewall-rules.mdx) to learn more.&#x20;
</hint>
...
The firewall managing Litmus Edge's traffic must open specific ports for certain PLC devices to connect to Litmus Edge. To manage firewall rules in Litmus Edge, see [Manage Firewall Rules](../product-features/system/network/manage-firewall-rules.mdx).&#x20;

Ports for Industrial Systems and Sensors Connections are PLC specific and should be open on a case-by-case basis. See the :Link[Industrial Systems Connection Guide]{docId="eR7j0MOGTLktBXYupdcD-" label="Industrial Systems Connection Guide" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Industrial Systems Connection Guide"} for more information.&#x20;
