...
slug: quickstart-guide/industrial-systems-connection-guide/parker/parker-acr9000-ethernet-gen1
...
| **Validated devices/series** | [Parker ACR9000](https://ph.parker.com/ca/en/acr9000-motion-controllers) |
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/I4FQLheUqfAlk5NRWBtKH_parkeracr9000ethernet.png" size="80" width="963" height="410" position="flex-start" caption="Reference image of device" indent="2" showCaption="true"></Image>
...
| ------------------- | -------------------------------------------- |
| **Type**            | Parker                                       |
| **Driver**          | Parker ACR9000 Ethernet (Gen1.3)             |
...
| ------------ | --------------- | ------------------ | --------------- | --------------- |
| P\_Low16bit  | bit             | DDDDDdd            | 0               | 9999915         |
| P\_High16bit | bit             | DDDDDdd            | 0               | 9999915         |
| P\_Int32     | int32           | DDDDD              | 0               | 99999           |
| P\_Float     | float           | DDDDD              | 0               | 99999           |
