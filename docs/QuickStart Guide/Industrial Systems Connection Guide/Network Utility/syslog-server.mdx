...
See :Link[Syslog Server Reference]{label="Syslog Server Reference" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="HGzrNGm6TXtjwuDImgRpw" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} for more information.&#x20;
