...
| Mapping            | Data from a predefined table could be mapped into a custom one. Example: \{"from": "to"} where "from" is a column from predefined table, and "to" is a column from destination table. See [Work with Tables in SQL Connectors (Create Table and Show Mapping)](<../../../../docs/How-To Guides/qAgbQTXc0x67BDlQo-u-G/FHQSWOSYHfgAMEjdBpdVv.mdx>) to learn more.                                    | No           |
| Create Table       | If selected and table doesn't exist, the table is created with the necessary format. See [Work with Tables in SQL Connectors (Create Table and Show Mapping)](<../../../../docs/How-To Guides/qAgbQTXc0x67BDlQo-u-G/FHQSWOSYHfgAMEjdBpdVv.mdx>) to learn more.                                                                                                                                     | No           |
