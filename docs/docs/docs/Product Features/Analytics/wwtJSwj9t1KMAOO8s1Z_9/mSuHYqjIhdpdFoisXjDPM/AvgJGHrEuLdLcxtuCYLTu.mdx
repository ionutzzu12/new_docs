...
Machine Learning Classification uses models created in TensorFlow. See [Upload a Model](<../../../../../Product Features/Analytics/wwtJSwj9t1KMAOO8s1Z_9/URDWTuVw3tUfXXi1MxOmR.mdx>). The TensorFlow Images Processor feeds images to an already created TensorFlow Model. The TensorFlow Processor feeds timeseries data to an already created TensorFlow Model.
