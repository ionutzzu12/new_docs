---
title: Panasonic Mewtocol Ethernet (Gen1)
slug: quickstart-guide/industrial-systems-connection-guide/panasonic/panasonic-mewtocol-ethernet-gen1
...
.3Review the following information for setting up and configuring the Panasonic Mewtocol Ethernet (Gen1) driver.&#x20;
...
| **Validated devices/series** | [FP0H](https://na.industrial.panasonic.com/products/industrial-automation/plc-hmi-communication/lineup/programmable-logic-controllers-interface-terminal/series/238) |
...
| ------------------- | -------------------------------------------- |
| **Type**            | Panasonic                                    |
| **Driver**          | Panasonic Mewtocol Ethernet (Gen1)           |
...
| -------- | --------------- | ------------------ | --------------- | --------------- | -------------------------- |
| X        | bit             | DDDDdd             | 0               | 999915          | Input                      |
| Y        | bit             | DDDDdd             | 0               | 999915          | Output                     |
| R        | bit             | DDDDdd             | 0               | 999915          | Internal Relay             |
| L        | bit             | DDDDdd             | 0               | 9999            | Link Relay                 |
| L\_Bit   | bit             | DDDDdd             | 0               | 999915          | Link Relay bit             |
