...
- [DB - PostgreSQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/fV_KC1r1dxVbQnjtaLRoW.mdx>)
- [DB - MongoDB](<../../../Product Features/Integration/Integration Connectors/Databases/x2a1RpNfa0lve-VwyghGL.mdx>)
- [DB - Mongo v4+](<../../../Product Features/Integration/Integration Connectors/Databases/a22AbO24i2zrd3kzgH6nM.mdx>)
...
If you set up a connection with [DB - Microsoft SQL Server](<../../../Product Features/Integration/Integration Connectors/Databases/_gz1WakPVqBOu3VzhgSnS.mdx>) or [DB - Microsoft SQL Server SSL](<../../../Product Features/Integration/Integration Connectors/Databases/_6e2FqKypcqbJVjE5mJd6.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.&#x20;
...
If you set up a connection with [DB - MySQL](<../../../Product Features/Integration/Integration Connectors/Databases/BP15ysJW04tZMQmCXOWFU.mdx>) or [DB - MySQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/gZB872FHbqVrnU_qNZDau.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
If you set up a connection with [DB - PostgreSQL](<../../../Product Features/Integration/Integration Connectors/Databases/3uozVFLB5Gbu2onEFAaoa.mdx>) or [DB - PostgreSQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/fV_KC1r1dxVbQnjtaLRoW.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
- [Microsoft SQL Server Integration Guide](<../../../How-To Guides/Integration Guides/p-aRElwy9KsxxVOVBX7lJ.mdx>)&#x20;
- :Link[MySQL Integration Guide]{docId="_akENVDNQZx-wCyWHqKyi" label="MySQL Integration Guide" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}
- [PostgreSQL Integration Guide](AmXx9XoGBXqyQy9Ikf04m.mdx)

These guides use DeviceHub data from devices and tags to create the data that will be sent to the database. Alternatively, you can also use [Analytics](<../../../Product Features/pnoXRmq24v3-hsin-ysBc.mdx>) or the [Flows Manager](<../../../Product Features/yOXP8Qb_U_AFnbdqxZSd4.mdx>) to create this data.&#x20;
