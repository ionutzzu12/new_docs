...
You must first [Set up an Azure IoT Hub](O7bEwhB6DATved5WmyCFt.mdx). When you add the IoT device to the hub, select **X.509 Self-Signed** as the **Authentication type&#xA0;**&#x77;hen you add the IoT device in Azure.&#x20;
...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/GcX9UZAhKiYSz8LSe4xaJ.mdx>) and select the **MQTT - Azure IoT Hub using Device Certificates** provider.&#x20;
...
11. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../docs/Product Features/tAQ2y6xPYLoNqxyFDrrb-/BIKDEdE9sU71jeGrPO9qu.mdx>) for more details.&#x20;
