...
slug: E8E1-databricks-zerobus-ingest-integration-guide
docTags: 
...
See [Create catalog](https://docs.databricks.com/aws/en/catalogs/create-catalog) for detailed instructions.

## Step 5: Create a Schema

In the catalog, create a new Schema or use the automatically created `default` schema.

See [Create schemas](https://docs.databricks.com/aws/en/schemas/create-schema) for detailed instructions.
...
If you see a *Failed* status, review the [Manage Connectors](<././././Product Features/Integration/Manage Connectors.md>) page and the relevant error messages.
