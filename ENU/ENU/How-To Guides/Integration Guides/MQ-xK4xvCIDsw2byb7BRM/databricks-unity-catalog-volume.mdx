...
- Access to Litmus Edge WebUI. See [Access the Litmus Edge Web UI](<../../../../QuickStart Guide/q1U1ZD1eRBYqCxfcTTCtX.mdx>).
...
<hint type="info">
  **Note:&#x20;**&#x54;o generate *CSV*, *JSON*, or *Parquet* files for syncing with the Databricks Unity Catalog, you can utilize the [File Reading Processor](<../../../../Product Features/Analytics/Statistical Functions/file-reading-processor.mdx>) in Litmus Edge.
</hint>
