...
If you see a *Failed* status, review the [Manage Connectors](<../../../docs/Product Features/sg--6i_X4_uGD7by2g88L/A4IRTEnfEkJidIw7T_Lsd.mdx>) page and the relevant error messages.
