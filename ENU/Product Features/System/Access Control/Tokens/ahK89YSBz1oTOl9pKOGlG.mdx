...
- **Select RBAC Groups**: Select which access groups will have access to the client. See [Users](<../../../../ENU/ENU/Product Features/Lv4VprvL49Sh2xq8oEdH-/Z27GWlDGawhpAlMXldr-l/aeHX1d2dkDtqlFVDx4nKQ.mdx>) to learn more.&#x20;
...
<hint type="info">
  **Important:&#x20;**&#x54;o set up and manage your OAuth 2.0 client, check the guide on [How to Create and Use OAuth 2.0 Tokens in Litmus Edge](<../../../../How-To Guides/qqTgLn46wYApPIZaSnacq.mdx>).
</hint>
