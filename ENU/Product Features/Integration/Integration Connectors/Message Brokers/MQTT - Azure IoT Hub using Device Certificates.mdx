...
Review the following guides: [Send Data to Azure IoT Hub with a Device Certificate](<./././././How-To Guides/Integration Guides/Azure IoT Hub Guides/Send Data to Azure IoT Hub with a Device Certificate.md>) and [Receive Data from Azure IoT Hub with a Device Certificate](<./././././How-To Guides/Integration Guides/Azure IoT Hub Guides/Receive Data from Azure IoT Hub with a Device Certificate.md>).&#x20;

## Overview

Azure IoT Hub using Device Certificates integration enables an Edge System to connect with Azure IoT Hub using SSL authentication.
...
- max\_queued\_bytes (default 0)
  ...
  \| Integration topic      | Default topic for publishing or subscribing.&#x20;
  Default: *devices/**\{\{deviceId}}**/messages/events/*
  Where \{\{deviceid}} gets replaced with the value from the configuraiton entered.                                                                                                                                                                                                                                                                                                                                                                        | Yes          |
