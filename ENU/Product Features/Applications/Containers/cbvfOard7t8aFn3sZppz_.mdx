...
See :Link[System Requirements]{label="System Requirements" spaceId docId="2HvbAMnACQvd83h0QIQDT" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel href="../../../QuickStart Guide/ZsUv8XPBAcnL7VJ3pFBEr.mdx"} to review the list of required and optional ports.&#x20;
