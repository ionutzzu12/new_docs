...
<hint type="info">
  **Note:** You can also managing port in Litmus Edge. See [Manage Firewall Rules](<../Product Features/System/Network/xRvUO7ASlPMSYtnSRUh_-.mdx>) to learn more.&#x20;
</hint>
...
The firewall managing Litmus Edge's traffic must open specific ports for certain PLC devices to connect to Litmus Edge. To manage firewall rules in Litmus Edge, see [Manage Firewall Rules](<../Product Features/System/Network/xRvUO7ASlPMSYtnSRUh_-.mdx>).&#x20;

Ports for Industrial Systems and Sensors Connections are PLC specific and should be open on a case-by-case basis. See the [Industrial Systems Connection Guide](ihnwJuFWkFifh4xbYZH3n.mdx) for more information.&#x20;
