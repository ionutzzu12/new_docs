...
- Submit the *Certificate Signing Request&#x20;*&#x69;n Litmus Edge to a certificate authority and subsequently receive the device certificate with all required parameters (CA Chain and Private Key). See [Manage Certificate Signing Requests](<../ENU/ENU/Product Features/System/aRH1r1vV6-4B-5sxj03Wl/pnzWphCLd1NXdvpuq3CuZ/HGeD11kC_kTNHECJfmbFD.mdx>) for details.&#x20;
- Confirm with your IT department if you require a custom CA certificate to be uploaded to Litmus Edge before you add a device certificate. If you need to upload a custom CA certificate, see [Add a Custom CA Certificate](<../ENU/ENU/Product Features/System/aRH1r1vV6-4B-5sxj03Wl/pnzWphCLd1NXdvpuq3CuZ/yW8bYb4D5iEng57JCNu-l.mdx>) for details.&#x20;
...
Follow the steps to [Backup a Device](<../Product Features/System/Device Management/Backup/Restore/MVjUFMC42NgtdnMKRvKkh.mdx>).&#x20;
