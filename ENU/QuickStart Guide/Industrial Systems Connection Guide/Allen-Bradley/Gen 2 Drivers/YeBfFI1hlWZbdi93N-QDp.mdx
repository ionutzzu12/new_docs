...
<hint type="info">
  **Notes**:
  ...
  - This driver provides faster performance over other compatible drivers. If you prefer stability over speed, you can use [AB CompactLogix Ethernet FreeTag](DrloAMF92cdH0H1Zcu490.mdx).
</hint>
