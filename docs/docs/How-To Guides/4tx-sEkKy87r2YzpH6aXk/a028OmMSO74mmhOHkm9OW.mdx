...
- [DB - Microsoft SQL Server](<../../../Product Features/Integration/Integration Connectors/Databases/m-04vWtvYt8FxrfjRrHT4.mdx>)
- [DB - Microsoft SQL Server SSL](<../../../Product Features/Integration/Integration Connectors/Databases/F7-QyC4wyPmzygb3sUOPk.mdx>)
- [DB - MySQL](<../../../Product Features/Integration/Integration Connectors/Databases/NA7QGl5X8kp-k4JEMgY1B.mdx>)
- [DB - MySQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/cGl9wbv8a3_pwihVAAbiy.mdx>)
- [DB - PostgreSQL](<../../../Product Features/Integration/Integration Connectors/Databases/BZfbgluhBc3xuct4S2KBd.mdx>)
- [DB - PostgreSQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/VPPusOKwnP_s36Lj5jzNJ.mdx>)
- [DB - MongoDB](<../../../Product Features/Integration/Integration Connectors/Databases/wlubkGl9neTzp63bi0K8W.mdx>)
- [DB - Mongo v4+](<../../../Product Features/Integration/Integration Connectors/Databases/MGVZ97qv_fNyFw6MhfnwI.mdx>)
...
If you set up a connection with [DB - Microsoft SQL Server](<../../../Product Features/Integration/Integration Connectors/Databases/m-04vWtvYt8FxrfjRrHT4.mdx>) or [DB - Microsoft SQL Server SSL](<../../../Product Features/Integration/Integration Connectors/Databases/F7-QyC4wyPmzygb3sUOPk.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.&#x20;
...
If you set up a connection with [DB - MySQL](<../../../Product Features/Integration/Integration Connectors/Databases/NA7QGl5X8kp-k4JEMgY1B.mdx>) or [DB - MySQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/cGl9wbv8a3_pwihVAAbiy.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
If you set up a connection with [DB - PostgreSQL](<../../../Product Features/Integration/Integration Connectors/Databases/BZfbgluhBc3xuct4S2KBd.mdx>) or [DB - PostgreSQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/VPPusOKwnP_s36Lj5jzNJ.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
- [Microsoft SQL Server Integration Guide](rnyKurZ9yIAuGnyJ6rcRE.mdx)&#x20;
- [MySQL Integration Guide](bqsJOz4HF2rXHEp_RiWTb.mdx)
- [PostgreSQL Integration Guide](MFYhKu311C7n79P7nGtyd.mdx)

These guides use DeviceHub data from devices and tags to create the data that will be sent to the database. Alternatively, you can also use [Analytics](<../../../Product Features/4B5Sgl13RYerzVbfE9zCC.mdx>) or the [Flows Manager](<../../../Product Features/d6Gdnkct4qETfXoFXUIfx.mdx>) to create this data.&#x20;
