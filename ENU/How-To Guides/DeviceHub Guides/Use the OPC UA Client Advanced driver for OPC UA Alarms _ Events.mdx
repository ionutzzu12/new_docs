...
slug: 4-oq-use-the-opcua-client-advanced-browse-tags
docTags: 
...
4. Configure the parameters for the device.&#x20;
   See [Connect a Device](<./././Product Features/DeviceHub/Devices/Connect a Device.md>) and [OPC UA](<./././QuickStart Guide/Industrial Systems Connection Guide/OPC UA.md>) or [OPC UA Client Advanced](<./././QuickStart Guide/Industrial Systems Connection Guide/OPC UA/OPC UA Client Advanced.md>) to learn more.
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/miYXM0FZlgc98u4v0KA3L_image.png" size="80" width="1872" height="717" position="center" caption="Tags section" indent="3" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/2uxLXW4RBr7lBVuf5rjd0_image.png" size="50" width="502" height="277" position="center" caption="Browse Parameters dialog box" indent="3" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/By8as4m5hHn71JzAerCxL_image.png" size="70" width="1223" height="687" position="center" indent="2" showCaption="false"></Image>
...
<hint type="info">
  ...
  For nested and non-nested OPC UA event properties, the order of *Namespace Index* values affects Litmus Edge's responses. See [Manage Tags](<./././Product Features/DeviceHub/Tags/Manage Tags.md>) for more details.

  <Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/lzhbMFcgdZxfBn_CbrsAP_image.png" size="80" width="1254" height="763" position="center" caption="Edit Tag Dialog Box" showCaption="true"></Image>
</hint>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/hUfeKglfYaDRpfGKf2xhg_image.png" size="70" width="1264" height="624" position="center" showCaption="false"></Image>

# Step 4: Enable the Connector

After adding the connector, click the **Start&#x20;**&#x69;con in the connector tile to enable it.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/f1R1uGsmKgZ1BZc7Lx38P_image.png" size="50" width="379" height="327" position="center" caption="OPC UA Client Advanced  connector tile " showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/YtlGvWj49va5sLtqWaCN4_image.png" size="80" width="1817" height="553" position="center" caption="Tags section" indent="2" showCaption="true"></Image>

3. Find the *Raw Topic* field in the tag details and click the **Copy&#x20;**&#x62;utton to copy the topic.

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/lz7548_oC9j-ZFnsivI_P_image.png" size="80" width="1426" height="272" position="center" caption="Tags section" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/5xY5eney18jzo4WAS-IQM_image.png" size="80" width="1180" height="202" position="center" caption="Completed Flows Canvas" indent="2" showCaption="true"></Image>

7. Click the **View&#x20;**&#x69;con in the *DataHub Subscribe&#x20;*&#x70;rocessor to view the event data.

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/KriqP_3kuL3avYrFmZk8e_image.png" size="80" width="1607" height="756" position="center" showCaption="false"></Image>
