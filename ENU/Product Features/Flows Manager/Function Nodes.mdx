...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/_AvYRaOUYvVtvTIy_3s4D_image.png" size="80" width="580" height="88" caption="Flows Manager : Level 1 Context Node Arrangement" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/-mCvp2WmWDNfSo1yigCt5_image.png" size="80" width="327" height="156" caption="Flow Manager view debug message" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/BcdulqpEvMrjq_wmZg8cw_image.png" size="80" width="372" height="154" caption="Flow Manager view debug message" position="center" showCaption="true">Level 1: Context</Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/sK1OYdbIndGF4WSyh5GJb_image.png" size="80" width="595" height="150" caption="Flows Manager : Level 2 Flow Node Arrangement" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/SSM_ECsqtidnF9RePQHpS_image.png" size="80" width="293" height="225" caption="Flow Manager view debug message" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/RgUN6FDBfUEbk9CjEyW2p_image.png" size="80" width="649" height="72" caption="Flows Manager : Level 3 Global Node Arrangement" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Y7kuSMyinMmNaAWA-oO7k_image.png" size="80" width="254" height="233" caption="Flow Manager view debug message" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/zlPmDBaFfLFr9sQNhqtKN_image.png" size="80" width="556" height="360" caption="Editing Inject node's msg.payload into global. " position="center" showCaption="true"></Image>

# Reading JSON Objects

1\. From the Flow Definition view, connect a **DataHub Subscribe** node, a **Function** node, and a **Debug** node.

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/nJV3hQuEGerf58oKP-o9s_image.png" size="80" width="830" height="121" caption="DataHub Subscribe with a raw topic connected to a Function node. The Function node connects to a Debug node" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/W1eM_qbUG5CCKIHJ1i6iI_image.png" size="76" width="327" height="156" caption="Flow Manager view debug message" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/f65B4X52bmJXVxjYASDEZ_image.png" size="80" width="568" height="139" caption="Two inject nodes connected to Join nodes. The Join node connects to Debug node." position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/ZWziH4bKpgb9s_d1TORYX_image.png" size="80" width="255" height="150" caption="Flow Manager view debug message" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/tFu8mSycBnBeNGUhqiPXE_image.png" size="80" width="529" height="83" caption="Inject node connect to a Function node that connects to a Debug node" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/4-uMofYANI5sEiUwzqq-O_image.png" size="80" width="334" height="170" caption="Flow Manager view debug message" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/9RYqTA8GWLvssGn3q7BGw_image.png" size="80" width="680" height="89" caption="Inject node connect to a Function node that connects to a Debug node" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/2K0gVs62LE_rt5pBb3XWm_image.png" size="60" width="276" height="147" caption="Flow Manager view debug message" position="center" showCaption="true"></Image>
