...
Review the [MySQL SSL Integration Guide](<./././././How-To Guides/Integration Guides/MySQL SSL Integration Guide.md>).&#x20;

## Overview

MySQL SSL integration enables an Edge System to connect with a MySQL Database using SSL authentication.&#x20;
...
| Hostname             | IP Address or Hostname of MSSQL Server (Must be reachable from the Edge system)                                                                                                                                                                                                 | Yes          |
