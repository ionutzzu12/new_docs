---
title: Mitsubishi FX3G ASCII Ethernet (Gen1.3)
slug: quickstart-guide/industrial-systems-connection-guide/mitsubishi/mitsubishi-fx3g-ascii-ethernet-gen1
description: Review the following information for setting up and configuring the Mitsubishi FX3G ASCII Ethernet (Gen1) driver.
docTags: 
createdAt: Thu May 28 2026 23:47:08 GMT+0300 (Eastern European Summer Time)
---

Review the following information for setting up and configuring the Mitsubishi FX3G ASCII Ethernet (Gen1.3) driver.&#x20;
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/ooOmPpTCH64e_aaCJrF87_mitsubishi-fx3g-ascii.png" size="80" width="398" height="244" position="flex-start" caption="Reference image of device" indent="2" showCaption="true"></Image>
...
| ------------------- | ---------------------------------------- |
| **Type**            | Mitsubishi                               |
| **Driver**          | Mitsubishi FX3G ASCII (Gen1.3)           |
...
| -------- | --------------- | ---------------------- | ------------------ | --------------- | --------------- | --------------------- |
| X        | bit             | R/W                    | DDD                | 0               | 255             | Input Relay           |
| Y        | bit             | R/W                    | DDD                | 0               | 255             | Output Relay          |
| M        | bit             | R/W                    | DDDD               | 0               | 7999            | Internal Relay        |
| T        | bit             | R/W                    | DDD                | 0               | 511             | Timer Contacts        |
| C        | bit             | R/W                    | DDD                | 0               | 255             | Counter Contacts      |
| SM       | bit             | R/W                    | DDDD               | 8000            | 8511            | Source Int. Relays    |
| S        | bit             | R/W                    | DDDD               | 0               | 4095            | Step Relays           |
| R        | word            | R/W                    | DDDDD              | 0               | 32767           | File Register         |
| SD       | word            | R/W                    | DDDD               | 8000            | 8511            | Service Data Register |
| CV2      | word            | R/W                    | DDD                | 200             | 255             | Counter Value         |
| D        | word            | R/W                    | DDDD               | 0               | 7999            | Data Registers        |
| CV       | word            | R/W                    | DDD                | 0               | 199             | Counter Value         |
| TV       | word            | R/W                    | DDD                | 0               | 511             | Timer Value           |
