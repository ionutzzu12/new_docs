...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Moving Window&#x20;*&#x70;rocessor, refer the :Link[Use the Moving Window Processor Function]{label="Use the Moving Window Processor Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="eq4i1gDmN-tyXUgGYGaHZ" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
