...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Production Cycle and Cycle Time Radio (CTR)&#x20;*&#x4B;PI, refer the :Link[Use the Production Time and Cycle Time Ratio KPI]{label="Use the Production Time and Cycle Time Ratio KPI" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="i8f-kUGzD8V8jOn5foDlv" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
