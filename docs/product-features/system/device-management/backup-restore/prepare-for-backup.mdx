...
<hint type="success">
  ...
  **Request a License Key**
  ...
  See :Link[Upgrade a Node-Locked License]{docId="TOGjhJ9-f2mV08Dpkq91w" label="Upgrade a Node-Locked License" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId} or :Link[Upgrade a Node-Locked License Offline]{docId="xiYfGTAhryGvCzqqEMEZP" label="Upgrade a Node-Locked License Offline" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId} for steps on upgrading licenses.
</hint>
