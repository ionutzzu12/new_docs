...
<hint type="info">
  **Note**: For additional functions on tag values such as rounding and data conversions, you can use [Analytics](../../Cquvomk4GSCEJym0wUtlK.mdx) or the [Flows Manager](../../tAQ2y6xPYLoNqxyFDrrb-.mdx). See [Analytics Guides](<../../../How-To Guides/NWeROWbMwdP6Asn21Sg6D.mdx>) to learn more.&#x20;
</hint>
