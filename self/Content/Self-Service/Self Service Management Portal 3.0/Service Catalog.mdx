...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **Service Catalog**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/TpW9w43EGPpphwx9i6OIs_service-catalog-icon-ssm-3017x17.png" alt caption} icon .
...
<ExpandableHeading>
  ...
  1. Log in to \{\{Primary.Product}}.
  2. From the workspace menu, select **Service Catalog**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/TpW9w43EGPpphwx9i6OIs_service-catalog-icon-ssm-3017x17.png" alt caption}icon .
...
<ExpandableHeading>
  ...
  1. Log in to \{\{Primary.Product}}.
  2. From the **Service Catalog** workspace, select a record and click either the Copy or share link:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/mM_vpkeU90VCp6LPQMs9c_icon-ssm-3024x24.png" alt caption}icon.
     - **To copy the link**: Select **Copy Link**. A message will confirm that the link has been copied to your clipboard.
     - **To send an email**: Select **Email** :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/2eq8VoXVMRdO8hUPT9nVi_send-email-ssm-3018x18.png" alt caption} icon. The default email client opens with the offering record in the email body. Enter the recipient details and send the email.
</ExpandableHeading>
