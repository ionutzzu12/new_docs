...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/lJILegHofFe3Ml7as-SR8_image.png "Management options for flows managers")
...
- **&#x20;Warning**: The flow encountered a problem. It has either timed out or is not running as defined.  |
  \| \[2] **Go To Flow Definition** | Opens the flow canvas. See [Create a Flow](<././Create a Flow.md>) to learn more.                                                                                                                                                                                                                                          |
  ...
  \| \[5] **Safe Mode**             | Allows the user to restart an unresponsive flow without having to delete and recreate it.                                                                                                                                                                                                                                  |
  \| \[6] **Stop Flow**             | Stopping a Flows Manager affects all associated individual flows and tabs in the flow canvas.                                                                                                                                                                                                                              |
  \| \[7] **Upload Modules**        | Refer to the "Upload Modules" section below to learn how to upload a preexisting module or custom modules from an individual flow.                                                                                                                                                                                         |
  \| \[8] **Download Flow File**    | Download all associated flows and tabs for the Flows Manager.                                                                                                                                                                                                                                                              |
  \| \[9] **Download Logs**         | Download a log to review the activity of the Flows Manager and troubleshoot issues.                                                                                                                                                                                                                                        |
  \| \[10] **Remove Flow**          | Removing a Flows Manager affects all of the associated tabs and cannot be undone.                                                                                                                                                                                                                                          |
