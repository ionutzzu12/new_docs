...
slug: _Ww8wNCU4McQ9R553l0PK
docTags: 
createdAt: Tue Jan 27 2026 20:22:45 GMT+0200 (Eastern European Standard Time)
---

This guide explains the configuration options available for Edge Cascading v2. For complete setup examples, see the :Link[Single Hub and Multi-Spoke Deployment Scenario]{label="Single Hub and Multi-Spoke Deployment Scenario" spaceId="dNcA0qsaQMoh10_hl6ySs" docId="qGS-LZ784-0AisxdDmvZn" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} topic.
