...
slug: quickstart-guide/industrial-systems-connection-guide/ge-fanuc/ge-fanuc-snp-serial-gen1
...
| ---------------------------- | ----------------- |
| **Driver type**              | Serial            |
| **Validated devices/series** | GE Fanuc VersaMax |
...
<Image src="https://app.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/uybBXWF-ml7i-6dgALThi_ge-fanuc-snp-serial.png" size="80" width="513" height="285" position="flex-start" caption="GE Fanuc SNP Serial reference" indent="2" showCaption="true"></Image>
...
| ---------------------- | --------------------------------- |
| **Type**               | GE Fanuc                          |
| **Driver**             | GE Fanuc SNP Serial (Gen1.3)      |
...
| S        | bit             | R/W                    | DDD                | 1               | 128             |                        |
| R\_Bit   | bit             | R/W                    | DDDDDdd            | 100             | 3264015         | Data Register bit      |
