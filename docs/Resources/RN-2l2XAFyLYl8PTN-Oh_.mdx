...
For a Litmus Edge to carry a site license, you will need a connection with a license server. The Litmus Edge can connect to Litmus Edge Manager (which contains an embedded license server that the Litmus Edge will automatically connect to) or a standalone license server. See [License Server Installation](<../docs/QuickStart Guide/HuKWZTyTIc3Ce9wsrNx0l/SkujcBCZeDe3fmlkXDUT9.mdx>) for details.
...
To retrieve a site license from a license server for Litmus Edge, see [Set a License Server](<../Product Features/System/Activation/Licenses/QIj9qNYSNqVKKhKunrcks.mdx>).
...
- [Activate a Node-Locked License Online](<../Product Features/System/Activation/Licenses/Online Node-Locked License Activations/1ZITrrNnKA0mQwzukxU1-.mdx>)
