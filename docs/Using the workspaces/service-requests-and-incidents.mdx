...
<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/xR6sffG2LEs9oDQSi8lPa_catalog.png" position="flex-start" size="40" initialPath="../Resources/images/catalog.png" githubPath="Content/Resources/images/catalog.png"></Image>
...
If you need to update an in-progress service request with a note or an attachment such as an image or a document, you can do so. For details, see [My Items](docId\:ZVk8C1jO29s_PFVYbkWC9).
...
You can't edit an incident once it's logged, but you can update it with a note or attachment (such as an image, document, and so on). You can also close an incident, regardless of its current status. For details, see [My Items](docId\:ZVk8C1jO29s_PFVYbkWC9).
