...
<hint type="success">
  ...
  **Request a License Key**
  ...
  See [Upgrade a Node-Locked License](<../../../../../docs/Product Features/System/Activation/Licenses/VQtZnef5bWbOdN43I5DcX/2LgOqMZ-3Miw3hlCBTIE7.mdx>) or [Upgrade a Node-Locked License Offline](<../../../Activation/Licenses/Offline Node-Locked License Activations/YGBBhhVwGcA9uuN3LfS5x.mdx>) for steps on upgrading licenses.
</hint>
