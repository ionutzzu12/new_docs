...
- MaxWorkers: Increases throughput and CPU usage              |
  \| **Tag Settings:**             | \* Severity: Inclusive Limit (at least as severe)
...
- Format: Format directives to define the published payload, described below |
  \| **Tag Types:**                | - STRING: Published payload is string type, using format directives
...
| $X         | ProcessID                                                                                                                                                         | string                                               |
| $I         | MessageID                                                                                                                                                         | string                                               |
| $D         | Structured Data                                                                                                                                                   | string OR json object (string🧵string, rfc5424 only) |
| $M         | Message                                                                                                                                                           | string                                               |
