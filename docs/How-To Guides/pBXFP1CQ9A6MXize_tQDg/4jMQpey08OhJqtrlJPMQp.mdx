...
Follow the steps to [Add a Connector](<../../Product Features/Integration/C5bo-JHYKWiLNMFY9iVsj.mdx>) and select the **Aveva Data Hub** provider.&#x20;
...
4. Double-click the **DataHub Subscribe** node.
   ...
   - If needed, configure the Datahub Subscribe connection. See the *Step 3: Configure Connector Nodes* section in [Create a Flow](<../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx>) to learn more.&#x20;
