...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Tengo Script&#x20;*&#x70;rocessor, refer the :Link[Use the Tengo Script Function]{label="Use the Tengo Script Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="fFiWWdsX06HHFmpPCJQKG" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
