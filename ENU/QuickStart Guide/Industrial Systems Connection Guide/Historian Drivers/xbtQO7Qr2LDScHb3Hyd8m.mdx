...
When you :Link[Add a Tag]{label="Add a Tag" spaceId="lwfN6vLUNp54T_hfVp5AA" docId="qvRMZsJet7cZB_ABGlx1b" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to the connected device, see the following Register Table and Tag Parameters sections.&#x20;
