...
Follow the steps to [Add a Connector](<../../../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **MQTT - Azure IoT Hub using Device Certificates** provider. Define the following parameters.&#x20;
...
Before creating the topics copy the *Raw Topic* parameter for all tags you want to use for topics. See [Manage Tags](<../../../ENU/Product Features/o1SOmeIprit2fauHD3CX9/lV8wjACGkGKndgtTE7YfD/yq5VFTW70yfxCU1nRYTe3.mdx>) for more information.
...
5. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="kR15wDiWr6qqJeBRq9TVh" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../Product Features/68WrvuaKK8gVSMbo8bVxq/Dl_unmfRV6alPsSkyT4lP.mdx"} to learn more.&#x20;
6. Click **Done**, and then click **Deploy**.
7. Check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../Product Features/68WrvuaKK8gVSMbo8bVxq/Afi9wqefeN0u5YmHVBn5G.mdx>) for more details.&#x20;
