...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/xc3BjqUGm6gHJZj5g-AaG_image.png "Timeseries DB toggle")
...
<hint type="info">
  **Important Notes**:&#x20;
  ...
  - If you select internal, make sure to select the *Enable Data Store* option for the device you want to store data for. See [Enable Data Store](<././DeviceHub/Devices/Connect a Device.md>) to learn more.&#x20;
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/3CNZ9KY98h1kjp0GdDm6r_image.png "Source type drop-down list")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/A4VU-0lQCBgXy9TxW4bgQ_image.png "The test Timeseries DB button")
