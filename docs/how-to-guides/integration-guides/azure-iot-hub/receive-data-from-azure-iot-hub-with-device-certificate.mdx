...
slug: how-to-guides/integration-guides/azure-iot-hub/receive-data-from-azure-iot-hub-with-device-certificate
...
Follow the steps to :Link[Add a Connector]{docId="ytsWGWeU6H6oEUnHj5hW3" label="Add a Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId} and select the **MQTT - Azure IoT Hub using Device Certificates** provider.&#x20;
...
5. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="wh4ZihWF0PwMRYRbAZbco" label="Create a Flow" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId="#step-3-configure-connector-nodes"} to learn more.&#x20;
...
11. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](../../../product-features/flows-manager/manage-the-flow-canvas.mdx) for more details.&#x20;
