...
<table isTableHeaderOn="true" selectedColumns="" selectedRows="" selectedTable="false" columnWidths="303,303">
  ...
  <tr>
    ...
    <td align="left">
      :Link[ELC Serial (Gen1.3)]{label="ELC Serial (Gen1.3)" spaceId="lwfN6vLUNp54T_hfVp5AA" docId="xL6C_gP9jMgIpGKDIbAV5" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}
    </td>
  </tr>
</table>
