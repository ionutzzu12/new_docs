...
Machine Learning Classification uses models created in TensorFlow. See [Upload a Model](<../../../../ENU/ENU/Product Features/ETlaRb27Q09oTONoE4bcY/-CDVNJeiGRTjHy9y5ubXa/4unoFdbqO1YZm5nLgG3YJ.mdx>). The TensorFlow Images Processor feeds images to an already created TensorFlow Model. The TensorFlow Processor feeds timeseries data to an already created TensorFlow Model.
