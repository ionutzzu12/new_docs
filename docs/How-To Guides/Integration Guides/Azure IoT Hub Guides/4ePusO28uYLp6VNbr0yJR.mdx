...
You must first [Set up an Azure IoT Hub](ucgpSvg_3dFQAZsjEZHV5.mdx).&#x20;

# Step 1: Add the Azure IoT Hub using SAS Key Connector

Follow the steps to [Add a Connector](<../../../Product Features/Integration/2-UCRLFSRK14ramqhVm36.mdx>) and select the **MQTT - Azure IoT Hub using SAS Key** provider.&#x20;
...
3. Double-click the **DataHub Subscribe&#xA0;**&#x6E;ode.
   ...
   - If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="KYuZm3Zwx8ZYXCjdm6hn6" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../Product Features/Flows Manager/HBH_feHBlPPJpVuXPyCAK.mdx"} to learn more.&#x20;
...
7. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../docs/Product Features/d6Gdnkct4qETfXoFXUIfx/-rsFCblTw9z7ExVVKp2Sl.mdx>) for more details.&#x20;
