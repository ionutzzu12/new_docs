...
slug: how-to-guides/analytics-guides/base-conversion-function
...
Follow the steps to :Link[Connect a Device]{docId="pal6ABPZbrimdU9LvGJ30" label="Connect a Device" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} and configure the following parameters.&#x20;
