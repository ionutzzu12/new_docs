...
- Get familiar with different rules of [Switch](<../../Product Features/mYDvaNX_uKDhol0ElJfJA/statistical-functions/switch.mdx>) processor. The rules for comparison are done through *GoLang strings.compare&#x20;*&#x66;unctions.
