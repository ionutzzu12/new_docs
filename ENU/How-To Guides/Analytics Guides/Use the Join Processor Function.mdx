...
2. Click **Save.**
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/N8W18SonlubcI2SmmkStQ_image.png "Join Processr dialog box with Map Output")
...
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/xzkKPmt1SIiQmDGYmB2Ub_image.png "Join Processr dialog box with Array Output")
3. Connect the DataHub Subscribe processor (tag: *tag1)* to the Join processor with a wire and enter the definition of **inputA&#x20;**&#x66;or the connection.
4. Connect the DataHub Subscribe processor (tag: *tag2*) to the Join processor with a wire and enter a definition of **inputB&#x20;**&#x66;or the connection.
5. Connect the DataHub Subscribe processor (tag: *tag3*) to the Join processor with a wire and enter a definition of **inputC&#x20;**&#x66;or the connection.
6. On the analytics canvas, click **Save**.
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/fja6VU1A99pU9CaBYR154_image.png "Completed Analytics Canvas")

## View Map Mode Output

The *Join* processor returns a JSON string with the joined fields from all the tags defined.

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Mcm5UwlM1RGcQfoHoWQxc_image.png "Output of Map Mode")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/M4oNAGH9TGHFk94hZ1Vfc_image.png "Output of Array Mode")
