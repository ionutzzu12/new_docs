...
docTags: 
createdAt: Thu Oct 20 2022 22:05:09 GMT+0300 (Eastern European Summer Time)
---

Machine Learning Classification uses models created in TensorFlow. See :Link[Upload a Model]{docId="UcNJeNTJsCIN-Zrr2jjtH" label="Upload a Model" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}. The TensorFlow Images Processor feeds images to an already created TensorFlow Model. The TensorFlow Processor feeds timeseries data to an already created TensorFlow Model.
