...
Learn more about [Certificates](<../../../../Product Features/System/b95PhFWmFc516r6yCWwJ0/Ls0gLfyNaT-TDFOgU6SNX.mdx>).
...
The MQTT SSL option allows the client to connect to the server by providing the client configuration with certificates. Learn more about [Certificates](<../../../../Product Features/System/b95PhFWmFc516r6yCWwJ0/Ls0gLfyNaT-TDFOgU6SNX.mdx>).
...
See the :Link[Define Optional Parameters]{docId="1krAPcglTn0CgrM_QTTmH" label="Connect a Device" spaceId version="v2" docAnchorId="#step-3-additional-attributes" loadingMethod="dynamic" overridedLabel="Define Optional Parameters" href="../../../Product Features/qDV3AZpxurItY0hScn5FH/36ZpLd_nEeqQvUAOKFxvf/sCrWEhYJ8UZnuYSbQ-0se.mdx"} section to learn more about additional options.&#x20;
...
<hint type="info">
  **Note**: You can't connect the DeviceHub [MQTT Client](ZoC9i90sRBxfEkj-XleEM.mdx) to the MQTT Server if they are using the same Litmus Edge instance. This includes connecting through the Flows Manager or through an Integration connector. If they are using different Litmus Edge instances, they can connect. &#x20;
</hint>
