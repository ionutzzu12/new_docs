...
- Get familiar with different rules of [Switch](<../../ENU/Product Features/ddQv_vx-hJA0ktkDqcaGW/statistical-functions/switch.mdx>) processor. The rules for comparison are done through *GoLang strings.compare&#x20;*&#x66;unctions.
