...
1. Navigate to **Flows Manager&#x20;**&#x61;nd create a new flow. See [Create a Flow](<../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx>) to learn more.&#x20;
...
3. If needed, configure the Datahub Subscribe connection. See the *Step 3: Configure Connector Nodes* section in :Link[Create a Flow]{docId="Nay58AX-cu8eMvJ5jUcQm" label="Create a Flow" spaceId version="v2" docAnchorId="#step-3-configure-connector-nodes" loadingMethod="dynamic" overridedLabel href="../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx"} to learn more.&#x20;
...
Follow the steps to [Add a Connector](<../../Product Features/Integration/C5bo-JHYKWiLNMFY9iVsj.mdx>) and select the **DB - MySQL&#x20;**&#x70;rovider.&#x20;
