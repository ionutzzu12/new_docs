...
slug: product-features/system/access-control/tokens/create-api-token
...
3. From the *API Credentials* section, click the **Add&#x20;**&#x69;con.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/snx-ycj8CnrAxRPFPiIia_create-api-credentials.png)
...
- **Select RBAC Groups**: Select which access groups will have access to the client. See [Users](././Users.md) to learn more.&#x20;
...
<hint type="info">
  **Important:&#x20;**&#x54;o set up and manage your OAuth 2.0 client, check the guide on [How to Create and Use OAuth 2.0 Tokens in Litmus Edge](<./././././How-To Guides/How to Create and Use OAuth 2_0 Tokens in Litmus Edge.md>).
</hint>
