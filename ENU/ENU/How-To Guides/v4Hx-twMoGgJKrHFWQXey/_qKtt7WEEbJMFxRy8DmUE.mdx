...
- If you get the MySQL error message `Error: Too many connections` , refer to [MySQL Error Message: Too Many Connections](../../Troubleshooting/oPAzG8i8GTkhFI_YofLYG/g4vwIaASuHdfWaSlwx3UC.mdx).&#x20;
