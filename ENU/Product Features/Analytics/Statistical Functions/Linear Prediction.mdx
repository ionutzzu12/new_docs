...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/-9GPQRiXC_ZzNs81neO80_image.png" size="80" width="943" height="451" caption="Linear Prediction parameters" position="center" showCaption="true"></Image>

<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Linear Prediction&#x20;*&#x70;rocessor, refer the [Use the Linear Prediction Function](<././././How-To Guides/Analytics Guides/Use the Linear Prediction Function.md>) guide for more details.
</hint>
