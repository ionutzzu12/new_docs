...
Follow the steps to [Add a Connector](<../../Product Features/Integration/C5bo-JHYKWiLNMFY9iVsj.mdx>) and select the **AMQP TCP&#x20;**&#x70;rovider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see [AMQP TCP](<../../Product Features/Integration/Integration Connectors/Message Brokers/jmHs_m3ah_c3KS3dVeOCd.mdx>) and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
