---
title: Siemens S7-1500 (Gen1)
slug: quickstart-guide/industrial-systems-connection-guide/siemens/siemens-s7-1500-gen1
description: Review the following information for setting up and configuring the Siemens S7-1500 (Gen1) driver.
docTags: 
...
| **Validated devices/series** | [Siemens S7-1500 series Ethernet](http://www.siemens.com/entry/cc/en/) |
...
| **S7-1500 Data Type** | **Data Format**                   | **Description** |
| --------------------- | --------------------------------- | --------------- |
| Byte                  | 8-bit BCD, Hex, Binary, Unsigned  | 8-bit           |
| SInt                  | 8-bit BCD, Hex, Binary, Signed    | 8-bit           |
| Bool                  | bit                               | bit             |
| USInt                 | 8-bit BCD, Hex, Binary, Unsigned  | 8-bit           |
