...
Follow the steps to [Add a Connector](<../../Product Features/Integration/C5bo-JHYKWiLNMFY9iVsj.mdx>) and select the **MQTT - Amazon AWS IoT Core over SSL&#x20;**&#x70;rovider.
...
1. Follow the steps to [Create a Flow](<../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx>) and add the following nodes.
   - **DataHub Subscribe&#x20;**
   - **Debug**
...
4. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="Nay58AX-cu8eMvJ5jUcQm" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" overridedLabel="Create a Flow" href="../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx"} to learn more.&#x20;
5. Click **Done**, and then click **Deploy**.
6. Click the **debug&#xA0;**&#x74;ab. See the *Additional Options* section in [Manage the Flow Canvas](<../../Product Features/34sTTMTBZO9bOWxfOE7kC/CKl1LMeZrekjdNexLVk4k.mdx>) for more details.&#x20;
