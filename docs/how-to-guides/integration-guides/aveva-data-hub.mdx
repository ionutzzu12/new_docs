...
Follow the steps to [Add a Connector](../../product-features/integration/add-a-connector.mdx) and select the **Aveva Data Hub** provider.&#x20;
...
4. Double-click the **DataHub Subscribe** node.
   ...
   - If needed, configure the Datahub Subscribe connection. See the *Step 3: Configure Connector Nodes* section in [Create a Flow](../../product-features/flows-manager/create-a-flow.mdx) to learn more.&#x20;
