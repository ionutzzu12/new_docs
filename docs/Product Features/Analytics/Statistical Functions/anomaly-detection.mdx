...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Anomaly Detection&#x20;*&#x70;rocessor, refer the :Link[Use the Anomaly Detection Function]{label="Use the Anomaly Detection Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="XXb5n2LjaYLSKjIAVaJ2E" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
