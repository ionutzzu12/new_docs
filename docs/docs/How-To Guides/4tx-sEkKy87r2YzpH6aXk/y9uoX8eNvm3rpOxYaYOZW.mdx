...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/2-UCRLFSRK14ramqhVm36.mdx>) and select the **Google Cloud Pub/Sub Connector** provider.&#x20;
...
- **Custom Attributes**:  You can add custom attributes in key/value pairs for further data processing. Refer to the following to learn more:
  - [Use Custom Attributes in the Google Cloud Pub/Sub Connector](<../../../How-To Guides/Integration Guides/Google Cloud Pub/Sub Integration Guide/remQe5YKiCmbPJWJ8HfjU.mdx>)
...
- [Create a Flow](<../../../Product Features/Flows Manager/HBH_feHBlPPJpVuXPyCAK.mdx>) to view the messages coming from Google Pub/Sub through the connector you created.&#x20;
- Visualize the incoming data using one of the dedicated [Applications](<../../../Product Features/ShA19E4MoUd8A8eYXeu1S.mdx>) such as [Grafana](<../../../How-To Guides/Applications Guides/V65ge1HRvTrpZjQL2ACJE.mdx>).&#x20;
