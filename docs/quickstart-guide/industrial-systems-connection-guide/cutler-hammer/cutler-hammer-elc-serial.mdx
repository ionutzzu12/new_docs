...
<table isTableHeaderOn="true" selectedColumns="" selectedRows="" selectedTable="false" columnWidths="303,303">
  ...
  <tr>
    ...
    <td align="left">
      :Link[ELC Serial (Gen1.3)]{label="ELC Serial (Gen1.3)" spaceId="wrAXt1hpevKwz3x_oRuPB" docId="F5C_IbZjoNLTe4xpshw3C" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}
    </td>
  </tr>
</table>
