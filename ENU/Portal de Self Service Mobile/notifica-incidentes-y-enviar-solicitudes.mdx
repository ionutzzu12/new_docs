...
- Para agregar un servicio a Favoritos, desde el espacio de trabajo Catálogo de servicio, pulse el icono de Favoritos :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/9Hym2ZtOBnTrdf_WZPGqt_favorites-disabled.png" alt caption}. El icono de Favoritos cambia a :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/d3Ccng5sSTCw2ljTCbz55_favorites-selected.png" alt caption}, aparecerá un mensaje que indica que el servicio seleccionado se ha agregado a Favoritos y el servicio se traslada a la parte superior de la lista junto a los otros servicios Favoritos.

<hint type="info">
  La función Favoritos está disponible en el portal \{\{FRS\_VARS.Self\_Service\_Mobile\_portal}} únicamente si el administrador la ha habilitado.
</hint>

<ExpandableHeading>
  ## Para crear una solicitud de servicios

  1. Pulse el icono del Catálogo de servicios :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/EktwMGw4JqAhT503S-ete_servicecatalogicon.png" alt caption}.
...
<ExpandableHeading>
  ...
  1. Pulse el icono :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/9deULDHgaYqKJgs-raNhN_myitemsicon.png" alt caption} para abrir **Mis elementos**. Se muestra una lista de elementos abiertos.
