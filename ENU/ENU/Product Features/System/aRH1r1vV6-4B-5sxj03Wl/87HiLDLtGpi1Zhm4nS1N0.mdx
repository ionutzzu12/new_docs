...
You can also configure static routes in the Terminal User Interface (TUI) or through REST API. See [Access the Terminal User Interface](<../../../QuickStart Guide/yQxcXE12X4qvj2U1lrzcw/Cpm64UZ-xvA5UDKcwA6_I.mdx>) to learn more.&#x20;
...
- Only Admin users are able to add static routes. See :Link[Access Control]{label="Access Control" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="79TRd7lbrr88qX25_zFo8" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
