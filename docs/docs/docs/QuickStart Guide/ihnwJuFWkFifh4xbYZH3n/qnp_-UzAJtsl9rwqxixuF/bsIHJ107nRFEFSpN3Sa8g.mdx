...
See the :Link[Define Optional Parameters]{docId="_2EDTlzj-mOkIWGexTiF0" label="Connect a Device" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId="#step-3-additional-attributes" loadingMethod="dynamic" overridedLabel="Define Optional Parameters"} section to learn more about additional options.&#x20;
