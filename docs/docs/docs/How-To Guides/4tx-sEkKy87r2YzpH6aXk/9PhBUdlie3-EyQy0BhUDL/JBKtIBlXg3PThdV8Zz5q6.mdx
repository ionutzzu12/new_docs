...
You must first [Set up an Azure IoT Hub](<../../../../../How-To Guides/Integration Guides/Azure IoT Hub Guides/ucgpSvg_3dFQAZsjEZHV5.mdx>).&#x20;
...
Before creating the topics copy the *Raw Topic* parameter for all tags you want to use for topics. See [Manage Tags](<../../../Product Features/0W8IDE7pms-wfQxZMG8Ep/v_j35-Rcple3NFDsiSHfU/chaCE4zDG6YsdhTsyHBzh.mdx>) for more information.
...
3. Add topics to the connector with the details below. See :Link[Add Topics to Connectors]{label="Add Topics to Connectors" spaceId docId="SVfFxcKWj_mOLGtJylllL" version="v2" docAnchorId="#IQNU7" loadingMethod="dynamic" overridedLabel href="../../../../../Product Features/Integration/IpEKAiQ3fiY4nSjX4KYHZ.mdx"} for more information.&#x20;
