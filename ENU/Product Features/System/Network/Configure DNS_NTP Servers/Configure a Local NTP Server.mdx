...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/cjJr7UgFPDTOamN6aT1Kl_ntpconfigwindowsservices.png" size="80" width="925" height="889" caption="The Windows Time service" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/cmhgvasxB62biEFYcjzMn_ntpconfigwindowsregistrycreatenew.png" size="80" width="997" height="525" caption="Create New DWORD item" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/7eVoLNT4X_CP6ixehEqW8_ntpconfigwindowsregistrytimeprovider.png" size="80" width="999" height="531" caption="Edit DWORD Value dialog box" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/8CnwDhfbjT24Nak72vZE1_ntpconfigwindowsregistryannounceflags.png" size="80" width="1000" height="529" caption="Edit DWORD Value dialog box" position="center" indent="2" showCaption="true"></Image>
...
4. In the *Windows Time Properties (Local Computer)* dialog box, select a *Startup type&#x20;*&#x6F;f **Automatic**, click **Start&#x20;**&#x66;or *Service status*, and click **OK**.&#x20;
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Cz2NNmyhLtuRqKM0NQDua_ntpconfigstartwindowstime.png "The Windows Time Properties dialog box")
...
3. Go to either the Litmus Edge Web UI or the Terminal User Interface (TUI) and enter the address of the local NTP server.&#x20;
   - To use the Litmus Edge Web UI, update the *NTP Servers*. See [Configure DNS/NTP Servers](<././Configure DNS_NTP Servers.md>) to learn more.&#x20;
   - To use the TUI, update the *Configure Time* setting. See [Access the Terminal User Interface](<./././././QuickStart Guide/Access the Litmus Edge Web UI/Access the Terminal User Interface.md>) to learn more.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/osabnYypK518ViRg9nPUg_loopedgetuitimentpconfiguration.png" size="80" width="745" height="514" caption="Configure NTP section in Terminal User Interface" position="center" indent="3" showCaption="true"></Image>
