...
docTags: 
createdAt: Mon Nov 28 2022 20:23:32 GMT+0200 (Eastern European Standard Time)
---
...
2. From the left pane, click **Onboard**.
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/V3BO-G9gCkJgBquUU1wEG_aws-iot-onboard.png" size="80" width="1397" height="588" caption="Connect to AWS IoT pane" position="center" showCaption="true"></Image>
3. From the Onboard a device box, click **Get Started**.
   The *Connect to AWS IoT* wizard appears.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/BHiU0IKv0X6aUQDOo0UdD_aws-iot-wizard.png" size="80" width="740" height="493" caption="Connect to AWS IoT wizard" position="center" showCaption="true"></Image>
4. Click **Get Started**.
   The *How are you connecting to AWS IoT* screen appears.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/hsDisp19aOwYBl-wpuGtc_aws-iot-how.png" size="80" width="743" height="566" caption="How are you connecting to AWS IoT screen" position="center" showCaption="true"></Image>
...
6. From the *Choose a AWS IoT Device SDK* section, select **Java**, and then click **Next**.
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/E-Fl8AkTeMQeWdkRi_4vG_aws-iot-register.png" size="80" width="741" height="335" caption="Register a thing screen" position="center" showCaption="true"></Image>
7. In the **Name&#x20;**&#x66;ield, enter **Thing1**, and then click **Next step**.
   The *Download a connection kit&#x20;*&#x73;creen appears.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/JcU-bFVza3ql5LxJWwnCD_aws-iot-download.png" size="80" width="743" height="581" caption="Download a connection kit screen" position="center" showCaption="true"></Image>
8. Click **Linux/OSX**, view the downloaded .zip file at the bottom of the screen, and then click **Next step**.
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Sjr9VXe3uXxpsrKksZ_RU_aws-iot-test-device.png" size="80" width="742" height="472" caption="Configure and test your device screen" position="center" showCaption="true"></Image>
9. View the downloaded .zip file at the bottom of the screen, and then click **Done**.
   The *Connected successfully* screen appears.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/nGT4A0Jc2g1xP8YmtleOM_aws-iot-connected.png" size="80" width="740" height="523" caption="Connected successfully screen" position="center" showCaption="true"></Image>
10. Click **Done**.
...
2. Refresh the page.&#x20;
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Sxu_BWI5z7d3niexH9xGb_aws-iot-thing-policy.png" size="80" width="1409" height="433" caption="Policy item" position="center" showCaption="true"></Image>
...
1. From the left pane, click **Certificates**.
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/csua6h_nIb2AtvPRf7XrW_aws-iot-thing-certificate.png" size="80" width="1410" height="490" caption="Certificate pane" position="center" showCaption="true"></Image>
...
4. Refresh the page.
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/0wDcTp89OT15aFLewKYbq_aws-iot-certificates.png" size="50" width="388" height="408" caption="Certificate wizard" position="center" showCaption="true"></Image>
5. Click **Create a certificate**.
   The *Create a certificate* screen appears.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/sehdtYmb71A0NICh4Nyml_aws-iot-create-certificate.png" size="80" width="746" height="382" caption="Create a certificate screen" position="center" showCaption="true"></Image>
6. Click **Create certificate**.
   The *Certificate created* screen appears.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/4xECEOxkSnjbd8n6dKL7r_aws-iot-certificate-success.png" size="80" width="1037" height="526" caption="Certificate created screen" position="center" showCaption="true"></Image>
...
10. Click **Activate**, and then click **Attach a policy**.
    ...
    <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/CER_7HJZXXmFRNvhXVaWO_aws-iot-policy.png" size="80" width="751" height="402" caption="Add authorization to certificate screen" position="center" showCaption="true"></Image>
11. Select the named **Thing1-Policy**, and then click **Done**.
    <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/xT6c811L9MGH58HgKZa8J_aws-iot-certificate-success.png" size="80" width="1037" height="526" position="center" showCaption="false"></Image>
...
2. Click the named **Thing1-Policy**.
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/klxQ58Tn_WLxFba6BIi68_aws-iot-policy-details.png" size="80" width="749" height="530" caption="Policy dialog box" position="center" showCaption="true"></Image>
3. Click **Edit policy document**.
   The *Edit Policy* screen appears.
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/cRhCT48jqWCWdGVcb-8hn_aws-iot-policy-edit.png" size="80" width="752" height="526" caption="Edit Policy screen" position="center" showCaption="true"></Image>
4. Scroll down the policy document, copy the last line, paste the copied line below, and edit it as follows:
   ...
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Fnaf_Q5NpkRt77wlgHJ7P_aws-iot-policy-edit-golang.png" size="80" width="590" height="101" caption="Edit policy code" position="center" showCaption="true"></Image>
...
8. Scroll to the bottom and copy SDK resource to your clipboard. For this use case, the SDK resource is **sdk-golang**. This is the *Client ID* parameter for the AWS connector.&#x20;
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/cobC0-16iXGjmwvUbVR0X_aws-iot-things-sdk.png" size="80" width="927" height="647" caption="The SDK resource value" position="center" showCaption="true"></Image>
9. Copy the first topic value. In this use case, the topic is **topic\_1**. This the *Integration Topic* value.&#x20;
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/et2d9FRdGwyIfg82wBQcF_aws-iot-things-topic.png" size="80" width="951" height="606" caption="The topic value" position="center" showCaption="true"></Image>

## Step 8: Add AWS IoT Core Connector

Follow the steps to :Link[Add a Connector]{docId="ytsWGWeU6H6oEUnHj5hW3" label="Add a Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Add a Connector"} and select the **MQTT - Amazon AWS IoT Core over SSL&#x20;**&#x70;rovider.
...
<Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/3Zn4dsoTADVWs5tUSHlfM_awsiot.png" size="60" width="369" height="345" position="center" showCaption="false"></Image>
...
<ContentSnippet docRefId="5xrEoBNiGFI2NwvBmdA9Y">
...
1. Follow the steps to [Create a Flow](../../product-features/flows-manager/create-a-flow.mdx) and add the following nodes.
   - **DataHub Subscribe&#x20;**
   - **Debug**
...
4. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="wh4ZihWF0PwMRYRbAZbco" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" overridedLabel="Create a Flow" href="../../product-features/flows-manager/create-a-flow.mdx"} to learn more.&#x20;
5. Click **Done**, and then click **Deploy**.
6. Click the **debug&#xA0;**&#x74;ab. See the *Additional Options* section in [Manage the Flow Canvas](../../product-features/flows-manager/manage-the-flow-canvas.mdx) for more details.&#x20;
