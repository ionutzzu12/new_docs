...
<ExpandableHeading>
  ...
  Try the Litmus Edge [Installation and Deployments](<../QuickStart Guide/NyWAQm5OPiDJ27ioRlTW6.mdx>) guide to start using Litmus Edge concepts and procedures.
...
<ExpandableHeading>
  ...
  See :Link[Firewall Port Configuration Requirements]{label="System Requirements" spaceId docId="7OVc_djPloplJlyZvE9jB" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel="Firewall Port Configuration Requirements" href="../QuickStart Guide/LLfc0pxXVQQj5GGA2gA1E.mdx"} to learn more about other ports used by Litmus Edge services.&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Use Upgrade next to the core license on the License pane. You need a `.upd` file for the new version and a currently installed version of Litmus Edge that supports upgrades to the new version. See [Software Updates](<../ENU/QuickStart Guide/NyWAQm5OPiDJ27ioRlTW6/MKLEE33uupZUE-L7ZFwRv.mdx>) for details on which version you must start from to begin the upgrade process from Litmus Edge.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId docId="UAVyPWgifP4TogcThnDI3" version="v2" docAnchorId="#XMn0S" loadingMethod="dynamic" overridedLabel href="../Troubleshooting/GUaQZL3lkdVBs0uABckPM.mdx"} for reasons and steps to resolve these issues.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  Why is my CSV file not able to upload tags?

  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId docId="UAVyPWgifP4TogcThnDI3" version="v2" docAnchorId="#25ovv" loadingMethod="dynamic" overridedLabel href="../Troubleshooting/GUaQZL3lkdVBs0uABckPM.mdx"} for possible reasons for this issue and how to resolve it.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  What devices and drivers are supported?

  Check out the extensive lists of [Industrial Systems Connection Guide](<../QuickStart Guide/4rCgbyfZd-2FiGUfa1Jy5.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  - There are 250+ device drivers included in DeviceHub. DeviceHub supports many PLC manufacturers, such as Siemens, Allen-Bradley, Mitsubishi, Omron. See also [Industrial Systems Connection Guide](<../QuickStart Guide/4rCgbyfZd-2FiGUfa1Jy5.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Before exporting nodes, select the nodes and connecting wires within a flow tab. See [Manage the Flow Canvas](<../ENU/Product Features/yOXP8Qb_U_AFnbdqxZSd4/bSXnAa7thWL0_2-05LetC.mdx>).&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  See [OPC UA Client](<../QuickStart Guide/Industrial Systems Connection Guide/OPC UA/g11pTiP0tPuvddZ0_0Myu.mdx>) for more information about supported servers.
</ExpandableHeading>
