...
This guide explains the configuration options available for Edge Cascading v2. For complete setup examples, see the [Single Hub and Multi-Spoke Deployment Scenario](<Single Hub and Multi-Spoke Deployment Scenario.mdx>) topic.
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/TmrrNt9bqNtCCxN58AaOg_image.png" size="80" width="1425" height="453" position="flex-start" indent="2" showCaption="false"></Image>
...
For more information on host file mapping, see [Host Files.](https://app.archbee.com/docs/wrAXt1hpevKwz3x_oRuPB/pGZWSr3Dtjm4dgl2x93Ab#k8nGu)
