...
See :Link[System Requirements]{label="System Requirements" spaceId docId="fvBfqs58X67DFpOvXwSwI" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel href="../../../QuickStart Guide/6EBdrjRrrytTaRC_GdWN0.mdx"} to review the list of required and optional ports.&#x20;
