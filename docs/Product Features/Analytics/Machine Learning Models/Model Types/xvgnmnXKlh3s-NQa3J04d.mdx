...
Machine Learning Classification uses models created in TensorFlow. See [Upload a Model](../19Gk-ns4EX4pbcC74_Lwb.mdx). The TensorFlow Images Processor feeds images to an already created TensorFlow Model. The TensorFlow Processor feeds timeseries data to an already created TensorFlow Model.
