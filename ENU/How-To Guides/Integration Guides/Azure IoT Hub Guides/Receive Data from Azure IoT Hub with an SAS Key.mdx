...
You must first [Set up an Azure IoT Hub](<Set up an Azure IoT Hub.mdx>).&#x20;

# Step 1: Add the Azure IoT Hub using SAS Key Connector

Follow the steps to [Add a Connector](<././././Product Features/Integration/Add a Connector.md>) and select the **MQTT - Azure IoT Hub using SAS Key** provider.&#x20;
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/kio3tM-CAoE1L2t6-lpSM_azureiotsas.png" size="60" width="369" height="345" position="center" caption="Toggle to enable connector" showCaption="true"></Image>
...
7. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<././././Product Features/Flows Manager/Manage the Flow Canvas.md>) for more details.&#x20;
