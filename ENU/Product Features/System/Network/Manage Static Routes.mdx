...
You can also configure static routes in the Terminal User Interface (TUI) or through REST API. See [Access the Terminal User Interface](<././././QuickStart Guide/Access the Litmus Edge Web UI/Access the Terminal User Interface.md>) to learn more.&#x20;
...
- Only Admin users are able to add static routes. See [Access Control](<././Access Control.md>) to learn more.&#x20;
...
2. Click **Add**.
   ...
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/OH-gwzAs7oVMgTZKQIuDl_add-static-route.png)
