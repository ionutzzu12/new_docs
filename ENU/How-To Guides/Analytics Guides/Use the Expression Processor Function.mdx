...
7. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/3u7ou-UJ-5LO4-OspjmxD_image.png "Expression processor dialog box")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/rvfxLsuRacaC8ZTUtlpIK_image.png "Completed canvas flow with one input")
...
7. Click **Add processor** again and select **Expression&#x20;**&#x70;rocessor.
   ...
   - **Output Field Name**: Enter **value&#x20;**&#x61;s the field to appear in the output.
8. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/lsGZw6G--vzW1dRvVakBf_image.png "Expression processor dialog box")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/WK2ZS831zXNvSAn7ZfakZ_image.png "Completed canvas flow with multiple inputs")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/IifgUf0XZAdWWV2IMGlPk_image.png "Output for single input expression")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Ixueibh5CTUVHXNyNRnZy_image.png "Output for multiple input expression")
