...
1. Navigate to **Flows Manager&#x20;**&#x61;nd create a new flow. See [Create a Flow](../../product-features/flows-manager/create-a-flow.mdx) to learn more.&#x20;
...
3. If needed, configure the Datahub Subscribe connection. See the *Step 3: Configure Connector Nodes* section in :Link[Create a Flow]{docId="wh4ZihWF0PwMRYRbAZbco" label="Create a Flow" spaceId version="v2" docAnchorId="#step-3-configure-connector-nodes" loadingMethod="dynamic" overridedLabel href="../../product-features/flows-manager/create-a-flow.mdx"} to learn more.&#x20;
...
Follow the steps to [Add a Connector](../../product-features/integration/add-a-connector.mdx) and select the **DB - MySQL&#x20;**&#x70;rovider.&#x20;
