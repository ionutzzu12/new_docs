...
<hint type="info">
  **Note**: For additional functions on tag values such as rounding and data conversions, you can use [Analytics](../../analytics.mdx) or the [Flows Manager](../../flows-manager.mdx). See [Analytics Guides](../../../how-to-guides/analytics-guides.mdx) to learn more.&#x20;
</hint>
