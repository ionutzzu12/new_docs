...
3. Add topics to the connector with the details below. See :Link[Add Topics to Connectors]{label="Add Topics to Connectors" spaceId docId="kGpUzLopnIcfD9r9gjEYA" version="v2" docAnchorId="#IQNU7" loadingMethod="dynamic" overridedLabel href="../../../Product Features/Integration/dn3BQs7BJ5iQXL7C7wGsG.mdx"} for more information.&#x20;
