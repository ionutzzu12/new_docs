...
| **Type**                  | Modbus                                  |
| **Driver**                | Modbus UDP                              |
| **Network Address**       | The device IP address defined in Step 1 |
| **Network Port**          | 502                                     |
| **Station ID**            | 0                                       |
...
<hint type="info">
  **Note**: The address format in this Gen 2 driver is different from the Gen 1 driver ([Modbus UDP (Gen1)](<././Gen 1 Drivers/Modbus UDP _Gen1_.md>)) for the same device. Learn more about [Gen1 and Gen2 Driver Differences](<./././././Product Features/DeviceHub/Devices/Gen1 and Gen2 Driver Differences.md>).&#x20;
</hint>
