...
# Understanding Different Rise and Fall Functions 123
...
Follow the steps to [Connect a Device](<../../docs/Product Features/DeviceHub/gp4Hx5suHimGbwANR-nBs/FbhaHiALYdPY4aeQGjHB0.mdx>) and configure the following parameters:
