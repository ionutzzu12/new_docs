...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Gaussian Filter&#x20;*&#x70;rocessor, refer the :Link[Use the Gaussian Filter Function]{label="Use the Gaussian Filter Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="AV3MiKOujaquc2d4pWyfk" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
