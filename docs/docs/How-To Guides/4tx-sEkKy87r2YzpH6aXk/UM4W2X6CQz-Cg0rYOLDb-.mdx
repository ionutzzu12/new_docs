...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/2-UCRLFSRK14ramqhVm36.mdx>) and select the **Cognite Connector** provider.&#x20;
...
You can visualize the incoming data using one of the dedicated [Applications](<../../../Product Features/ShA19E4MoUd8A8eYXeu1S.mdx>) such as [Grafana](<../../../How-To Guides/Applications Guides/V65ge1HRvTrpZjQL2ACJE.mdx>).&#x20;
...
- If you are creating a flow from the [Flows Manager](<../../../Product Features/d6Gdnkct4qETfXoFXUIfx.mdx>), subscribe to the *Local Data Topic* name. See [Subscribe to Topics with Flows](<../../../How-To Guides/Flows Guides/PUgLM2xrJLAFEYxNNtdsJ.mdx>) to learn more.&#x20;
- If you are using [Analytics](<../../../Product Features/4B5Sgl13RYerzVbfE9zCC.mdx>), select the DataHub Subscribe processor and use the *Local Data Topic* name. See [Create an Analytics Flow](<../../Product Features/Analytics/w6vHugPMctrZS18BMnGE7/S7d7-6tJBt2yCHLK6AGTB.mdx>) and [Add Processors and Processor Connections](<../../Product Features/Analytics/w6vHugPMctrZS18BMnGE7/ZrSLldYC988ui1PsWJBG_.mdx>) to learn more.&#x20;
