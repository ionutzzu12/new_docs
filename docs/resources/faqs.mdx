...
<ExpandableHeading>
  ...
  Try the Litmus Edge [Installation and Deployments](../quickstart-guide/installation-and-deployments.mdx) guide to start using Litmus Edge concepts and procedures.
...
<ExpandableHeading>
  ...
  See :Link[Firewall Port Configuration Requirements]{label="System Requirements" spaceId docId="NjMoknGqRerxH-iznRnGj" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel="Firewall Port Configuration Requirements" href="../quickstart-guide/system-requirements.mdx"} to learn more about other ports used by Litmus Edge services.&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Use Upgrade next to the core license on the License pane. You need a `.upd` file for the new version and a currently installed version of Litmus Edge that supports upgrades to the new version. See :Link[Software Updates]{docId="Q9MPElGA-U-fkCFKAnVjl" label="Software Updates" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Software Updates"} for details on which version you must start from to begin the upgrade process from Litmus Edge.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="7Fa2-oN6FTIHPuDS8V3Sk" version="v2" docAnchorId="#XMn0S" loadingMethod="dynamic" overridedLabel} for reasons and steps to resolve these issues.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  Why is my CSV file not able to upload tags?

  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="7Fa2-oN6FTIHPuDS8V3Sk" version="v2" docAnchorId="#25ovv" loadingMethod="dynamic" overridedLabel} for possible reasons for this issue and how to resolve it.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  What devices and drivers are supported?

  Check out the extensive lists of :Link[Industrial Systems Connection Guide]{label="Industrial Systems Connection Guide" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="eR7j0MOGTLktBXYupdcD-" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  - There are 250+ device drivers included in DeviceHub. DeviceHub supports many PLC manufacturers, such as Siemens, Allen-Bradley, Mitsubishi, Omron. See also :Link[Industrial Systems Connection Guide]{label="Industrial Systems Connection Guide" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="eR7j0MOGTLktBXYupdcD-" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Before exporting nodes, select the nodes and connecting wires within a flow tab. See [Manage the Flow Canvas](../product-features/flows-manager/manage-the-flow-canvas.mdx).&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  See :Link[OPC UA Client]{docId="10tYPn86wH3boiDPtk2H7" label="OPC UA Client" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="OPC UA Client"} for more information about supported servers.
</ExpandableHeading>
