...
<table isTableHeaderOn="true" selectedColumns="" selectedRows="" selectedTable="false" columnWidths="303,303">
  ...
  <tr>
    ...
    <td align="left">
      [ELC Serial (Gen1.3)](SFSFR-eYVEXTmaCzdLI9h.mdx)
    </td>
  </tr>
</table>
...
Configure the following parameters when you [Connect a Device](<../../../Product Features/qDV3AZpxurItY0hScn5FH/36ZpLd_nEeqQvUAOKFxvf/sCrWEhYJ8UZnuYSbQ-0se.mdx>) with this driver. Update default values to the specific setup of your device.
