...
- Access to Litmus Edge WebUI. See [Access the Litmus Edge Web UI](<../../../../QuickStart Guide/LH9wLRWVmLRpp4M4yCy-f.mdx>).
- Access to Databricks workspace URL and access token.

# Step 1: Add Device

Follow the steps to [Connect a Device](<../../../ENU/Product Features/qDV3AZpxurItY0hScn5FH/36ZpLd_nEeqQvUAOKFxvf/sCrWEhYJ8UZnuYSbQ-0se.mdx>). The device will be used to store tags that will be eventually used to create outbound topics in the connector. Make sure to select the **Enable Data Store** checkbox.&#x20;
...
<hint type="info">
  **Note:&#x20;**&#x54;o generate *CSV*, *JSON*, or *Parquet* files for syncing with the Databricks Unity Catalog, you can utilize the [File Reading Processor](<../../../ENU/Product Features/ETlaRb27Q09oTONoE4bcY/statistical-functions/file-reading-processor.mdx>) in Litmus Edge.
</hint>
