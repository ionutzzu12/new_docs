...
slug: product-features/integration/integration-connectors/cloud-service-providers/google-cloud-pubsub-connector
...
Review the :Link[Google Cloud Pub/Sub Integration Guide]{docId="-9h7uX3mPNSmgtd5NbKnd" label="Google Cloud Pub/Sub Integration Guide" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.&#x20;
