...
<ExpandableHeading>
  ...
  <Image src="i/my-items.png" position="flex-start" size="40" initialPath="i/my-items.png" githubPath="self-ESP/Content/Self-Service/i/my-items.png"></Image>
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  - Para buscar un elemento específico, introduzca una palabra clave en el campo **Buscar Mis elementos** y haga clic en el icono :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/txDuhxj2xVYfK8ADFCk70_search-icon14x13.png" alt caption}. Se mostrarán los resultados que coincidan.
  - Para centrar la búsqueda, utilice el desplegable de búsqueda para seleccionar una categoría de Solicitud, Problema, etc.
  - Para borrar todos los criterios de búsqueda, haga clic en el icono :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/nWZw9CZo0Wn5l9XkwK6w4_red-x-icon14x13.png" alt caption}.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  <Image src="i/catalog.png" position="flex-start" size="40" indent="1" initialPath="i/catalog.png" githubPath="self-ESP/Content/Self-Service/i/catalog.png"></Image>
...
<ExpandableHeading>
  ...
  3. Haga clic en la pestaña **Progreso de la solicitud de servicio**.
     ...
     - En el campo **Agregar archivo adjunto**, haga clic en el icono :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/SMFrK8qjl5FncgeipELzN_browse-icon18x15.png" alt caption} para seleccionar un archivo que desee adjuntar.
