...
- **Select RBAC Groups**: Select which access groups will have access to the client. See [Users](../users.mdx) to learn more.&#x20;
...
<hint type="info">
  **Important:&#x20;**&#x54;o set up and manage your OAuth 2.0 client, check the guide on [How to Create and Use OAuth 2.0 Tokens in Litmus Edge](../../../../how-to-guides/oauth-20-tokens-in-litmus-edge.mdx).
</hint>
