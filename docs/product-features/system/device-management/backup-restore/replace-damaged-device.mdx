...
slug: product-features/system/device-management/backup-restore/replace-damaged-device
...
If you only need to restore a device configuration to a device that isn't damaged, see [Restore a Device](restore-device.mdx).&#x20;

# Important

- You should regularly back up Litmus Edge. See [Back Up a Device](back-up-device.mdx).&#x20;
...
See :Link[Activate a Node-Locked License Online]{docId="92RbXbyDbFWkkUo1jt5lZ" label="Activate a Node-Locked License Online" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId} to learn how to activate the license for the device.
