...
Configure the following parameters when you [Connect a Device](<../../../../../Product Features/DeviceHub/Devices/2QO5xh8wBeO2UG92F3hbM.mdx>) with this driver. Update default values to the specific setup of your device.
...
When you [Add a Tag](<../../../../../Product Features/DeviceHub/Tags/yXwhVlOl6mjbRcBeWrY1m.mdx>) to the connected device, refer to the following register table and tag parameters. Refer to the following additional resources:
