...
slug: how-to-guides/flows-guides/send-alerts-to-a-mobile-phone
...
1. In Litmus Edge, navigate to the **Flows Manager&#x20;**&#x61;nd create a new flow. See :Link[Create a Flow]{docId="wh4ZihWF0PwMRYRbAZbco" label="Create a Flow" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId} to learn more.
