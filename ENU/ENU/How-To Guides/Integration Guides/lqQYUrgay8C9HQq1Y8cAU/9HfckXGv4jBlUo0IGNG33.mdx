...
You must first [Set up an Azure IoT Hub](YwA4yEho8Lkh--rL8B8u7.mdx).&#x20;

# Step 1: Add the Azure IoT Hub using SAS Key Connector

Follow the steps to [Add a Connector](<../../../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **MQTT - Azure IoT Hub using SAS Key** provider.&#x20;
...
3. Double-click the **DataHub Subscribe&#xA0;**&#x6E;ode.
   ...
   - If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="kR15wDiWr6qqJeBRq9TVh" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../Product Features/68WrvuaKK8gVSMbo8bVxq/Dl_unmfRV6alPsSkyT4lP.mdx"} to learn more.&#x20;
...
7. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../Product Features/68WrvuaKK8gVSMbo8bVxq/Afi9wqefeN0u5YmHVBn5G.mdx>) for more details.&#x20;
