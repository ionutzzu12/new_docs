...
If you don't see an option for a 64-bit version and only see a 32-bit version, refer to [Installation and Deployments Troubleshooting](<././././Troubleshooting/Installation and Deployments Troubleshooting.md>).
