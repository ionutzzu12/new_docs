...
Learn more about [Certificates](<././././Product Features/System/Network/Certificates.md>).
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/4WzJkTieEFwi1rirnct9O_adddevice.png" size="80" width="1046" height="528" caption="Conect a device icon" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/otBqkFAemo0q5HwXHp83u_image.png" size="80" width="1152" height="760" caption="User and Password fields" position="center" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/8zv8a-Uiw9gzPSK_AlK1S_image.png" size="80" width="1161" height="769" position="center" showCaption="false"></Image>

## MQTT SSL

The MQTT SSL option allows the client to connect to the server by providing the client configuration with certificates. Learn more about [Certificates](<././././Product Features/System/Network/Certificates.md>).
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/nT71NlLhA_dlySC6xUpTC_image.png" size="80" width="1150" height="756" caption="MQTT SSL fields" position="center" showCaption="true"></Image>
...
<hint type="info">
  **Note**: You can't connect the DeviceHub [MQTT Client](<MQTT Client.mdx>) to the MQTT Server if they are using the same Litmus Edge instance. This includes connecting through the Flows Manager or through an Integration connector. If they are using different Litmus Edge instances, they can connect. &#x20;
</hint>

When connecting the client, configure the following:

**Host**: Enter the IP address or domain name of your Litmus Edge instance. For example, if your Litmus Edge instance IP address is [https://192.168.0.26](https://192.168.0.26), ente&#x72;**&#x20;mqtt://192.168.0.26**.&#x20;
