...
- Submit the *Certificate Signing Request&#x20;*&#x69;n Litmus Edge to a certificate authority and subsequently receive the device certificate with all required parameters (CA Chain and Private Key). See [Manage Certificate Signing Requests](<../Product Features/System/Network/Certificates/bF_WM90XdVuQQDT4vPoQr.mdx>) for details.&#x20;
- Confirm with your IT department if you require a custom CA certificate to be uploaded to Litmus Edge before you add a device certificate. If you need to upload a custom CA certificate, see [Add a Custom CA Certificate](<../ENU/ENU/Product Features/System/b95PhFWmFc516r6yCWwJ0/Ls0gLfyNaT-TDFOgU6SNX/LjjsMicj0XKXVxkpz7cmf.mdx>) for details.&#x20;
...
Follow the steps to [Backup a Device](<../Product Features/System/Device Management/Backup/Restore/32ST0mVB5ESaCls-3YOXn.mdx>).&#x20;
