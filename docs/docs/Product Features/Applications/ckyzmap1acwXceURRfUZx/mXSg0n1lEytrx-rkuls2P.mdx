...
See :Link[System Requirements]{label="System Requirements" spaceId docId="gLtPRe4J7Pwurbmrvqca7" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel href="../../../../QuickStart Guide/GhaNpfCdRlH0OiNIyk1du.mdx"} to review the list of required and optional ports.&#x20;
