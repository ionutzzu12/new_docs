---
title: HPE GPIO (Gen1.3)
slug: quickstart-guide/industrial-systems-connection-guide/gpio/hpe-gpio-gen1
description: Review the following information for setting up and configuring the HPE GPIO (Gen1) driver.
docTags: 
createdAt: Thu May 28 2026 23:47:05 GMT+0300 (Eastern European Summer Time)
---

Review the following information for setting up and configuring the HPE GPIO (Gen1.3) driver.&#x20;
...
| ---------------------------- | ------------------------------------------------------------- |
| **Driver type**              | Serial                                                        |
| **Validated devices/series** | Use this driver to connect to your gateway hardware I/O port. |
...
| ------------------ | ---------- | ------------ | -------------- | ----------- | ----------- |
| DI\_bit            | bit        | R/W          | D              | 1           | 8           |
| DO\_bit            | bit        | R/W          | D              | 1           | 8           |
| Polarity\_bit      | bit        | R/W          | D              | 1           | 8           |
| Configuration\_bit | bit        | R/W          | D              | 1           | 8           |
| DI                 | byte       | R/W          | D              | 0           | 0           |
| DO                 | byte       | R/W          | D              | 0           | 0           |
| Polarity Inversion | byte       | R/W          | D              | 0           | 0           |
| Configuration      | byte       | R/W          | D              | 0           | 0           |
