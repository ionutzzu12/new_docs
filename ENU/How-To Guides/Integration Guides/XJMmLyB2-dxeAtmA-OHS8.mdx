...
Follow the steps to [Add a Connector](<../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **Aveva Data Hub** provider.&#x20;
...
4. Double-click the **DataHub Subscribe** node.
   ...
   - If needed, configure the Datahub Subscribe connection. See the *Step 3: Configure Connector Nodes* section in [Create a Flow](<../../ENU/Product Features/68WrvuaKK8gVSMbo8bVxq/Dl_unmfRV6alPsSkyT4lP.mdx>) to learn more.&#x20;
