...
- Submit the *Certificate Signing Request&#x20;*&#x69;n Litmus Edge to a certificate authority and subsequently receive the device certificate with all required parameters (CA Chain and Private Key). See [Manage Certificate Signing Requests](<../Product Features/System/K00xodiUcRZSv3JWl3g2N/fWOlnfU6bX3IkmjGs4DOr/-s0oOl7KEhb1NY5inHbPG.mdx>) for details.&#x20;
- Confirm with your IT department if you require a custom CA certificate to be uploaded to Litmus Edge before you add a device certificate. If you need to upload a custom CA certificate, see [Add a Custom CA Certificate](<../Product Features/System/K00xodiUcRZSv3JWl3g2N/fWOlnfU6bX3IkmjGs4DOr/dCTTjshh1fmC95_iwQNN2.mdx>) for details.&#x20;
...
Follow the steps to [Backup a Device](<../Product Features/System/Device Management/Backup/Restore/31Z_7DrDtGyjhwdmvPrHz.mdx>).&#x20;
