...
- Activate the device with Litmus Edge Manager. See [Activate an Edge Device](../../DTXnDPBaCvEGTyNLqNKbs/aWVArhXB_zrN99TFbRzZt.mdx) for more information.
...
<hint type="success">
  ...
  **Request a License Key**
  ...
  See [Upgrade a Node-Locked License](<../../../../../Product Features/System/Activation/Licenses/Online Node-Locked License Activations/uxLhmhDTtVe2xGeT31NTr.mdx>) or [Upgrade a Node-Locked License Offline](<../../../../../Product Features/System/Activation/Licenses/Offline Node-Locked License Activations/uCBj2Vh47FOcbTsKgvqXr.mdx>) for steps on upgrading licenses.
</hint>
