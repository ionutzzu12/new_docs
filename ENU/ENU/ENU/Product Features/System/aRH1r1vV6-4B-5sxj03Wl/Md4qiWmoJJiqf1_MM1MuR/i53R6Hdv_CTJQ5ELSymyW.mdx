...
3. Go to either the Litmus Edge Web UI or the Terminal User Interface (TUI) and enter the address of the local NTP server.&#x20;
   - To use the Litmus Edge Web UI, update the *NTP Servers*. See :Link[Configure DNS/NTP Servers]{docId="WLZH6JfGdYQlATJM9JP_L" label="Configure DNS/NTP Servers" spaceId version="v2" docAnchorId="#ntp-servers" href="../../../../../Product Features/System/aRH1r1vV6-4B-5sxj03Wl/Md4qiWmoJJiqf1_MM1MuR.mdx"} to learn more.&#x20;
   - To use the TUI, update the *Configure Time* setting. See :Link[Access the Terminal User Interface]{docId="8sxmrg9ZcVUXt6V2i6Cxt" label="Access the Terminal User Interface" spaceId version="v2" docAnchorId="#configure-time" href="../../../../../QuickStart Guide/yQxcXE12X4qvj2U1lrzcw/Cpm64UZ-xvA5UDKcwA6_I.mdx"} to learn more.&#x20;
