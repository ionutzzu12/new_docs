...
slug: product-features/flows-manager/manage-the-flow-canvas
...
- **Settings**: See :Link[Manage User Settings]{docId="Am_U1xgEIMVAbIEg9u-_S" label="Manage User Settings" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Manage User Settings"}.
