...
slug: how-to-guides/integration-guides/azure-iot-hub/send-data-to-azure-iot-hub-with-sas-key
...
You must first :Link[Set up an Azure IoT Hub]{docId="Uaw77-If2Eys0LMB_Xtx1" label="Set up an Azure IoT Hub" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}.&#x20;

# Step 1: Add the Azure IoT Hub using SAS Key Connector

Follow the steps to :Link[Add a Connector]{docId="ytsWGWeU6H6oEUnHj5hW3" label="Add a Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId} and select the **MQTT - Azure IoT Hub using SAS Key** provider.&#x20;
...
3. Double-click the **DataHub Subscribe&#xA0;**&#x6E;ode.
   ...
   - If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="wh4ZihWF0PwMRYRbAZbco" label="Create a Flow" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId="#sQhVJ"} to learn more.&#x20;
...
7. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](../../../product-features/flows-manager/manage-the-flow-canvas.mdx) for more details.&#x20;
