...
- :Link[Create API Credentials]{docId="KHiz95m21m4jYZUApnVTS" label="Create API Credentials" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}.
- Validate the API token from the **Action menu&#x20;**&#x6F;f the API Token. See :Link[Manage API Credentials]{docId="tpNwuLxSnVNFrYe4wpDS6" label="Manage API Credentials" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
- Copy the API token (click the **Copy&#x20;**&#x69;con next to the *API token value)*. See :Link[Manage API Credentials]{docId="tpNwuLxSnVNFrYe4wpDS6" label="Manage API Credentials" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
