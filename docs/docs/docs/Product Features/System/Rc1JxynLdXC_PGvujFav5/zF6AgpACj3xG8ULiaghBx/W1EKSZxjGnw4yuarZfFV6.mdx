...
3. Go to either the Litmus Edge Web UI or the Terminal User Interface (TUI) and enter the address of the local NTP server.&#x20;
   - To use the Litmus Edge Web UI, update the *NTP Servers*. See :Link[Configure DNS/NTP Servers]{docId="ZNnYtuC0TSC-gH8QsYWML" label="Configure DNS/NTP Servers" spaceId version="v2" docAnchorId="#ntp-servers" href="../../../../../Product Features/System/Rc1JxynLdXC_PGvujFav5/zF6AgpACj3xG8ULiaghBx.mdx"} to learn more.&#x20;
   - To use the TUI, update the *Configure Time* setting. See :Link[Access the Terminal User Interface]{docId="6WZGbRP2bb5ezKDyGASew" label="Access the Terminal User Interface" spaceId version="v2" docAnchorId="#configure-time" href="../../../../../../QuickStart Guide/Access the Litmus Edge Web UI/eNx7bJhJ3CDDgdUqOcF0y.mdx"} to learn more.&#x20;
