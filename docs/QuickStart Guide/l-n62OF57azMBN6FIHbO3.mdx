...
<hint type="info">
  **Note:** You can also managing port in Litmus Edge. See :Link[Manage Firewall Rules]{label="Manage Firewall Rules" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="yoyxEJo_L-Pg5ki1PsLHm" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
</hint>
...
The firewall managing Litmus Edge's traffic must open specific ports for certain PLC devices to connect to Litmus Edge. To manage firewall rules in Litmus Edge, see :Link[Manage Firewall Rules]{label="Manage Firewall Rules" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="yoyxEJo_L-Pg5ki1PsLHm" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.&#x20;

Ports for Industrial Systems and Sensors Connections are PLC specific and should be open on a case-by-case basis. See the [Industrial Systems Connection Guide](2-Ltb7c8-8qpZ89JbkXo6.mdx) for more information.&#x20;
