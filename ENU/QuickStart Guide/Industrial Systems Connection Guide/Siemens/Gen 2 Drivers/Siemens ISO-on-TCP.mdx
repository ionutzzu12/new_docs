...
| **Validated devices/series** | [S7-1200](https://www.siemens.com/global/en/products/automation/systems/industrial/plc/s7-1200.html)&#xA;[S7-1500](https://new.siemens.com/global/en/products/automation/systems/industrial/plc/simatic-s7-1500.html) |
...
| ------------------- | ---------------------------------------- |
| **Type**            | Siemens                                  |
| **Driver**          | Siemens ISO-on-TCP                       |
| **Network Address** | The device address you defined in Step 1 |
| **Port**            | 102                                      |
| **Local TSAP**      | TCP-2                                    |
| **Remote TSAP**     | Keep this field empty                    |
...
| -------- | ----------------- | ------------------ | --------------- | --------------- | ------------------------------ |
| Basic    | byte, word, dword | DDDD               | 0               | 8191            | Raw Data, Address is an Offset |
| Buffer   | word              | D                  | 0               | 0               | Buffer                         |
