...
- See [Access the Terminal User Interface](<../../Access the Litmus Edge Web UI/eNx7bJhJ3CDDgdUqOcF0y.mdx>) for instructions on how to navigate and log in for the first time.
