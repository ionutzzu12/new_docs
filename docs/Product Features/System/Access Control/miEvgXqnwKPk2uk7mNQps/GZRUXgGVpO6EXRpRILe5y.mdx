...
- **Select RBAC Groups**: Select which access groups will have access to the client. See [Users](../moGMQ2wysFEIN34R8AE_n.mdx) to learn more.&#x20;
...
<hint type="info">
  **Important:&#x20;**&#x54;o set up and manage your OAuth 2.0 client, check the guide on :Link[How to Create and Use OAuth 2.0 Tokens in Litmus Edge]{label="How to Create and Use OAuth 2.0 Tokens in Litmus Edge" spaceId="SuELLqhxHnnKWA4eA6SOc" docId="Iugo2yhA5R1IDtTpbeoBy" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
</hint>
