...
Review the [AMQP TCP Integration Guide](<./././././How-To Guides/Integration Guides/AMQP TCP Integration Guide.md>).&#x20;

## Overview

AMQP TCP integration enables an Edge System to connect with an AMQP broker.
...
| Port                 | Enter the AMQP broker port                                                                                                                                                                            | Yes          |
