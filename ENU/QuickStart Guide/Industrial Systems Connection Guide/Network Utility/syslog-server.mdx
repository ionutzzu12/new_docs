...
See [Syslog Server Reference](<../../../ENU/QuickStart Guide/Industrial Systems Connection Guide/Network Utility/syslog-server/syslog-server-reference.mdx>) for more information.&#x20;
