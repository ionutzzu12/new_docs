...
- [Create API Credentials](kbsleyYhvGFbX6Pwcmvk0.mdx).
- Validate the API token from the **Action menu&#x20;**&#x6F;f the API Token. See [Manage API Credentials](<../../../../../../Product Features/System/Access Control/Tokens/xNcTiWe0UhjrIZhlvPIwN.mdx>) to learn more.&#x20;
- Copy the API token (click the **Copy&#x20;**&#x69;con next to the *API token value)*. See [Manage API Credentials](<../../../../../../Product Features/System/Access Control/Tokens/xNcTiWe0UhjrIZhlvPIwN.mdx>) to learn more.&#x20;
