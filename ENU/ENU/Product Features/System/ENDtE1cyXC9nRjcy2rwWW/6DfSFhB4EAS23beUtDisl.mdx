...
You can also configure static routes in the Terminal User Interface (TUI) or through REST API. See [Access the Terminal User Interface](<../../../../QuickStart Guide/Access the Litmus Edge Web UI/iAraP2Cg9XKflMp1yOFrt.mdx>) to learn more.&#x20;
...
- Only Admin users are able to add static routes. See :Link[Access Control]{label="Access Control" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="DMt2U3feL_9GEgOyos0FK" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
