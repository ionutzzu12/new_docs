...
After connecting the device, add the following tag. See :Link[Add Tags]{label="Add Tags" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="XgWOkQbTPevII7OR82LL0" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more. Only one tag will be used for simulating the different Moving processor outputs mentioned above.
...
2. Click **Save.**
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/RATjN77ITpAJLV_3_2i7p_image.png "Moving Average dialog box")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/iO_k59vGqpqUpLj-DxxtB_image.png "Completed Moving Average flow canvas")
...
1. Click **Add processor** again and select **Moving Maximum**.
   ...
   - **Window Size:&#x20;**&#x45;nter the number of values you want the function to consider.
2. Click **Save**.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Llb9yIaiMoQ6h8ClXS6sZ_image.png "Moving Maximum dialog box")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/IJMJ3tknbGfpzAuk6jO5M_image.png "Completed Moving Maximum flow canvas")
...
1. Click **Add processor** again and select **Moving Minimum**.
   ...
   - **Window Size:&#x20;**&#x45;nter the number of values you want the function to consider.
2. Click **Save**.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/mz2rgydGIGMqMKHwtw8kv_image.png "Moving Minimum dialog box")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/7-5_DVeRji3igK8ZzYAUT_image.png "Completed Moving Minimum flow canvas")
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Fbtp7g0bphCi6xwA7Tj5E_image.png "Moving Average Processor Output")

## View Moving Maximum Output

The maximum function finds the largest of last 10 values from the defined *tag1* values.

![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/92_tIhvb6ijk_rSK5BoU9_image.png "Moving Maximum Processor Output")

## View Moving Minimum Output

The minimum function finds the smallest of last 10 values from the defined *tag1* values.

![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/VicTmQsnJxFLpxpzpJl0n_image.png "Moving Minimum Processor Output")
