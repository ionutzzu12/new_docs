...
Define your script in the Code Editor. The editor is a user-friendly interface for writing and editing JavaScript, supporting syntax highlighting and real-time validation. Write the JavaScript code you want to execute. Learn more [here](https://www.w3schools.com/js/).
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/blxh7gPWDxR9zAZlBwrfT_image.png" size="80" width="1918" height="964" position="flex-start" indent="2" showCaption="false"></Image>

- **Validate**
  Validate your code.

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/c0PPDqsXX8klBwb9ZmShI_image.png" size="80" width="767" height="406" position="flex-start" indent="2" showCaption="false"></Image>

<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *JavaScript Processor&#x20;*&#x70;rocessor, refer the [Use the JavaScript Processor Function](<././././How-To Guides/Analytics Guides/Use the JavaScript Processor Function.md>) guide for more details.
</hint>
