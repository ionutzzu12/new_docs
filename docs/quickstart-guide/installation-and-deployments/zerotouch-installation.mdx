...
slug: quickstart-guide/installation-and-deployments/zerotouch-installation
docTags: 
...
If several URLs are displayed, use the first one. See [Access the Litmus Edge Web UI](../fLzmpdmbELjQU6mB_7GMA.mdx) for more information.&#x20;
