...
Follow the steps to [Add a Connector](<../../ENU/Product Features/Xgrv-_ps5irJcZlfL22DG/dDu4AKvRbiI_S8SeXkpia.mdx>) and select the **AMQP SSL** provider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see [AMQP SSL](<../../Product Features/Integration/Integration Connectors/Message Brokers/aYXxYiiG04ZFseDb92MLV.mdx>) and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
