...
Learn more about :Link[Certificates]{docId="s0U2D435yoVVrrtj5T-Jr" label="Certificates" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
...
The MQTT SSL option allows the client to connect to the server by providing the client configuration with certificates. Learn more about :Link[Certificates]{docId="s0U2D435yoVVrrtj5T-Jr" label="Certificates" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
...
See the :Link[Define Optional Parameters]{docId="IxDarLhX06j-kM1HeO34R" label="Connect a Device" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId="#step-3-additional-attributes" loadingMethod="dynamic" overridedLabel="Define Optional Parameters"} section to learn more about additional options.&#x20;
...
<hint type="info">
  **Note**: You can't connect the DeviceHub :Link[MQTT Client]{docId="vwrlrDdwjGnlBOqK-lrjX" label="MQTT Client" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to the MQTT Server if they are using the same Litmus Edge instance. This includes connecting through the Flows Manager or through an Integration connector. If they are using different Litmus Edge instances, they can connect. &#x20;
</hint>
