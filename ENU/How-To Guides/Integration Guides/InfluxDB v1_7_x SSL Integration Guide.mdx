...
- [Enable HTTPS with InfluxDB](https://docs.influxdata.com/influxdb/v1/administration/https_setup/)
...
Follow the steps to [Add a Connector](<./././Product Features/Integration/Add a Connector.md>) and select the **DB - InfluxDB v1.7.x SSL&#x20;**&#x70;rovider.&#x20;
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/-4X0ecoEZdAEOcKNSfj3W_influxdb17ssl.png" size="60" width="388" height="358" position="flex-start" showCaption="false"></Image>
