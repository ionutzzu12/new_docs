...
- Access to Litmus Edge WebUI. See [Access the Litmus Edge Web UI](<../../../../../QuickStart Guide/U0ysScw1b4iCeuqqo-MC5.mdx>).
- Access to Databricks workspace URL and access token.

# Step 1: Add Device

Follow the steps to [Connect a Device](<../../../../Product Features/DeviceHub/T8nX0itgnIY8ltxcJAFsG/t1scfzE7ZGrTKq0YgKW8g.mdx>). The device will be used to store tags that will be eventually used to create outbound topics in the connector. Make sure to select the **Enable Data Store** checkbox.&#x20;
...
<hint type="info">
  **Note:&#x20;**&#x54;o generate *CSV*, *JSON*, or *Parquet* files for syncing with the Databricks Unity Catalog, you can utilize the [File Reading Processor](<../../../Product Features/4B5Sgl13RYerzVbfE9zCC/EnUe-statistical-functions/file-reading-processor.mdx>) in Litmus Edge.
</hint>
