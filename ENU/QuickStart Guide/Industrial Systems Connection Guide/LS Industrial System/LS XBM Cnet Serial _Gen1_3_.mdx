...
slug: quickstart-guide/industrial-systems-connection-guide/ls-industrial-system/ls-xbm-cnet-serial-gen1
...
| ---------------------------- | --------------------------------------------------------- |
| **Driver type**              | Serial                                                    |
| **Validated devices/series** | LS Electric XBM Series with communication module XGL-CH2A |
...
| **Driver**             | LS XBM Cnet Serial (Gen1.3)       |
