...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Statistical Functions&#x20;*&#x70;rocessor, refer the :Link[Use the Statistical Tests Function]{label="Use the Statistical Tests Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="dIpnIkp1WK0iHbxL1DgV3" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}  guide for more details.
</hint>
