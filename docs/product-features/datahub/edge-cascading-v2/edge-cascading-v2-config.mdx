...
slug: edge-cascading-v2-config
docTags: 
createdAt: Tue Jan 27 2026 20:22:45 GMT+0200 (Eastern European Standard Time)
---

This guide explains the configuration options available for Edge Cascading v2. For complete setup examples, see the [Single Hub and Multi-Spoke Deployment Scenario](edge-cascading-v2-deploy.mdx) topic.
