...
Configure the following parameters when you [Connect a Device](<../../../ENU/Product Features/qDV3AZpxurItY0hScn5FH/36ZpLd_nEeqQvUAOKFxvf/sCrWEhYJ8UZnuYSbQ-0se.mdx>) with this driver. Update default values to the specific setup of your device.
