...
- [Enabling TLS Support in RabbitMQ](https://www.rabbitmq.com/ssl.html#enabling-tls)
...
Follow the steps to [Add a Connector](<./././Product Features/Integration/Add a Connector.md>) and select the **AMQP SSL** provider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see [AMQP SSL](<./././Product Features/Integration/Integration Connectors/Message Brokers/AMQP SSL.md>) and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/8KBgai2vx5kuY8puFgarA_amqpssl.png" size="60" width="388" height="358" position="center" showCaption="false"></Image>
