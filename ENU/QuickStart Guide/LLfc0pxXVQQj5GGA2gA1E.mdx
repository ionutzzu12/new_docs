...
<hint type="info">
  **Note:** You can also managing port in Litmus Edge. See :Link[Manage Firewall Rules]{label="Manage Firewall Rules" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="kxLt_fP_rRXgDB3uSXOmC" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
</hint>
...
The firewall managing Litmus Edge's traffic must open specific ports for certain PLC devices to connect to Litmus Edge. To manage firewall rules in Litmus Edge, see :Link[Manage Firewall Rules]{label="Manage Firewall Rules" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="kxLt_fP_rRXgDB3uSXOmC" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.&#x20;

Ports for Industrial Systems and Sensors Connections are PLC specific and should be open on a case-by-case basis. See the :Link[Industrial Systems Connection Guide]{docId="vyCb88Feafh1OWHoczALG" label="Industrial Systems Connection Guide" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Industrial Systems Connection Guide"} for more information.&#x20;
