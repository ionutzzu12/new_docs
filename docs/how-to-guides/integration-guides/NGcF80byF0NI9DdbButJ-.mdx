...
Follow the steps to :Link[Add a Connector]{docId="ytsWGWeU6H6oEUnHj5hW3" label="Add a Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId} and select the **DB - MySQL SSL&#x20;**&#x70;rovider.&#x20;
