...
slug: how-to-guides/integration-guides/influxdb-v3
description: Learn how to set up the InfluxDB v3 connector to stream time-series data from Litmus Edge directly into an InfluxDB v3 measurement.
docTags: 
...
<table isTableHeaderOn="true" columnWidths="302,696">
  <tr>
    <td>
      Deployment Type
    </td>
...
<table isTableHeaderOn="true" columnWidths="212,182,228,375">
  <tr>
    <td>
      Payload Field
    </td>
...
<table isTableHeaderOn="true" columnWidths="369,159,158,311">
  <tr>
    <td>
      Payload Field
    </td>
