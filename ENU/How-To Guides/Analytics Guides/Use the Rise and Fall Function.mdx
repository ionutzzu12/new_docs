...
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/k5lwGS8Eg3HNhonWdka96_image.png "rise and fall dialog box")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/I4Ba-kd5BWQoSh4fgqSkB_image.png "Completed analytics flow canvas")
...
1. Click **Add processor** again and select **Rise and Fall&#x20;**&#x70;rocessor.
   ...
   - **Lower:** Enter **70** for lower threshold value.
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/UyqVy0lEmDwGpm7TXrvUe_image.png "rise and fall dialog box")
3. Connect the DataHub Subscribe processor (tag: *temperature*) to the Rise and Fall processor with a wire and use the **events** connection.
4. On the analytics canvas, click **Save**.

The configured analytics flows should look like the following:&#x20;

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/95PWcyu4J_226gmVAvtql_image.png "Completed analytics flow canvas")
...
1. Click **Add processor** again and select **Rise and Fall&#x20;**&#x70;rocessor.
   ...
   - **Lower:** Enter **70** for lower threshold value.
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/LJ8udCR1F3nHal867cMTF_image.png "rise and fall dialog box")
3. Connect the DataHub Subscribe processor (tag: *temperature*) to the Rise and Fall processor with a wire and use the **events** connection.
4. On the analytics canvas, click **Save**.

The configured analytics flows should look like the following:&#x20;

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/E2ISHhq7Z4KZNpW4Z87oO_image.png "Completed analytics flow canvas")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/I7l-xFUGwOKrEb9fU7cn5_image.png "rise KPI Output")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/5w0X3f6agPvTdYXGRWbLV_image.png "fall KPI Output")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/WTtJ_5QauoHGa1rB619bX_image.png "riseAndFall KPI Output")
