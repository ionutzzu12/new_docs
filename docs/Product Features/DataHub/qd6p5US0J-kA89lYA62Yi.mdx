...
<hint type="info">
  **Important Notes**:&#x20;
  ...
  - If you select internal, make sure to select the *Enable Data Store* option for the device you want to store data for. See :Link[Enable Data Store]{label="Connect a Device" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="D4_KwNQkfuTMiAcfqY9v5" version="v2" docAnchorId="#0YCTg" loadingMethod="dynamic" overridedLabel="Enable Data Store"} to learn more.&#x20;
