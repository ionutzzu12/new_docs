...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **Google Cloud Pub/Sub Connector** provider.&#x20;
...
- **Custom Attributes**:  You can add custom attributes in key/value pairs for further data processing. Refer to the following to learn more:
  - [Use Custom Attributes in the Google Cloud Pub/Sub Connector](<../../../How-To Guides/Integration Guides/Google Cloud Pub/Sub Integration Guide/tmBx98mSK_oSJnSai0ibF.mdx>)
...
- [Create a Flow](<../../Product Features/68WrvuaKK8gVSMbo8bVxq/Dl_unmfRV6alPsSkyT4lP.mdx>) to view the messages coming from Google Pub/Sub through the connector you created.&#x20;
- Visualize the incoming data using one of the dedicated [Applications](<../../../Product Features/0vRF5bj1ZBmIj-wPDSPf1.mdx>) such as [Grafana](../C3fzsinpnjPwNfDGmQXhw/vA5ZP1_MFR-n9SeHvqfri.mdx).&#x20;
