...
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/4gmVV6Z2YIilbqXMgH4Yw_image.png "Normalization dialog box")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/XcdTnR963am5Yzx8cKyGR_image.png "Completed Normalization flow canvas")
...
1. Click **Add processor** again and select **Normalization&#x20;**&#x70;rocessor.
   ...
   - **Window Size:&#x20;**&#x45;nter the number of values you want the function to consider.
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/q2Go2HgTPF1v6IIjoFuum_image.png "Normalization dialog box")
3. Connect the DataHub Subscribe processor (tag: *tag1*) to the Normalization processor with a wire and use the **events&#x20;**&#x63;onnection.
4. On the analytics canvas, click **Save**.

The configured analytics flows should look like the following:&#x20;

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/1VK1DIM9XEn5-Q0xUyF8H_image.png "Completed Normalization flow canvas")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/CNXufZ8NLTsMSwWhEg27C_image.png "Min-Max Normalization Output")

## View Average-Standard Deviation Normalization Output

The normalization function normalizes the last 5 values from the defined *tag1*, and the next value is again placed between 0 and 1 based on the previous window.&#x20;

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/i61iTf514dmby6HSZGqa4_image.png "Average-Standard Deviation Normalization Output")
