...
slug: product-features/system/network/configure-dns-ntp-servers/configure-local-ntp-server
...
3. Go to either the Litmus Edge Web UI or the Terminal User Interface (TUI) and enter the address of the local NTP server.&#x20;
   - To use the Litmus Edge Web UI, update the *NTP Servers*. See :Link[Configure DNS/NTP Servers]{docId="pGZWSr3Dtjm4dgl2x93Ab" label="Configure DNS/NTP Servers" spaceId version="v2" docAnchorId="#ntp-servers" href="../configure-dns-ntp-servers.mdx"} to learn more.&#x20;
   - To use the TUI, update the *Configure Time* setting. See :Link[Access the Terminal User Interface]{docId="TReVmtf8z-5YhmYPnmo-C" label="Access the Terminal User Interface" spaceId version="v2" docAnchorId="#configure-time" href="../../../../quickstart-guide/access-the-litmus-edge-web-ui/access-the-terminal-user-interface.mdx"} to learn more.&#x20;
