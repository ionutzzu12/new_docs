...
2. Click the **Start Capture** button.
   ...
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/IBUXCh_tVm2-qKdZi-rWC_image.png)
...
4. Set the capture **Duration&#x20;**(from 1 to 30 minutes).
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/KCAc33TilSW9hg7E6xrR5_image.png)
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/7Xl2YWHdwcs5eML8cg_Fw_image.png)

# Stop Packet Capture

You can stop the capture manually at any time by clicking the **Stop** button.&#x20;

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/gUll-cbTMu17uKxhaR75w_image.png)

# Download Packet's Captured

You can download the capture manually once it is finished by clicking the **Download&#x20;**&#x62;utton.&#x20;

![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/eXsAl0JkN0NuhgbzX8L5Y_image.png)

<hint type="info">
  **Note:** The file you downloaded is in `.pcap` format. To open and examine these files, you can utilize tools such as [Wireshark](https://www.wireshark.org/docs/wsug_html_chunked/ChIOOpenSection.html).
</hint>
