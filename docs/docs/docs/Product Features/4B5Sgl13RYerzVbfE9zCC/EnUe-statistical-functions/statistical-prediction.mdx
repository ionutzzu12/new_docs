...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Statistical Prediction&#x20;*&#x70;rocessor, refer the :Link[Use the Statistical Prediction Function]{label="Use the Statistical Prediction Function" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="QDEpT8PP-nk6VDCcQyKLY" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}  guide for more details.
</hint>
