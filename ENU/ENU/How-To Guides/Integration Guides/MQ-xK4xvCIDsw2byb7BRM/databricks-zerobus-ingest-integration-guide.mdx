...
If you see a *Failed* status, review the [Manage Connectors](<../../../Product Features/LR02cKZrqRt_aoIMAeuRN/tCiWQXqqwmrfdnUMGcl3j.mdx>) page and the relevant error messages.
