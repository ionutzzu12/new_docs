...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/2-UCRLFSRK14ramqhVm36.mdx>) and select the **MQTT - Amazon AWS IoT Core over SSL&#x20;**&#x70;rovider.
...
1. Follow the steps to [Create a Flow](<../../../Product Features/Flows Manager/HBH_feHBlPPJpVuXPyCAK.mdx>) and add the following nodes.
   - **DataHub Subscribe&#x20;**
   - **Debug**
...
4. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="KYuZm3Zwx8ZYXCjdm6hn6" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" overridedLabel="Create a Flow" href="../../../Product Features/Flows Manager/HBH_feHBlPPJpVuXPyCAK.mdx"} to learn more.&#x20;
5. Click **Done**, and then click **Deploy**.
6. Click the **debug&#xA0;**&#x74;ab. See the *Additional Options* section in [Manage the Flow Canvas](<../../Product Features/d6Gdnkct4qETfXoFXUIfx/-rsFCblTw9z7ExVVKp2Sl.mdx>) for more details.&#x20;
