---
title: Modbus ASCII (Gen1)
slug: quickstart-guide/industrial-systems-connection-guide/modbus/modbus-ascii-gen1
description: Review the following information for setting up and configuring the Modbus ASCII (Gen1) driver.
docTags: 
createdAt: Thu May 28 2026 23:47:03 GMT+0300 (Eastern European Summer Time)
---

<hint type="info">
  **Note**: This driver will be deprecated in a future release. We recommend using the Gen 2 [Modbus ASCII](<././Gen 2 Drivers/Modbus ASCII.md>).
</hint>

Review the following information for setting up and configuring the Modbus ASCII (Gen1) driver.&#x20;
...
| **Replaced with Gen 2 driver** | [Modbus ASCII](<././Gen 2 Drivers/Modbus ASCII.md>) |
...
| C        | bt              | DDDD               | 0               | 9999            | Discrete Output Coils           |
