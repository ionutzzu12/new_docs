...
Follow the steps to [Add a Connector](<../../ENU/Product Features/Xgrv-_ps5irJcZlfL22DG/dDu4AKvRbiI_S8SeXkpia.mdx>) and select the **Google Cloud Pub/Sub Connector** provider.&#x20;
...
- **Custom Attributes**:  You can add custom attributes in key/value pairs for further data processing. Refer to the following to learn more:
  - [Use Custom Attributes in the Google Cloud Pub/Sub Connector](<../../ENU/How-To Guides/Integration Guides/j_cBRohbRLF-rcmeLCJ_-/OgdVVxYxZFzRcRXFj3gx_.mdx>)
...
- [Create a Flow](<../../Product Features/Flows Manager/ddBsmAZtGH9krDnb5AEyU.mdx>) to view the messages coming from Google Pub/Sub through the connector you created.&#x20;
- Visualize the incoming data using one of the dedicated [Applications](<../../Product Features/SELEg_S3bA0hxfxG3aPFC.mdx>) such as [Grafana](<../Applications Guides/zjXhvRfu26kpALy0wMJLt.mdx>).&#x20;
