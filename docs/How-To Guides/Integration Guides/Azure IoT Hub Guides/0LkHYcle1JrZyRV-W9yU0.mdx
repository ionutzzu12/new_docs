...
You must first :Link[Set up an Azure IoT Hub]{docId="dFo6qW06wSIeWdJWZTzt-" label="Set up an Azure IoT Hub" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}. When you add the IoT device to the hub, select **X.509 Self-Signed** as the **Authentication type&#xA0;**&#x77;hen you add the IoT device in Azure.&#x20;
...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/2-UCRLFSRK14ramqhVm36.mdx>) and select the **MQTT - Azure IoT Hub using Device Certificates** provider. Define the following parameters.&#x20;
...
Before creating the topics copy the *Raw Topic* parameter for all tags you want to use for topics. See [Manage Tags](<../../../docs/docs/Product Features/0W8IDE7pms-wfQxZMG8Ep/v_j35-Rcple3NFDsiSHfU/chaCE4zDG6YsdhTsyHBzh.mdx>) for more information.
...
5. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="KYuZm3Zwx8ZYXCjdm6hn6" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../Product Features/Flows Manager/HBH_feHBlPPJpVuXPyCAK.mdx"} to learn more.&#x20;
6. Click **Done**, and then click **Deploy**.
7. Check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../docs/Product Features/d6Gdnkct4qETfXoFXUIfx/-rsFCblTw9z7ExVVKp2Sl.mdx>) for more details.&#x20;
