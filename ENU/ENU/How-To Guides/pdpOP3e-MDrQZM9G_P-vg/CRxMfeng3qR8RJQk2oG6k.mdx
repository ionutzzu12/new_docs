...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **AMQP TCP&#x20;**&#x70;rovider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see [AMQP TCP](<../../../Product Features/Integration/Integration Connectors/Message Brokers/vrw0d3hNiXwwvEWf9Ud2e.mdx>) and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
