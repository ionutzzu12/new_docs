...
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/NjeODEEcC4UqgicOF7Nnw_image.png "Combination Pocessor dialog box")
...
2. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/w26zM7NVOstD5fnXsVUlZ_image.png "Combination Pocessor dialog box")
3. Connect the DataHub Subscribe processor (tag: *Combine\_selected\_fields)* to the Combination processor with a wire and enter the definition of **combineselect&#x20;**&#x66;or the connection.
4. Connect the DataHub Subscribe processor (tag: *Combine\_all\_fields*) to the Combination processor with a wire and enter a definition of **combineall&#x20;**&#x66;or the connection.
5. On the analytics canvas, click **Save**.
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/iV6uFsC1u7nUIw2FHvtDt_image.png "Completed Analytics Flow")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/v-7Lh-gRTywVNdGu4qxxy_image.png "Selected Fields in Output")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/jopnvNW3f5U6Bryatv3Gp_image.png "All Fields in Output")
