...
For a Litmus Edge to carry a site license, you will need a connection with a license server. The Litmus Edge can connect to Litmus Edge Manager (which contains an embedded license server that the Litmus Edge will automatically connect to) or a standalone license server. See [License Server Installation](<../ENU/QuickStart Guide/NyWAQm5OPiDJ27ioRlTW6/LjAvdcvRlU9s3MbVum-Iz.mdx>) for details.
...
To retrieve a site license from a license server for Litmus Edge, see [Set a License Server](<../ENU/ENU/Product Features/System/iHQKLbDMiX3GEgZ1pBTFr/j9YIvESKKiKALBjUoR8oW/3fxmqSmDrv3WUpUrC662I.mdx>).
...
- [Activate a Node-Locked License Online](<../Product Features/System/Activation/Licenses/Online Node-Locked License Activations/FgyvwsFVYPsXAiZyD3Mle.mdx>)
- [Activate a Node-Locked License Offline](<../ENU/ENU/ENU/Product Features/System/iHQKLbDMiX3GEgZ1pBTFr/j9YIvESKKiKALBjUoR8oW/SSfTZ7pDrrfVO7Cu8iGi7/C0s5rsUkwZpQoqZ71t8uQ.mdx>)
