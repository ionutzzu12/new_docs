...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Compliance and Loss&#x20;*&#x4B;PI, refer the :Link[Use the Compliance and Loss KPI]{label="Use the Compliance and Loss KPI" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="uyyRGh7SPs56ac8hJ1Wh-" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
