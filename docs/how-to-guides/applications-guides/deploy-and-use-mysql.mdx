...
slug: how-to-guides/applications-guides/deploy-and-use-mysql
...
7. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="wh4ZihWF0PwMRYRbAZbco" label="Create a Flow" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId="#step-3-configure-connector-nodes" overridedLabel="Create a Flow"} to learn more.&#x20;
8. Click **Deploy**.&#x20;
