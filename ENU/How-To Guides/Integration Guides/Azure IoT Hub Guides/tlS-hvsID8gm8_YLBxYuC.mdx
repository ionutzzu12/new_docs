...
3. Add topics to the connector with the details below. See :Link[Add Topics to Connectors]{label="Add Topics to Connectors" spaceId docId="KTs6KmicPU5hbLIBRmn28" version="v2" docAnchorId="#IQNU7" loadingMethod="dynamic" overridedLabel href="../../../Product Features/Integration/rUxzv307WZUQThP-fwrMO.mdx"} for more information.&#x20;
