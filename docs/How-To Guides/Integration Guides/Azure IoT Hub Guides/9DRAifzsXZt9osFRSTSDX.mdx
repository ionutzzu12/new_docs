...
1. Follow the steps to [Create a Flow](<../../../docs/Product Features/tAQ2y6xPYLoNqxyFDrrb-/EfWU7FhzSuuhmZvRB11Ad.mdx>) and add the following nodes.
   - **DataHub Subscribe**:&#x20;
   - **Debug**
...
3. Double-click the **DataHub Subscribe&#xA0;**&#x6E;ode.
   ...
   - If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="U2ZE0GLAydau4Z5agvqMV" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../docs/Product Features/tAQ2y6xPYLoNqxyFDrrb-/EfWU7FhzSuuhmZvRB11Ad.mdx"} to learn more.&#x20;
...
7. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../docs/Product Features/tAQ2y6xPYLoNqxyFDrrb-/BIKDEdE9sU71jeGrPO9qu.mdx>) for more details.&#x20;
