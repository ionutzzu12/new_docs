...
You must first [Set up an Azure IoT Hub](HEhrG898B6vDoufnBT0z5.mdx). When you add the IoT device to the hub, select **X.509 Self-Signed** as the **Authentication type&#xA0;**&#x77;hen you add the IoT device in Azure.&#x20;
...
Follow the steps to [Add a Connector](<../../../Product Features/LR02cKZrqRt_aoIMAeuRN/Oltgmv6mo5teuzS_GsNx1.mdx>) and select the **MQTT - Azure IoT Hub using Device Certificates** provider.&#x20;
...
1. Follow the steps to [Create a Flow](<../../../Product Features/yOXP8Qb_U_AFnbdqxZSd4/7xvHQOytaduG1w9sa5Jh8.mdx>) and add the following nodes.
   - **DataHub Subscribe**:&#x20;
   - **Debug**
...
11. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../Product Features/yOXP8Qb_U_AFnbdqxZSd4/bSXnAa7thWL0_2-05LetC.mdx>) for more details.&#x20;
