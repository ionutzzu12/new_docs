...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/2-UCRLFSRK14ramqhVm36.mdx>) and select the **AMQP SSL** provider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see [AMQP SSL](<../../../Product Features/Integration/Integration Connectors/Message Brokers/RNNfGoXEqGA7XjRfnNGkF.mdx>) and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
