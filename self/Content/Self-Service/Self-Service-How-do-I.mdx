...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **My Items**. A list of your submitted service requests and reported incidents is displayed:
     - To find a specific item, enter a keyword into the **Search My Items** field and use the drop-down list to focus the search. Then click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/M_TBbmBh766i4IV6JY-jP_search-icon14x12.png" alt caption} icon.
  ...
  For more information, see [My Items](docId\:BvEMNMWXGqcyYBqh6ZohS).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  For more information, see [Service Requests and Incidents](docId\:VFdmKutzpXWJ55tUByiF1).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  To find specific messages, enter text in the **Search Post** field (top right of page) and click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/UbAUvFG0Kw-rDtXRubXDt_search-icon14x13.png" alt caption} icon.

  To filter the real-time stream of messages in the main pane, use the filter criteria in the left Activity Stream pane.

  For more information, see [Social Board messages](docId\:DO0IStfJtoDfXN-yBCcMw).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  For more information, see [Announcements, FAQs, and Alerts](docId\:j7vYG8-pIcuDhZErIPR8Y).
</ExpandableHeading>
