...
When you [Add a Tag]() to the connected device, see the following Register Table and Tag Parameters sections. You can also [Browse and Add Tags from a Device](../../../product-features/devicehub/tags/browse-tags.mdx) for the device.
