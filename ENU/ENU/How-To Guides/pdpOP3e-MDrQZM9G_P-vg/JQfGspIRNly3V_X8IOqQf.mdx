...
- [DB - Microsoft SQL Server](<../../../Product Features/Integration/Integration Connectors/Databases/S-8vMT8nB4MEdvIOV2ItV.mdx>)
- [DB - Microsoft SQL Server SSL](<../../../Product Features/Integration/Integration Connectors/Databases/hTN-M1XDDp4RyOOwCYXb6.mdx>)
- [DB - MySQL](<../../../Product Features/Integration/Integration Connectors/Databases/lnAV6Q0BIjI_R294L46jd.mdx>)
- [DB - MySQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/OTA_jhEtKcqpjCo-h2F77.mdx>)
- [DB - PostgreSQL](<../../../Product Features/Integration/Integration Connectors/Databases/HyfGTkf3s0_s5t4627mz6.mdx>)
- [DB - PostgreSQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/62dmPrzXl6LyxQAmku2rv.mdx>)
- [DB - MongoDB](<../../../Product Features/Integration/Integration Connectors/Databases/wWe1SeSdh3IVxSOJipOiZ.mdx>)
- [DB - Mongo v4+](<../../../Product Features/Integration/Integration Connectors/Databases/z7ld0UzEw6bu4kfxizXyi.mdx>)
...
If you set up a connection with [DB - Microsoft SQL Server](<../../../Product Features/Integration/Integration Connectors/Databases/S-8vMT8nB4MEdvIOV2ItV.mdx>) or [DB - Microsoft SQL Server SSL](<../../../Product Features/Integration/Integration Connectors/Databases/hTN-M1XDDp4RyOOwCYXb6.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.&#x20;
...
If you set up a connection with [DB - MySQL](<../../../Product Features/Integration/Integration Connectors/Databases/lnAV6Q0BIjI_R294L46jd.mdx>) or [DB - MySQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/OTA_jhEtKcqpjCo-h2F77.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
If you set up a connection with [DB - PostgreSQL](<../../../Product Features/Integration/Integration Connectors/Databases/HyfGTkf3s0_s5t4627mz6.mdx>) or [DB - PostgreSQL SSL](<../../../Product Features/Integration/Integration Connectors/Databases/62dmPrzXl6LyxQAmku2rv.mdx>) and select **Create table**, an existing table will be used or a new one will be created using the following commands.
...
- [MySQL Integration Guide](IGXgKE6GabTnnw5vbgJaL.mdx)
- [PostgreSQL Integration Guide](XygAKOuAfQ6IL0Ke5k31S.mdx)

These guides use DeviceHub data from devices and tags to create the data that will be sent to the database. Alternatively, you can also use [Analytics](<../../../Product Features/ddQv_vx-hJA0ktkDqcaGW.mdx>) or the [Flows Manager](<../../../Product Features/68WrvuaKK8gVSMbo8bVxq.mdx>) to create this data.&#x20;
