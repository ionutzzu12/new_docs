...
You must first [Set up an Azure IoT Hub](<../Azure IoT Hub Guides/cBE2vVrgnJYNq8FK63UBX.mdx>). When you add the IoT device to the hub, select **X.509 Self-Signed** as the **Authentication type&#xA0;**&#x77;hen you add the IoT device in Azure.&#x20;
...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/C5bo-JHYKWiLNMFY9iVsj.mdx>) and select the **MQTT - Azure IoT Hub using Device Certificates** provider. Define the following parameters.&#x20;
...
Before creating the topics copy the *Raw Topic* parameter for all tags you want to use for topics. See [Manage Tags](<../../../Product Features/DeviceHub/pucQJehoEvHwqcmrKM9cy/b1VEajs1Y4Grj8Rn3qUua.mdx>) for more information.
...
5. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="Nay58AX-cu8eMvJ5jUcQm" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../Product Features/Flows Manager/M-7nGo-rJyXZ37GawCjly.mdx"} to learn more.&#x20;
6. Click **Done**, and then click **Deploy**.
7. Check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../Product Features/34sTTMTBZO9bOWxfOE7kC/CKl1LMeZrekjdNexLVk4k.mdx>) for more details.&#x20;
