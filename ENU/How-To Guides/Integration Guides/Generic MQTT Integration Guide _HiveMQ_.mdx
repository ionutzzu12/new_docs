...
You must download [MQTT Explorer](http://mqtt-explorer.com/).

Visit the [MQTT Dashboard](http://www.mqtt-dashboard.com/) to find the settings required in the MQTT Explorer application.
...
Follow the steps to [Add a Connector](<./././Product Features/Integration/Add a Connector.md>) and select the **MQTT - Generic&#x20;**&#x70;rovider.&#x20;
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/lr3QYFh3sAl8wRZdPk1vN_mqttgeneric.png" size="60" width="369" height="345" position="center" showCaption="false"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Aj9tTx4BUmgxzEsVkWk3l_addnewsubicon.png" size="80" width="1279" height="325" caption="Add a new subscription icon" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Y6H9bnSXYEshKVHY7EUCY_gotoflowdefinition.png" size="80" width="1203" height="421" caption="Go To Flow Definition icon" position="center" indent="2" showCaption="true"></Image>

3. From the flow canvas, drag the **DataHub Publish** node (DataConnector section) and **Inject&#x20;**&#x6E;ode (Common section) to the canvas.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/RZawqMsuHHTpvY8MEgnBf_datahub-pub-and-inject-nodes.png" size="80" width="850" height="587" caption="The DataHub Publish and Inject nodes" position="center" indent="2" showCaption="true"></Image>

4. Connect the two nodes.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/AAATdRNUdC-pGwdpwlufS_inject-publish-nodes-connected.png" size="80" width="840" height="603" caption="The Inject node and DataHub Publish node connected" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/p4lMLgTf0dqt3oN_Gjtf4_outbound-topic-name.png" size="80" width="1236" height="476" caption="The local topic name for the outbound topic" position="center" indent="2" showCaption="true"></Image>

7. If needed, configure the Datahub Publish connection. See [Configure Connector Nodes](<./././Product Features/Flows Manager/Create a Flow.md>) to learn more.&#x20;
8. Click **Done**.&#x20;
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/f30O7kK1iIVIBwHiTqDzi_inject-node-properties.png" size="70" width="577" height="365" caption="Inject node properties" position="center" indent="2" showCaption="true"></Image>

12. Click **Done**, and then **Deploy**.&#x20;
13. Click the Inject node button to send the "test MQTT connection" message to the topic.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/tm_kY2RGCzwGf8VZZ4s1p_inject-button.png" size="80" width="869" height="584" position="center" indent="2" showCaption="false"></Image>

14. Verify that the message displays in MQTT Explorer.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/S8w5UzAv62c8Y4rLGQjl-_mqtt-explorer-message.png" size="80" width="999" height="677" caption="Message sent from the Flows Manager to the MQTT topic" position="center" indent="2" showCaption="true"></Image>
