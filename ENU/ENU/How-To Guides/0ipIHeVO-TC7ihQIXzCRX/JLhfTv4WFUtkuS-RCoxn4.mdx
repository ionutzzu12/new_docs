...
slug: JLhfTv4WFUtkuS-RCoxn4
description: Learn how to create a custom table in a MySQL database. 
docTags: 
createdAt: Mon Mar 04 2024 22:54:21 GMT+0200 (Eastern European Standard Time)
---
...
After connecting the device, :Link[Add a Tag]{docId="XgWOkQbTPevII7OR82LL0" label="Add Tags" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel="Add a Tag"} to the device. &#x20;
...
2. Click **Add Flow**.&#x20;
   ...
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/ygXFT_hIplmYcbdrL1MEU_flow-icon.png)
3. Fo&#x72;*&#x20;Processor Input*, select **DataHub Subscribe**.&#x20;
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/1ZZHYykbyQ_JtG7AkJyjy_datahubsubscribe.png)
4. Click the **Search&#x20;**&#x69;con and select the device and tag you previously created.&#x20;
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/cFOc0_s7WsvPgF7PIYEV-_topicsearch.png)
5. Click **Next**.&#x20;
6. For *Processor Function*, select **Conversion**. Then, select the **Celsius > Fahrenheit** conversion.&#x20;
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/aJUEEQSq1QHN2pO_WyCry_conversion2.png)
7. Click **Next**.&#x20;
8. For *Processor Output*, select **DataHub Publish**, Then, copy the topic name and store it somewhere securely for reference later.&#x20;
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/Ia9U9gayCgmhQl7FNgBH8_datahubpublish.png)
9. Click **Create Flow**.&#x20;
...
1. Navigate to **Flows Manager&#x20;**&#x61;nd create a new flow. See [Create a Flow](<../../../Product Features/Flows Manager/ddBsmAZtGH9krDnb5AEyU.mdx>) to learn more.&#x20;
2. Connect the following nodes together:
   ...
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/6ALwpDjFvMQK0YkpDmvBq_flowfull.png)
...
3. If needed, configure the Datahub Subscribe connection. See the *Step 3: Configure Connector Nodes* section in :Link[Create a Flow]{docId="bezDaqGGrrny6TWDnL9CK" label="Create a Flow" spaceId version="v2" docAnchorId="#step-3-configure-connector-nodes" loadingMethod="dynamic" overridedLabel href="../../../Product Features/Flows Manager/ddBsmAZtGH9krDnb5AEyU.mdx"} to learn more.&#x20;
...
2. Update **Set&#x20;**&#x74;o **Delete**.&#x20;
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/VFB1sZ9iyo_AUakxMiFQY_changedelete.png" size="70" width="528" height="334" position="center" showCaption="false"></Image>
3. In the msg. field, enter payload.metadata.&#x20;
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/SuXYg91fPSPq1Fo1W4qWf_firstchange.png" size="70" width="517" height="299" position="center" showCaption="false"></Image>
4. Click **+add**.&#x20;
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/qK27Mi71wur2D2t1w1KF__addchange.png" size="70" width="526" height="875" position="center" showCaption="false"></Image>
...
2. In the *Topic&#x20;*&#x66;ield enter a topic name. You will refer to this name later.&#x20;
   <Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/k5cS60IelFXdZfOgz3ysi_publishname.png" size="70" width="506" height="306" position="center" showCaption="false"></Image>
3. Click **Done**.&#x20;
...
2. Expand the message window beneath the flow.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/woDAMmFgulRO1sZTdx3NK_expanddebug-window.png)
3. Click the **Debug&#xA0;**&#x69;con to view the data output.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/LQSeWVyAJIbwiJomRgIXI_debugicon.png)
4. Confirm that the output is only including two items in the payload: *value&#x20;*&#x61;nd *timestamp*.&#x20;
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/F6Dmj1IpoblHz4L4PQeuk_output.png)
...
2. Click the **Terminal&#xA0;**&#x69;con next to the MySQL container.
   ...
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/9t2LYeH-mHRMjiVEnpZrv_terminalicon.png)
...
Follow the steps to [Add a Connector](<../../Product Features/Xgrv-_ps5irJcZlfL22DG/dDu4AKvRbiI_S8SeXkpia.mdx>) and select the **DB - MySQL&#x20;**&#x70;rovider.&#x20;
...
3. Click the **Topics&#x20;**&#x74;ab.
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/odNo8M5KEK95osYZnnQ8z_topicstab.png)
4. Click the **Add&#x20;**&#x69;con and select **Add a new subscription**.&#x20;
   ![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/RpmJjmFmSqptxQ56ThNVa_addnewsubscription.png)
...
![](https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/JqEg2_onpKXdX37AhedLs_image.png)
...
<Image src="https://archbee-image-uploads.s3.amazonaws.com/SSUUxKZUk9bFTEPNn_6Zo/g71z0s3b92tKVDjcyb1t7_image.png" size="40" width="288" height="280" position="center" showCaption="false"></Image>
