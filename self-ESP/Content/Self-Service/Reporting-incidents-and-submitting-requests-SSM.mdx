...
En algunos dispositivos, el Catálogo de servicios se puede ver como una lista o en mosaico. Alterne la vista pulsando icono de vista de lista :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/an8nxI4JRkQxYRTQIOEe6_list-icon16x12.png" alt caption} o el icono de vista de mosaico :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/jiopj4nqTp_Mp8NJoN0Y6_tile-icon16x11.png" alt caption} en la parte superior derecha de la página. Tenga en cuenta que la vista de mosaico muestra elementos en mosaicos grandes, que ocupan la mayor parte del espacio y se listan menos elementos en la pantalla.
...
- Para agregar un servicio a Favoritos, desde el espacio de trabajo Catálogo de servicio, pulse el icono de Favoritos :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/OClmHyRVwn40T2NcB1OFg_favorites-disabled.png" alt caption}. El icono de Favoritos cambia a :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/IS3AX5uYu_60IMbzHhxse_favorites-selected.png" alt caption}, aparecerá un mensaje que indica que el servicio seleccionado se ha agregado a Favoritos y el servicio se traslada a la parte superior de la lista junto a los otros servicios Favoritos.
...
<ExpandableHeading>
  ...
  1. Pulse el icono del Catálogo de servicios :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/nBGgQzuSQPBYHRI7ND5tq_servicecatalogicon.png" alt caption}.
...
<ExpandableHeading>
  ...
  1. Pulse el icono :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/MppBlyPR6kfeG1T_4CYXE_myitemsicon.png" alt caption} para abrir **Mis elementos**. Se muestra una lista de elementos abiertos.
