...
<hint type="info">
  **Note**: The **Enable Logging** option when connecting an edge device is only available for Gen 2 drivers. See :Link[Connect a Device]{label="Connect a Device" spaceId docId="pal6ABPZbrimdU9LvGJ30" version="v2" docAnchorId="#e31JR" loadingMethod="dynamic" overridedLabel href="connect-a-device.mdx"} for more details.
</hint>
