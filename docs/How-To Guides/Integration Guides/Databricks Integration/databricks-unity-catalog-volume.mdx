...
- Access to Litmus Edge WebUI. See [Access the Litmus Edge Web UI](<../../../QuickStart Guide/i861oBtdL-QNxXTt1b3ga.mdx>).
...
<hint type="info">
  **Note:&#x20;**&#x54;o generate *CSV*, *JSON*, or *Parquet* files for syncing with the Databricks Unity Catalog, you can utilize the [File Reading Processor](<../../../docs/Product Features/Analytics/statistical-functions/file-reading-processor.mdx>) in Litmus Edge.
</hint>
