...
- [Create API Credentials](ahK89YSBz1oTOl9pKOGlG.mdx).
- Validate the API token from the **Action menu&#x20;**&#x6F;f the API Token. See [Manage API Credentials](<../../../../ENU/ENU/ENU/Product Features/Lv4VprvL49Sh2xq8oEdH-/Z27GWlDGawhpAlMXldr-l/7YQnesVo2MQRGybXrX0J_/kvpUqNNt12TbLvtiJWwOd.mdx>) to learn more.&#x20;
- Copy the API token (click the **Copy&#x20;**&#x69;con next to the *API token value)*. See [Manage API Credentials](<../../../../ENU/ENU/ENU/Product Features/Lv4VprvL49Sh2xq8oEdH-/Z27GWlDGawhpAlMXldr-l/7YQnesVo2MQRGybXrX0J_/kvpUqNNt12TbLvtiJWwOd.mdx>) to learn more.&#x20;
