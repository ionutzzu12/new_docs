...
When you [Add a Tag](<../../../Product Features/DeviceHub/Tags/t2iGQ9bojYRXYfzs-cVi_.mdx>) to the connected device, see the following Register Table and Tag Parameters sections.&#x20;
