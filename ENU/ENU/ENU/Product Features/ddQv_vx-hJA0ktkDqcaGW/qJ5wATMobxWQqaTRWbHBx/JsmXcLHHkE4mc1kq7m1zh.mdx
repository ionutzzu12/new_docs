...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *Change of Value&#x20;*&#x4B;PI, refer the :Link[Use the Change of Value KPI]{label="Use the Change of Value KPI" spaceId="7QvCN5MYpwobQXnPvWc7V" docId="QSvcdYBmvem38MJWSWiV6" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
