...
3. Go to either the Litmus Edge Web UI or the Terminal User Interface (TUI) and enter the address of the local NTP server.&#x20;
   - To use the Litmus Edge Web UI, update the *NTP Servers*. See :Link[Configure DNS/NTP Servers]{docId="5sDa20M6W_iuKVlNYK3ce" label="Configure DNS/NTP Servers" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId="#ntp-servers"} to learn more.&#x20;
   - To use the TUI, update the *Configure Time* setting. See :Link[Access the Terminal User Interface]{docId="GhleJUcz08Slu1oLYF93U" label="Access the Terminal User Interface" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId="#configure-time"} to learn more.&#x20;
