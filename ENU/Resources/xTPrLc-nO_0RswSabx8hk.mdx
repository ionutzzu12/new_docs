...
<ExpandableHeading>
  ...
  Try the Litmus Edge [Installation and Deployments](<../QuickStart Guide/EmHliFGv5ujr9ktoGwG5Y.mdx>) guide to start using Litmus Edge concepts and procedures.
...
<ExpandableHeading>
  ...
  See :Link[Firewall Port Configuration Requirements]{label="System Requirements" spaceId docId="2HvbAMnACQvd83h0QIQDT" version="v2" docAnchorId="#firewall-port-configuration-requirements" loadingMethod="dynamic" overridedLabel="Firewall Port Configuration Requirements" href="../QuickStart Guide/ZsUv8XPBAcnL7VJ3pFBEr.mdx"} to learn more about other ports used by Litmus Edge services.&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Use Upgrade next to the core license on the License pane. You need a `.upd` file for the new version and a currently installed version of Litmus Edge that supports upgrades to the new version. See [Software Updates](<../ENU/QuickStart Guide/EmHliFGv5ujr9ktoGwG5Y/VZKxzlKe2YlF6uaqOn3Eh.mdx>) for details on which version you must start from to begin the upgrade process from Litmus Edge.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId docId="isKZIIEzoHV5OuLX-KCEP" version="v2" docAnchorId="#XMn0S" loadingMethod="dynamic" overridedLabel href="../Troubleshooting/w0pRmcF15_oOmkT-G5Nq3.mdx"} for reasons and steps to resolve these issues.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  Why is my CSV file not able to upload tags?

  Refer to :Link[DeviceHub Troubleshooting]{label="DeviceHub Troubleshooting" spaceId docId="isKZIIEzoHV5OuLX-KCEP" version="v2" docAnchorId="#25ovv" loadingMethod="dynamic" overridedLabel href="../Troubleshooting/w0pRmcF15_oOmkT-G5Nq3.mdx"} for possible reasons for this issue and how to resolve it.&#x20;
</ExpandableHeading>

<ExpandableHeading>
  What devices and drivers are supported?

  Check out the extensive lists of [Industrial Systems Connection Guide](<../QuickStart Guide/-7aeKA0Yvj7t8RGFEgbww.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  - There are 250+ device drivers included in DeviceHub. DeviceHub supports many PLC manufacturers, such as Siemens, Allen-Bradley, Mitsubishi, Omron. See also [Industrial Systems Connection Guide](<../QuickStart Guide/-7aeKA0Yvj7t8RGFEgbww.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  Before exporting nodes, select the nodes and connecting wires within a flow tab. See [Manage the Flow Canvas](<../ENU/Product Features/68WrvuaKK8gVSMbo8bVxq/Afi9wqefeN0u5YmHVBn5G.mdx>).&#x20;
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  See [OPC UA Client](<../ENU/ENU/QuickStart Guide/-7aeKA0Yvj7t8RGFEgbww/oJxUog-OmvKw90OTACxQC/hOPEf8YrZKQAZLKycfcgM.mdx>) for more information about supported servers.
</ExpandableHeading>
