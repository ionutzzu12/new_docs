...
<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/3EwjbOlmezTTJYTi8De7m_service-catalog-v3.png" position="flex-start" size="40" initialPath="../../Resources/images/service-catalog-v3.png" githubPath="self/Content/Resources/images/service-catalog-v3.png"></Image>
...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **Service Catalog**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/STxz87SAGiKsFJFhXiRME_service-catalog-icon-ssm-3017x17.png" alt caption} icon .
  ...
  7. You can search for offering using the **Search Services** field. You cannot edit an incident once it is logged, but you can update it with notes or attachments (such as images or documents). You can also close an incident, regardless of its status. For details, see [My Items](docId\:K0qwBEJxsKlm3xMypWV7G).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to \{\{Primary.Product}}.
  2. From the workspace menu, select **Service Catalog**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/STxz87SAGiKsFJFhXiRME_service-catalog-icon-ssm-3017x17.png" alt caption}icon .
  ...
  7. If you need to update an in-progress offering request, you can add notes or attachments, such as images or documents. For more details, see [My Items](docId:2qTiq6dmg3LmNWOtZXl2H).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to \{\{Primary.Product}}.
  2. From the **Service Catalog** workspace, select a record and click either the Copy or share link:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/2SB808YmkFjd-3TheZXAO_icon-ssm-3024x24.png" alt caption}icon.
     - **To copy the link**: Select **Copy Link**. A message will confirm that the link has been copied to your clipboard.
     - **To send an email**: Select **Email** :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/8s21UITlfDYXw5OAD5o8b_send-email-ssm-3018x18.png" alt caption} icon. The default email client opens with the offering record in the email body. Enter the recipient details and send the email.
</ExpandableHeading>
