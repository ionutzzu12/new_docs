...
- Submit the *Certificate Signing Request&#x20;*&#x69;n Litmus Edge to a certificate authority and subsequently receive the device certificate with all required parameters (CA Chain and Private Key). See [Manage Certificate Signing Requests](<../Product Features/System/Network/Certificates/tpf-fIYro26oFBy5jeStd.mdx>) for details.&#x20;
- Confirm with your IT department if you require a custom CA certificate to be uploaded to Litmus Edge before you add a device certificate. If you need to upload a custom CA certificate, see [Add a Custom CA Certificate](<../Product Features/System/Network/Certificates/JgO02nFDKE0AfZULHhrQV.mdx>) for details.&#x20;
...
Follow the steps to [Backup a Device](<../Product Features/System/Device Management/Backup/Restore/k3lgAyGNXqAdzZG78Seh7.mdx>).&#x20;
