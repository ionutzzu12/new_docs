...
slug: quickstart-guide/industrial-systems-connection-guide/mqtt/industrial-ot-server
...
Learn more about [Certificates](../../../product-features/system/network/certificates.mdx).
...
The MQTT SSL option allows the client to connect to the server by providing the client configuration with certificates. Learn more about [Certificates](../../../product-features/system/network/certificates.mdx).
...
See the :Link[Define Optional Parameters]{docId="pal6ABPZbrimdU9LvGJ30" label="Connect a Device" spaceId version="v2" docAnchorId="#step-3-additional-attributes" loadingMethod="dynamic" overridedLabel="Define Optional Parameters" href="../../../product-features/devicehub/devices/connect-a-device.mdx"} section to learn more about additional options.&#x20;
...
<hint type="info">
  **Note**: You can't connect the DeviceHub :Link[MQTT Client]{docId="VxbDOiAuXfohf-S1yRzxi" label="MQTT Client" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to the MQTT Server if they are using the same Litmus Edge instance. This includes connecting through the Flows Manager or through an Integration connector. If they are using different Litmus Edge instances, they can connect. &#x20;
</hint>
