...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **MQTT - Amazon AWS IoT Core over SSL&#x20;**&#x70;rovider.
...
4. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="kR15wDiWr6qqJeBRq9TVh" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" overridedLabel="Create a Flow" href="../../Product Features/68WrvuaKK8gVSMbo8bVxq/Dl_unmfRV6alPsSkyT4lP.mdx"} to learn more.&#x20;
5. Click **Done**, and then click **Deploy**.
6. Click the **debug&#xA0;**&#x74;ab. See the *Additional Options* section in [Manage the Flow Canvas](<../../Product Features/68WrvuaKK8gVSMbo8bVxq/Afi9wqefeN0u5YmHVBn5G.mdx>) for more details.&#x20;
