...
- Submit the *Certificate Signing Request&#x20;*&#x69;n Litmus Edge to a certificate authority and subsequently receive the device certificate with all required parameters (CA Chain and Private Key). See [Manage Certificate Signing Requests](../product-features/system/network/certificates/manage-certificate-signing-requests.mdx) for details.&#x20;
- Confirm with your IT department if you require a custom CA certificate to be uploaded to Litmus Edge before you add a device certificate. If you need to upload a custom CA certificate, see [Add a Custom CA Certificate](../product-features/system/network/certificates/add-custom-ca-certificate.mdx) for details.&#x20;
...
Follow the steps to [Backup a Device](../product-features/system/device-management/backup-restore/back-up-device.mdx).&#x20;
