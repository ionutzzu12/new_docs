...
You must first :Link[Set up an Azure IoT Hub]{docId="BHuM5hVYGkXnFYI3t20xe" label="Set up an Azure IoT Hub" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}.&#x20;
...
3. Add topics to the connector with the details below. See :Link[Add Topics to Connectors]{label="Add Topics to Connectors" spaceId docId="_UOVFh7mautWK2gXBa9CO" version="v2" docAnchorId="#IQNU7" loadingMethod="dynamic" overridedLabel href="../../../../Product Features/Integration/TFGOZCQrFetfqf7Yn1W67.mdx"} for more information.&#x20;
