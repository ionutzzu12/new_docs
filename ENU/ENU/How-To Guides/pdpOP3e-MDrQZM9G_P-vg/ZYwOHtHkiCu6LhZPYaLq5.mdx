...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/xQi5POxWkMPNQ1-YhUBJa.mdx>) and select the **AMQP SSL** provider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see [AMQP SSL](<../../../Product Features/Integration/Integration Connectors/Message Brokers/vMFp6HRNkDvtifudM7z-A.mdx>) and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
