...
Follow the steps to [Add a Connector](<../../ENU/Product Features/Xgrv-_ps5irJcZlfL22DG/dDu4AKvRbiI_S8SeXkpia.mdx>) and select the **AMQP TCP&#x20;**&#x70;rovider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see [AMQP TCP](<../../Product Features/Integration/Integration Connectors/Message Brokers/jbONQXuq4kq4vZdXIW39R.mdx>) and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
