...
If you only need to restore a device configuration to a device that isn't damaged, see [Restore a Device](UX8SgjFMfVrolEAz0Sgxt.mdx).&#x20;
...
See [Activate a Node-Locked License Online](../../Activation/Licenses/NSMqjG2O4blVt54EBbGUb/DslCwWv7dF-W1I9r9Txic.mdx) to learn how to activate the license for the device.
