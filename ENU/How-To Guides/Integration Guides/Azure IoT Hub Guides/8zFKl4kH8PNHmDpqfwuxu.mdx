...
You must first :Link[Set up an Azure IoT Hub]{docId="3wKCm6kQgusuW7SaCKQBs" label="Set up an Azure IoT Hub" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId}.&#x20;

# Step 1: Add the Azure IoT Hub using SAS Key Connector

Follow the steps to [Add a Connector](<../../../ENU/Product Features/LR02cKZrqRt_aoIMAeuRN/Oltgmv6mo5teuzS_GsNx1.mdx>) and select the **MQTT - Azure IoT Hub using SAS Key** provider.&#x20;
...
3. Double-click the **DataHub Subscribe&#xA0;**&#x6E;ode.
   ...
   - If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="w5OhQrB_Yi_BmcZabhEBj" label="Create a Flow" spaceId version="v2" docAnchorId="#sQhVJ" href="../../../ENU/Product Features/yOXP8Qb_U_AFnbdqxZSd4/7xvHQOytaduG1w9sa5Jh8.mdx"} to learn more.&#x20;
...
7. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../ENU/Product Features/yOXP8Qb_U_AFnbdqxZSd4/bSXnAa7thWL0_2-05LetC.mdx>) for more details.&#x20;
