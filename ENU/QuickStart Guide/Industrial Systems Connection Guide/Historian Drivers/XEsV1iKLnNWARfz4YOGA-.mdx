...
When you [Add a Tag](<../../../Product Features/DeviceHub/Tags/LXlEhL0D9yVC0yvh2v7mo.mdx>) to the connected device, see the following Register Table and Tag Parameters sections. You can also [Browse and Add Tags from a Device](<../../../Product Features/DeviceHub/Tags/Browse and Add Tags from a Device/fKgStHijk9qq8gtGE9rom.mdx>).
