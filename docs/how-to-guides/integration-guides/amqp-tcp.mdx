...
Follow the steps to :Link[Add a Connector]{docId="ytsWGWeU6H6oEUnHj5hW3" label="Add a Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Add a Connector"} and select the **AMQP TCP&#x20;**&#x70;rovider.&#x20;

<hint type="info">
  **Note**: For configuring exchange options, see :Link[AMQP TCP]{label="AMQP TCP" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="ShCmBKQ8QoiZFC9iyuFv3" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} and refer to the *Exchange Options* section to learn more.&#x20;
</hint>
