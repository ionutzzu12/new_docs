...
Follow the steps to [Add a Connector](<../../../Product Features/Xgrv-_ps5irJcZlfL22DG/dDu4AKvRbiI_S8SeXkpia.mdx>) and select the **MQTT - Azure IoT Hub using Device Certificates** provider.&#x20;
...
5. If needed, configure the *Datahub Subscribe* connection. See the "Step 3: Configure Connector Nodes" section in :Link[Create a Flow]{docId="bezDaqGGrrny6TWDnL9CK" label="Create a Flow" spaceId version="v2" docAnchorId="#step-3-configure-connector-nodes" href="../../../../Product Features/Flows Manager/ddBsmAZtGH9krDnb5AEyU.mdx"} to learn more.&#x20;
...
11. Open the flow you created in Litmus Edge and check the *Debug messages* tab. See the *Additional Options* section in [Manage the Flow Canvas](<../../../../Product Features/Flows Manager/UXxv8NCZ8McWCpmAig_Lw.mdx>) for more details.&#x20;
