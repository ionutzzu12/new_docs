...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/WaAOMIYw3jqvo2U3FPKiX_image.png" size="80" width="1710" height="176" caption="Operational Grafana Docker Container" position="center" showCaption="true"></Image>
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/nDu33rzpXZih5O3N3dqYJ_image.png "Operational Grafana Docker Container")

# Step 2: Access Grafana

To connect to Grafana, you will use your Litmus Edge IP address and the port configured in the Grafana container.&#x20;

<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/fd8bBffMy8AnzthY0OC16_image.png" size="80" width="1350" height="363" caption="Grafana port" position="center" showCaption="true"></Image>

**To access Grafana:&#x20;**

1. In a new browser window, enter the URL to connect to Grafana using this format: \[Litmus Edge IP address]:\[port]. For example, if your Litmus Edge instance uses the IP address [https://192.168.0.146](https://192.168.0.146), and the Grafana container uses port 3000, enter **192.168.0.146**:3000.
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/87yrHqM7VDvqiMyQcsDE5_add-user.png" size="80" width="1031" height="383" caption="The Add user icon" position="center" indent="2" showCaption="true"></Image>
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/QHmEBSDbk3KSmAlPxduy__image.png" size="80" width="1133" height="456" caption="Expand the tsdata database" position="center" showCaption="true"></Image>

If there are no measurements listed, follow the steps below.&#x20;

### Step 2a: Connect Device

Follow the steps to [Connect a Device](<./././Product Features/DeviceHub/Devices/Connect a Device.md>) and do the following:
...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/w3I4oxDdUWezec3DTR1eS_image.png" size="80" width="1133" height="465" caption="tsdata measurement" position="center" showCaption="true"></Image>

# Step 4: Add a Data Source in Grafana

You will need to add a data source in Grafana that connects to the database you created. See the [Influx data source](https://grafana.com/docs/grafana/latest/datasources/influxdb/) documentation from Grafana to learn more.&#x20;
...
Now that the database is successfully connected to Grafana, you can start visualizing the data by using a dashboard. See the [Create a dashboard ](https://grafana.com/docs/grafana/latest/dashboards/build-dashboards/create-dashboard/)documentation from Grafana to learn more.&#x20;
