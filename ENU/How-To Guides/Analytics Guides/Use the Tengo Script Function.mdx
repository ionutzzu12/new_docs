...
6. Click **Add processor** again and select **Tengo script&#x20;**&#x70;rocessor.
   ...
   - **Code Block**: Copy and paste the Single Input User Scenario **code&#x20;**&#x65;xample.
     ...
     `}`
7. Click **Save**.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/oYjmtoKt25hIwEkwf4U1L_image.png "Tengo script processor dialog box")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/VeR_0EzlSYGUGzBfbJznm_image.png "Completed analytics canvas with one input")
...
7. Click **Add processor** again and select **Tengo script&#x20;**&#x70;rocessor.
   ...
   - **Code Block**: Copy and paste the Multiple Inputs User Scenario **code&#x20;**&#x65;xample.
     ...
     `}`
8. Click **Save.**
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/Gzd4lUMVexpi9P9fusTHv_image.png "Tengo script processor dialog box")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/u5W-7VUO6ymzRc-JA2z8u_image.png "Completed analytics canvas with multiple inputs")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/aYlqsd-zYvQHe1zH2Yol6_image.png "Output for Tengo script function with one input")
...
![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/mw92h07UhSd2EcQel5Bgj_image.png "Output for Tengo script function with multiple inputs")
