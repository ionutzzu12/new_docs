...
- Get familiar with different rules of [Switch](<../../ENU/Product Features/pnoXRmq24v3-hsin-ysBc/statistical-functions/switch.mdx>) processor. The rules for comparison are done through *GoLang strings.compare&#x20;*&#x66;unctions.
