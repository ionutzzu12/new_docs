...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **My Items**. A list of your submitted service requests and reported incidents is displayed:
     - To find a specific item, enter a keyword into the **Search My Items** field and use the drop-down list to focus the search. Then click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/Hz4nIWQOCH49QrjNLC5YY_search-icon14x12.png" alt caption} icon.
  ...
  For more information, see [My Items](docId\:dUrscaLg2g8NPGT-t8Vb3).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  For more information, see [Service Requests and Incidents](docId\:vwW2ajN75Lswc10aZVq8i).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  To find specific messages, enter text in the **Search Post** field (top right of page) and click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/JNDvkOTyMgIjxaIPL1YZu_search-icon14x13.png" alt caption} icon.

  To filter the real-time stream of messages in the main pane, use the filter criteria in the left Activity Stream pane.

  For more information, see [Social Board messages](docId\:qb4wx8j5msb5tjr2wqY-v).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  For more information, see [Announcements, FAQs, and Alerts](docId\:KLhFqtUWZ7Y0alQrMh6v2).
</ExpandableHeading>
