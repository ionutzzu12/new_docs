...
4. Configure the parameters for the device.&#x20;
   See [Connect a Device](<../../Product Features/DeviceHub/BsCZeopVvxIBRMcyy7USc/P8ECCvXLg-LwowsB7Leyc.mdx>) and [OPC UA](<../../QuickStart Guide/shwmWlfjHWDMjeLg1E_jU/rIrlK44klKlJRbYC9_d5Z.mdx>) or [OPC UA Client Advanced](<../../QuickStart Guide/shwmWlfjHWDMjeLg1E_jU/rIrlK44klKlJRbYC9_d5Z/_VcAJZoPHvn0d6aqBz1Q2.mdx>) to learn more.
...
<hint type="info">
  ...
  For nested and non-nested OPC UA event properties, the order of *Namespace Index* values affects Litmus Edge's responses. See [Manage Tags](<../../Product Features/DeviceHub/pucQJehoEvHwqcmrKM9cy/b1VEajs1Y4Grj8Rn3qUua.mdx>) for more details.
