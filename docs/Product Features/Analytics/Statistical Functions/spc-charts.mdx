...
<hint type="info">
  **Note:&#x20;**&#x57;hen creating an analytics flow with *SPC Charts&#x20;*&#x70;rocessor, refer the :Link[Use the SPC Charts Function]{label="Use the SPC Charts Function" spaceId="SuELLqhxHnnKWA4eA6SOc" docId="nLJJvZYsvvfSKrDAOEHIY" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} guide for more details.
</hint>
