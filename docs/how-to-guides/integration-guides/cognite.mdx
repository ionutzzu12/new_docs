...
Follow the steps to :Link[Add a Connector]{docId="ytsWGWeU6H6oEUnHj5hW3" label="Add a Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Add a Connector"} and select the **Cognite Connector** provider.&#x20;
...
You can visualize the incoming data using one of the dedicated :Link[Applications]{docId="iiPaN4OLp8RQzNJc_Q8br" label="Applications" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId overridedLabel="Applications"} such as :Link[Grafana]{docId="FyzNYYM_3ZfiuoLgo5NlT" label="Visualize Data Using Grafana" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel="Grafana"}.&#x20;

You can also view the data in the :Link[Flows Manager]{label="Flows Manager" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="JGhNQYhxbIk8x2nhH5Vte" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} and [Analytics](../../product-features/analytics.mdx) areas of Litmus Edge.&#x20;

- If you are creating a flow from the :Link[Flows Manager]{label="Flows Manager" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="JGhNQYhxbIk8x2nhH5Vte" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}, subscribe to the *Local Data Topic* name. See [Subscribe to Topics with Flows](../flows-guides/subscribe-to-topics-with-flows.mdx) to learn more.&#x20;
- If you are using [Analytics](../../product-features/analytics.mdx), select the DataHub Subscribe processor and use the *Local Data Topic* name. See [Create an Analytics Flow](../../product-features/analytics/analytics-flows-and-processors/create-an-analytics-flow.mdx) and :Link[Add Processors and Processor Connections]{label="Add Processors and Processor Connections" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="V37iAOLFGYw_7gLaZJt1n" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to learn more.&#x20;
