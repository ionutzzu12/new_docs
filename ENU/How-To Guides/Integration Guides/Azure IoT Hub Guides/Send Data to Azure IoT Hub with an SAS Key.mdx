...
<Image src="https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/RQot-5j1JSnlVxY_dW-ZT_azureiotsas.png" size="60" width="369" height="345" position="center" showCaption="false"></Image>
...
3. Add topics to the connector with the details below. See [Add Topics to Connectors](<././././Product Features/Integration/Add Topics to Connectors.md>) for more information.&#x20;
...
Once data is sent to the Azure IoT Hub, you can manage it as needed. Refer to the [Azure IoT Hub Documentation](https://learn.microsoft.com/en-us/azure/iot-hub/) to learn more.&#x20;
