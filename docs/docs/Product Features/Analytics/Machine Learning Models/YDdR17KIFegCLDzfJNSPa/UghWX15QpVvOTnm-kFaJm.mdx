...
Machine Learning Classification uses models created in TensorFlow. See [Upload a Model](<../../../../../Product Features/Analytics/Machine Learning Models/fAZMo-GiWfuY1b1Iiz7LY.mdx>). The TensorFlow Images Processor feeds images to an already created TensorFlow Model. The TensorFlow Processor feeds timeseries data to an already created TensorFlow Model.
