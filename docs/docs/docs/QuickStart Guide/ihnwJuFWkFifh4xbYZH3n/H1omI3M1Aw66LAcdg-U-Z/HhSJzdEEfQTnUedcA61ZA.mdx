...
When you :Link[Add a Tag]{label="Add a Tag" spaceId="dNcA0qsaQMoh10_hl6ySs" docId="o9zZT3M74618ShS4oe6--" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to the connected device, see the following Register Table and Tag Parameters sections. You can also :Link[Browse and Add Tags from a Device]{label="Browse and Add Tags from a Device" spaceId="dNcA0qsaQMoh10_hl6ySs" docId="c2Wytqk0WVCRvjhlBHX7D" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}.
