...
<hint type="info">
  **Important Notes**:&#x20;
  ...
  - If you select internal, make sure to select the *Enable Data Store* option for the device you want to store data for. See :Link[Enable Data Store]{label="Connect a Device" spaceId docId="WL56idZTpJY5A20Turkbd" version="v2" docAnchorId="#0YCTg" loadingMethod="dynamic" overridedLabel="Enable Data Store" href="../../../Product Features/DeviceHub/Devices/2QO5xh8wBeO2UG92F3hbM.mdx"} to learn more.&#x20;
