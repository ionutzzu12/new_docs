...
When you :Link[Add a Tag]{label="Add a Tag" spaceId="uscaaRRprMldzn77HKGZr" docId="pg-6Xtr10autJdpVRfNXq" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel} to the connected device, see the following Register Table and Tag Parameters sections.&#x20;
