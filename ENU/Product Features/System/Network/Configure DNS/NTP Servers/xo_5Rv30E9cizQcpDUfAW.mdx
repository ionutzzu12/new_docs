...
3. Go to either the Litmus Edge Web UI or the Terminal User Interface (TUI) and enter the address of the local NTP server.&#x20;
   - To use the Litmus Edge Web UI, update the *NTP Servers*. See :Link[Configure DNS/NTP Servers]{docId="yPNrkJy9ey-VtjcOlcl-p" label="Configure DNS/NTP Servers" spaceId version="v2" docAnchorId="#ntp-servers" href="../../../../../ENU/Product Features/System/b95PhFWmFc516r6yCWwJ0/uw-tkNCQ7k2v6VmOwmUot.mdx"} to learn more.&#x20;
   - To use the TUI, update the *Configure Time* setting. See :Link[Access the Terminal User Interface]{docId="Yd6Qn1sTcvqqNCavVDoVD" label="Access the Terminal User Interface" spaceId version="v2" docAnchorId="#configure-time" href="../../../../../ENU/QuickStart Guide/LH9wLRWVmLRpp4M4yCy-f/h0KyQCpKLpGAqZ06S-LRP.mdx"} to learn more.&#x20;
