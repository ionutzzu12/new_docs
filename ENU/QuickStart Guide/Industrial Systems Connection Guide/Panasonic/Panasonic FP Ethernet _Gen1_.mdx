---
title: Panasonic FP Ethernet (Gen1)
slug: quickstart-guide/industrial-systems-connection-guide/panasonic/panasonic-fp-ethernet-gen1
...
1. Note down the following information and refer to it as needed.&#x20;
   **Device**: Panasonic FP Ethernet FP2SH-60K
   **Communication I/**&#x46;: Ethernet. Refer to the following figure.
   ![](https://api.archbee.com/api/optimize/SSUUxKZUk9bFTEPNn_6Zo/FT5_9hrzag3AGMidO9qZs_panasonic-fp-ethernet.png "Reference image of device")
2. Launch Control FPWIN Pro7 v7.2.3.0 software, and then click **Online > Communication parameters**.
