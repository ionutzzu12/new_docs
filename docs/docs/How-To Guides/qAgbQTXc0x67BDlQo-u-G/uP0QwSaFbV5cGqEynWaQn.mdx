...
Follow the steps to [Add a Connector](<../../../Product Features/Integration/GcX9UZAhKiYSz8LSe4xaJ.mdx>) and select the **Google Cloud Pub/Sub Connector** provider.&#x20;
...
- **Custom Attributes**:  You can add custom attributes in key/value pairs for further data processing. Refer to the following to learn more:
  - :Link[Use Custom Attributes in the Google Cloud Pub/Sub Connector]{label="Use Custom Attributes in the Google Cloud Pub/Sub Connector" spaceId="JWQMp_kvm0WsA_Fpjt1v_" docId="Bwi1T-MSpS7gU20s2pnnh" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel}
...
- [Create a Flow](<../../Product Features/tAQ2y6xPYLoNqxyFDrrb-/EfWU7FhzSuuhmZvRB11Ad.mdx>) to view the messages coming from Google Pub/Sub through the connector you created.&#x20;
- Visualize the incoming data using one of the dedicated [Applications](<../../../Product Features/jP-Ua-hPAdzeVpas5X8Zq.mdx>) such as :Link[Grafana]{docId="poe3FWu3nH33s-hVvYIBE" label="Visualize Data Using Grafana" spaceId="JWQMp_kvm0WsA_Fpjt1v_" version="v2" docAnchorId loadingMethod="dynamic" overridedLabel="Grafana"}.&#x20;
