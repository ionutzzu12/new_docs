...
<hint type="info">
  **Important Notes**:&#x20;
  ...
  - If you select internal, make sure to select the *Enable Data Store* option for the device you want to store data for. See :Link[Enable Data Store]{label="Connect a Device" spaceId docId="_2EDTlzj-mOkIWGexTiF0" version="v2" docAnchorId="#0YCTg" loadingMethod="dynamic" overridedLabel="Enable Data Store" href="../DeviceHub/gp4Hx5suHimGbwANR-nBs/FbhaHiALYdPY4aeQGjHB0.mdx"} to learn more.&#x20;
